...
**차중량은 문서화 된 트랙터는 40 t 총 조합 무게에 대한 평가, 25 t 트랙터 자체에 대한 GVWR.
** 수동 또는 ** 14-speed DT14 기어 박스는 수동 및 AMT 형태로 제공됩니다.
** 520/560 및 가스 버전은 동일한 ** 그들은 KL 택시 가족을 공유하지만 다른 엔진 연료 시스템을 사용 - 별도의 사양으로 유지.

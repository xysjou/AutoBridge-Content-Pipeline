...
|---|---|---|---|---|---|---|
| 중국 브랜드 소프트웨어 장 (각자 개발된 조종석, 중국과 층) | 전기 자동차 중국 (산업) | CN→글로벌 | https: //www.electricautochina.com/the-ultimate- 2026-b2b-export-guide-for-top-rated-chinese-car-brands-pr/에 대한 자세한 정보 | 2026-09-02 | SINGLE_SOURCE(싱글) | Industry**pattern/example만**, 일반화되지 않음 |
| BYD 바다 사자 07 Ukraine 현지화 케이스 | NEV Fix (국립 서비스) | CN→멀티 | https: //nevfix.net/blog/byd-sealion- 07-ukraine-localization-case.html | 2026-09-02 | SINGLE_SOURCE(싱글) | **Brand-specific 예제**: 중국 전용 문제; BYD 계정 영어 스위치 (모델당 재확인) |
...
| 다국어/RTL 수출 표준 | CCID 赛迪 / 노이 소프트 원코어 Go 적용 (산업용 미디어) | - 연혁 | HTTP: //www.ccidnet.com/hlw/ 93237.jhtml번으로 이동 | 2026-09-02 | SINGLE_SOURCE(싱글) | RTL/Arabic 배치 고려 |
| 중국 자동차 OS 영어 버전 B2B 수출 가이드 | 전기 자동차 중국 | 담당자: Mr. wang | https: //www.electricautochina.com/the-ultimate- 2026-b2b-export-guide-for-chinese-car-os-english-version/에 대한 자세한 정보 | 2026-09-02 | SINGLE_SOURCE(싱글) | 英文 HMI, 刷机成本 (行业口径, 待官方核验) |

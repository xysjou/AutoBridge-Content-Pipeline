...
L/C는 해당 조건으로 안전합니다. Watch for conditions that put payment under the buyer's or a third party's control: 신청자, 문서에 서명한 증명서는 구매자만, 선적 날짜 또는 항구를 만날 수 없습니다, 금지, 또는 서류 발급 은행은 명확하게 받아들이지 않을 것입니다. 결제가 얼굴에 따라 발표에 따라, 신청자가 문서를 차단할 수있는 모든 항목은 신용이 확인되기 전에 또는 중립성을 제거 할 협상 지점입니다.

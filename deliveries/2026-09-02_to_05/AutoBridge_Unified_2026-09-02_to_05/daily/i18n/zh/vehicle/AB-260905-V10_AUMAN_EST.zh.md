# 福顿·戴姆勒 AUMAN EST(中国-V/VI)——中马重拖拉机车样板及出口检查.
...
## 购买者上下文:一个有单独排放线和能量线的拖拉机头
**福通戴姆勒AUMAN EST(欧曼 EST)**是中国市场重型拖拉机头. 中车-V EST510型和中车-VI X13型是不同的排放代号,一台**电池-电动牵引机是一条单独的线路**——它们绝不能合并为一个规格. 参考市场为**中国**.

## 确定线路和驱动线
- ** 中国-V EST510 **:国五 EST510:福康 ISGe5-510/X12,6x4,公告型号 BJ4259SNFKB-AA.
- ** 中国-VI X13 **: 国六 X13NS6B560：12.9L，412kW/560马力，2600N·m.
- ** Gearboxes **: ZF 12TX2621TD(AMT)/法士特 16 挡 (中文(简体)).
- ** 组合质量**:牵引总质量约 40t 级 (6x4) 主流) (GCW类为主流6x4;确切数字以同义词表示).
- **BEV线(分离)**:2026纯电牵引申报:双电机峰值350kW,总质量25000kg.

## 验证规格表(中市参考文献).
| 规格 | 数值 | 单位 | 市场 | 信心 | 来源说明 |
|---|---|---|---|---|---|
| est510瓜乌 | 国五EST510：福康ISGe5-510/X12，6x4，公告型号BJ4259SNFKB-AA | - 说吧 | 中国 | 资源 | 抖音百科(T4)+汽车之家 (中文(简体)). |
| 国 家 x13 | 国六 X13NS6B560：12.9L，412kW/560马力，2600N·m | - 说吧 | 中国 | 资源 | 汽车之家车家号 维基月球 |
| 变速箱选项 | ZF 12TX2621TD (AMT)/法士特 16 挡 (韩语) | - 说吧 | 中国 | 资源 | 汽车之家车家号 维基月球 |
| gcw 拖拉机 | 牵引总质量约 40t 级 (6x4 主流) (中文(简体)). | 计数 | 中国 | 资源 | 汽车之家+百科 (单位:千美元) |
| 贝弗单行 | 2026 纯电牵引申报: 双电机峰值 350kW, 总质量 25000kg (中文(简体)). | - 说吧 | 中国 | 资源 | 新浪财经 维基月球 |

## 拖拉机出口检查:排放产生、GCW和BEV边界
始终说明该单位是China-V(历史)还是目前的China-VI; 不以当前方式显示中V单位。 精确的GCW,第五轮负载和GVW要求特定型号代码的同位化公告. 柴油或BEV的燃料消耗/范围没有权威记录,不予公布。 The 2026 BEV tractor filing (twin-motor 350 kW,  25 000 kg total mass) is reported as a **separate energy line**, 而非作为柴油EST的变种.

## 付款前对海外买方的核实
1. 国华五(历史)对中华六流;从不将旧作重贴为流.
2. 从同位化公告中获取确切的GCW/第五轮载荷.
3. 将柴油机和BEV牵引机分别订购/规格.
4. 确认 ZF AMT 相对 快速手册、排放阶段和目的地进口规则。
5. 请求当前导出报价;无。

## 财务问题
** EST510是目前使用的模型吗? ** 是中V线——标注它的历史位置是中VI线的现今.
**What is the exact GCW?** About the 40 t class for 6x4; 以同义词确认。
**Is there an electric EST?** A separate 2026 BEV filing exists — do not merge it with diesel specs.
** ZF 12TX AMT或Fast 16-speed,通过建造。
**X13输出量?**12.9 L,412 kW/560 hp,2600 N·m中VI线.
...
- ** 日期:2026-09-06
- ** MODEL_TOPIC_MATCH**:准确的福顿·戴姆勒 AUMAN ST拖拉机

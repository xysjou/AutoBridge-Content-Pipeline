...
## 费奥夫 动力列车:发动机+汽车+操作模式
| 项目 | 秦L DM-i(中国参考文献) |
|---|---|
| 能源类型 | 插式混合式(PHEV),五-基因DM |
| 引擎 | 1.5 L 专用混合汽油发动机 |
...
## 不可混合的版本差异
- ** 80 km vs 120 km **=不同的电池包(10.08 vs 15.87 kWh);充电硬件和修剪器也升级. 在任意范围句子之前说明版本。
- 电网电网范围与任何合并范围的索赔都位于不同的试验基地;不直接增加或比较这些试验基地。
- 中线设备没有OEM海外页面,不是出口市场设备的证据.

## 付款前对海外买方的核实
- DM-i横轴位置决定驱动轮——验证VIN建设图/证书上的布局,而不是将前驱作为混合系统所暗示的处理.
1. ** Battery版本和容量** 写在VIN(10.08 vs 15.87 kWh)上;不只接受范围编号。

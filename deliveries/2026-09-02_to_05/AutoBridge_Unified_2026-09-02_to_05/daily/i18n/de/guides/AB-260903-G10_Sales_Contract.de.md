...
- **Fahrzeugidentität** (FIN, Modell/Trimm, Modelljahr, Konfigurationsliste), **Menge und Stückpreis**;
- **Qualitäts-/Konditionsstandard** und **Prüfstandard/Methode** (binden Sie dies mit dem PSI-Bericht);
- **Verpackung/Schutz** für den Seetransit und die **Abwicklungs-/Zahlungsmethode**;

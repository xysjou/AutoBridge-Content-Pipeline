...
- **Meta Description**: Foton Toano Light Bus/Großer Van auf dem chinesischen Markt: Kurz- und Langradstände, Dieseldrehmoment, breiter Sitzbereich und warum Kühlumbauten separat bewertet werden.
- ** H1 **: Foton Toano / Tuyano (2026) - Chinesischer Großer Van (Light Bus) Specs und Export-Checks
- **Hauptschlüsselwort**: Foton / 福田 Toano / 图雅诺 大VAN（轻客） specs export
- **Secondary Search Terms**: Foton Toano Export; Tuyano van; Chinese light bus; Passenger van; Cargo Van Umbau
- **Vorgeschlagene URL**: /Fahrzeuge/foton-toano/
- **Search Intent**: 了解 Foton / 福田 Toano / 图雅诺 大VAN（轻客） 中国版规格、配置与出口适配性（车型参数页）
- **Interne Linkvorschläge**: /Fahrzeuge/foton-toano/, /guides/ckd-skd-knockdown-kit-export-assembly/, /guides/tir-road-transport-china-central-asia/
...
The **Foton Toano (图雅诺, 2026)** is a Chinese-market diesel large van/light bus offered across many wheelbases and seat counts. Da die Variantenmatrix breit ist, wird diese Seite nur um **identifizierte Konfigurationen** geschrieben, anstatt um eine einzelne implizierte "Toano"-Spezifikation. Referenzmarkt ist **China**.

## Identifizierte Abmessungen, Antriebsstrang und Sitze
- **Kurzer Körper (X5) **: 4990×1980×1990, wheelbase 3070 mm.
- **Langer Radstand**: 3510（X5长轴）/3750（经典长轴，车长5990×2000） mm.
- ** 2.5T Dieseldrehmoment**: 400 N·m; Getriebe 6MT.
- **Sitzplätze**: 3/5/6/7/9/14/15/17（随版本）.
- **Umrechnungsnotiz**: F2.8NS6B177L：2780mL/130kW，属冷藏改装上装 — a refrigerated body is an upfit, not a base-van specification.
...
| Optionen für lange Radstände | 3510（X5长轴）/3750（经典长轴，车长5990×2000） | mm | CHINA | SINGLE_SOURCEN | 搜狐对比 |
...
**Why no full ISF2.8 power list?** The variant matrix needs an OEM lock; Sie wird zurückgehalten.
...
- **MODEL_TOPIC_MATCH**: genauer Foton Toano van

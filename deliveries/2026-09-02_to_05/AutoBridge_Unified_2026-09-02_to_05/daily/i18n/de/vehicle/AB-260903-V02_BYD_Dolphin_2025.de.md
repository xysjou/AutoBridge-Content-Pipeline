...
## Zwei Motor Grades, zwei Batterien (China Referenz)
| Position | Standardnoten (活力 / 自由 / 时尚) | Ritterklasse (骑士版) |
|---|---|---|
| Antriebsmotor | 70 kW / 180 N·m | 150 kW / 310 N·m |
| Blade Battery (LFP) | 44.928 kWh | 60.48 kWh |
| CLTC-Bereich | 420 km | 520 km |
| Körper L×W×H | 4125 / 1770 / 1570 mm | 4150 / 1770 / 1570 mm |
| Radstand | 2700 mm (beide) | 2700 mm |

Befestigen Sie ** Batterie und Motor zusammen **: Der 150 kW/310 N·m-Antriebsstrang paart sich mit dem größeren 60.48 kWh-Pack auf der Knight-Klasse. Die Präsentation eines "Delphin" ohne Namensnote lässt sowohl Macht als auch Reichweite mehrdeutig.

## Range Cycle Discipline (CLTC ist nicht WLTP/EPA)
The 420/520 km figures are **China CLTC**. Zitieren Sie immer den Zyklus neben der Nummer:
- Beschriften Sie CLTC 420/520 nicht als WLTP- oder EPA-Bereich für ausländische Kunden um.
- Wenn ein Bestimmungs-Delphin-Blatt WLTP/NEFZ verwendet, geben Sie die Zahl des Marktes an und halten Sie sie getrennt (regionale Referenz mit gleichem Namen — kein Trimm-für-Trimm-Äquivalent).
- Notieren Sie sowohl den chinesischen Gradnamen als auch seine Batterie kWh auf dem Build-Note, so dass ein "420" -Label nicht durch eine andere Note ersetzt wird.

## Lade-, Software- und ADAS-Prüfungen (EV-spezifische Prüfungen)
- **Verbinder:** Chinesische Builds verwenden die GB / T-Ladeschnittstelle; bestätigen Sie den Zieleingang und ob ein Adapter / Protokoll-Gateway akzeptabel ist (siehe Ladestandard-Guide). Ein mechanischer Adapter garantiert keine Handshake-Kompatibilität.
- **ADAS:** die chinesische Linie bietet **DiPilot** mit ACC/AEB/Lane-Departure Assist für entsprechende Noten (Single-Source; bestätigen Sie die genaue Note Feature Set).
- **Infotainment/OTA:** verifizieren Sie die UI-Sprache, die App/Server-Erreichbarkeit und OTA außerhalb Chinas **auf der VIN**, anstatt davon auszugehen, dass eine Head Unit des chinesischen Marktes unverändert im Ausland funktioniert.
- **AC/DC-Fähigkeit:** bestätigen die fahrzeugseitige AC-Ladung und jegliche DC-Schnellladung nach Grad und nicht über die gesamte Linie.

## Abmessungen und Kabine
Kompaktfünftürige Heckklappe, 2700 mm Radstand; Standardlänge 4125 mm, Knight 4150 mm; width/height 1770/1570 mm. Ein kleiner Fußabdruck und ein enger Kreiszug für städtische Flotten, aber die Erwartungen an die hintere Kabine und die Fracht sollten aus diesen Dimensionen heraus festgelegt werden, nicht von einem größeren BYD in Übersee.

## Was Importeure vor der Zahlung überprüfen sollten
1. **Grad + Batterie + Motor als eine geschlossene Kombination ** (70 kW / 44.928 kWh vs 150 kW / 60.48 kWh).
2. **Range-Zyklus** mit der Bezeichnung CLTC; Bestimmungsort WLTP/NEFZ nur aus dem Bestimmungsblatt.
3. **GB/T vs. Zielstecker**, AC/DC-Bereitstellung und jegliche Adapter-Legalität.
4. **DiPilot-Funktionsliste** für die genaue Note; **Sprache/OTA** auf der VIN getestet.
5. ** EV Versand Papierkram * - UN38.3 / MSDS plus die Ozean Gefahrgutklassifizierung, nach IMDG Änderung 42-24 (obligatorisch von 2026-01-01) ein Lithium-Ionen-Batterie-betriebenes Fahrzeug ist UN3556 klassifiziert, nicht das Vermächtnis generische UN3171; gelten Dokumentation / SOC Details nach dem aktuellen EV Versand Fact Sheet und dem Carrier (siehe EV Ocean-Compliance Guide).
...
|---|---|---|---|---|---|---|
| 2025 Delfinstart (Preis, Parameter) | IT Home / Toutiao | CN | http://m.toutiao.com/group/7389073901650723378/ | 2026-09-03 | CROSS_CHECKED | 44.928 kWh, 70 kW, 420 CLTC, Inlandspreis (TIME_SENSITIVE) |
| Dolphin-Antriebsstrang/Batterie/Bereich | PCauto-Enzyklopädie | CN | https://m.pcauto.com.cn/baike/1551886/ | 2026-09-03 | CROSS_CHECKED | 60.48 kWh, 150 kW / 310 N·m, 520 CLTC |
| Dolphin 1, 000, 000th Einheit (Abmessungen) | NetEase Auto | CN | https://www.163.com/dy/article/KH3NHD5F0552EGI8.html | 2026-09-03 | CROSS_CHECKED | 4125/4150 × 1770 × 1570 Radstand 2700 |
| 2025 Dolphin DiPilot | Xincheping / Toutiao | CN | http://m.toutiao.com/group/7389115620090053159/ | 2026-09-03 | SINGLE_SOURCEN | Beschreibung des ACC/AEB/LDA-Features |
...
| 2025 Offizielle Dolphin Model Page (Ozean-Netzwerk) | BYD Auto (**Manufaktur offiziell**) | CN | https://www.byd.com/cn/ocean-home/models/haitun/2025haitun | 2026-09-05 | VERIFIZIERT (OEM; Identitätsumfang) | OEM-Anker für die Modellidentität des 2025 China Dolphin, Blade LFP-Batterie und E-Plattform 3.0; die öffentliche Seite ist eine dynamische Modellseite und veröffentlicht selbst keine statische numerische Tabelle, so dass die folgenden Noten von unabhängigen Gegenkontrollen durchgeführt werden. |
| Dolphin 智驾版 (DiPilot) Offizielle Modellseite | BYD Auto (**Manufaktur offiziell**) | CN | https://www.byd.com/cn/ocean-home/models/haitun/haitun-zhijia | 2026-09-05 | VERIFIZIERT (OEM; Identitätsumfang) | OEM-Identität für die Smart-Driving (DiPilot)-Klasse-Linie und Vier-Link-unabhängige Hinterradaufhängung |
| 2025 Delfingehalt/Batterie/Bereichstabelle | Autohome Q&A Modelldatenbank | CN | https://www.autohome.com.cn/ask/24636224.html | 2026-09-05 | SINGLE_SOURCE (nur unterstützend) | AI-aggregierte Q&A-Seite — nur unterstützender Kontext, NICHT als entscheidendes Cross-Check-Bein pro Quellqualitätsregel verwendet |
| 2025 Tabelle mit den Dolphinparametern | 太平洋汽车 PCauto-Konfiguration | CN | https://price.pcauto.com.cn/s48492/config.html | 2026-09-05 | CROSS_CHECKED | Unabhängige China-Konfig-Tabelle (überprüft erreichbar): CLTC 420/520 lines,  44.9/60.48 kWh, Notenmatrix — entscheidendes Kontrollglied # 1 |
| 海豚 参数配置 (2025 款) | 汽车之家 Autohome Config Serie | CN | https://m.autohome.com.cn/config/series/6139.html | 2026-09-05 | CROSS_CHECKED | Richtige Parametertabelle (keine AI Q&A-Seite), verifiziert erreichbar: 2025 Grad/Batterie/CLTC-Matrix — entscheidendes Cross-Check-Bein # 2 |
| Dolphin 2025 offizielle Broschüre | BYD Automotive Australia (OEM/Vertriebsmitarbeiter) | AU | https://bydautomotive.com.au/brochures/BYD-DOLPHIN-2025.pdf | 2026-09-05 | ÜBERPRÜFUNG (OEM; Anwendungsbereich des Ausfuhrmarktes) | OEM brochure confirms Blade LFP 44.9/60.48 kWh  and  70/150 kW motor lines  and  Abmessungen; NEFZ 410/490 und WLTP 340/427 sind Exportzykluszahlen und werden NICHT als China CLTC 420/520 verwendet |

*Evidenz-Scope-Anmerkung: Die offiziellen China-Seiten von BYD (siehe oben) verankern die Modellidentität des 2025 Dolphin. LFP-Batterie des Blattes  and  e-Plattform 3.0  and  the official BYD Australia 2025 brochure independently confirms the 44.9/60.48 kWh battery  and  70/150 kW motor lines (on export NEDC/WLTP cycles, getrennt von den Zahlen in China. Die China-Grade-Werte - 70 kW / 44.928 kWh / 420 km CLTC und 150 kW / 60.48 kWh / 520 km CLTC — ruhen auf einem echten Gegenprüfstand mit gleicher Sachlage durch zwei unabhängige chinesische Parametertabellen, die auf 2026-09-05 (PCauto s48492 config und Autohome 6139 config series) erreichbar sind, unterstützt von IT Home/PCauto Enzyklopädie; Die Autohome * Ask* Seite ist AI-aggregiert und wird bewusst nicht als entscheidendes Bein verwendet. Ein früherer Entwurf namens "Xcar" ohne URL - das nicht unterstützte Zitat wurde entfernt (keine erreichbare Xcar-Seite wurde erfasst). Binden Sie die genaue Note an den MIIT-Katalog und die VIN vor der Bestellung. CLTC ist nur für den chinesischen Zyklus bestimmt und wird niemals mit WLTP/NEFZ in Übersee gleichgesetzt. Gleichnamige im Ausland Delfine sind verschiedene Marktbauten. Schreib-AI-gesteuerter Patch 2026-09-05: Batterie-/Motorlinien, die jetzt OEM-unterstützt werden (AU-Broschüre, Exportumfang) und China CLTC-Werte, die von zwei unabhängigen Konfigurationstabellen überprüft werden, wodurch die Seite von NEEDS_ verschoben wird FORSCHUNG (China CLTC Vertrauen CROSS_CHECKED, nicht OEM-VERIFIED). *
...
- **Referenzmarkt**: China, 2025 Dolphin (Chinesische Marktreferenz; Übersee-gleichnamige Builds getrennt gehalten)
- **Verifizierungsmethode**: Multi-Source-Kreuzprüfung; Range-Cycle und Marktumfang nach MODEL_ALIAS / SOURCE_SCOPE-Regeln getrennt

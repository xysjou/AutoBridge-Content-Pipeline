# SAIC Maxus Xatu V90 Diesel Van: Configuration - Matrix Komersial Light, Bukan Model Tunggal
## SEO Metadata
- SAIC Maxus V90 Diesel Van Specs & Ekspor Panduan Konfigurasi
- ** Meta Description **: Chinese-market SAIC Maxus V90 wide-body diesel light van — SAIC π 2.0T diesel (110/130 kW), 6AT/ZF 8AT, Didukung dengan roda belakang ganda, dua pangkalan roda, 9–15 kursi oleh homologasi.
- ** Sugested URL **: / kendaraan / saic- makasi- v90-specs/
- ** H1 **: SAIC Maxus Xintu V90 (Cinese- Pasar): Diesel Light Van Konfigurasi dan Ekspor Cek
- ** Primary Keyword **: saic maxus v90 diesel van spesifikasi
- Maxus V90 wheelbase, V90 ZF 8AT, Maxus light bus 9-15 kursi, diesel wide- tubuh van ekspor, double roda belakang van
- ** Interior Link Sugestions **: / kendaraan / faw-jiefang-j6p-tractor-specs/; / kendaraan / farizon -xingxiang- v6e-specs/; / pemandu / kendaraan-coc-ketik -peresmisi- berkas /
- *** Sugestions Gambar **: Long-roda tinggi-atap profil sisi; dual- belakang roda poros; penumpang vs tubuh kargo; ZF 8AT pemilih; interior kargo; interior kargo
- "SAIC Maxus V90 panjang roda atap van"; V90 mesin diesel dan pilihan poros belakang "

## Pembeli Konteks: Pesankan Kode Konfigurasi, Bukan Nama
Xinta V90 adalah platform komersial cahaya ** yang dijual sebagai penumpang minibus, panel / kargo van dan taksi telanjang, di beberapa roda, atap tinggi, jumlah kursi dan roda belakang tunggal / ganda. Tidak ada "V90 spec" tunggal. Pekerjaan eksportir adalah untuk memperbaiki ** kode model homologasi yang tepat (公告型号) ** dan kemudian cocok mesin, gearbox, axle, tubuh dan kursi untuk itu - karena sertifikasi tujuan dilakukan pada konfigurasi tertentu. REFERENCE MARKET: ** CHINA **.

## Mesin dan Driveline (fokus diesel komersial)
| Butir | V90 Referensi Cina |
|---|---|
| Mesin | SAIC ASAC ("PI") 2.0 L turbo- diesel inline- 4 |
| Nilai daya | 110 kW (≈150 PS) / 130 kW (≈177 PS) |
| Nilai torsi | 375 N·m / 400–420 N·m |
| Transmisi | 6-speed otomatis ** or ** ZF 8-speed otomatis |
| Tata Letak | Mesin depan, roda belakang, roda belakang, pilihan ganda. |
| Bahan Bakar | Diesel - konfirmasi toleransi kualitas bahan bakar dan tahap emisi tujuan |

Untuk iklan diesel, pembeli harus membandingkan tingkat torsi dan pilihan putar-belakang (ban belakang dua vs tunggal) terhadap muatan yang dimaksudkan, bukan hanya puncak daya. ZF 8AT adalah transmisi tingkat tinggi; jangan asumsikan setiap kelas memilikinya.

## Chassis, Wheelbase dan Body Matrix
- Contoh standar-panjang tubuh L × W × H: **5498 / 2062 / 2535–2545 mm**; tubuh lagi juga ada.
- Dasar Wheelbacks: * 3366 mm / 3760 mm **.
- ** Kursi versi penumpang: 9–15, ketat per model homologat (tunggal - sumber; konfirmasi pada kode pengumuman / model) **.
- Tinggi atap, tata letak pintu geser / belakang, kargo vs interior penumpang dan chassis- variants taksi mengubah penggunaan GVW-class dan kategori lisensi.

Karena pangkalan roda, atap, kursi, dan putar ulang pilihan menggabungkan ke banyak kode homologat, baris spec disalin dari satu V90 tidak dapat diterapkan ke lain - permintaan lembar membangun untuk kode model yang tepat sebelum mengutip.

## Spesiasi Komersial untuk Kembali ke Unit
1. ** Model / kode pengumuman yang tepat ** Daya mesin, GVW, kursi, tipe tubuh.
2. ** Payload / GVW dan poros belakang ** (single vs roda belakang ganda) untuk beban yang dimaksudkan.
3. ** Tahap emisi ** (Cina diesel standar) vs tujuan kebutuhan; diesel fuel toleransi.
4. ** Jenis kategori lisensi jenis tubuh ** di tujuan (barang minibus vs penumpang van vs chassis untuk konversi).
5. Untuk mesin SAIC AVER dan ZF / 6AT gearbox di pasar.

## Ekspor Konsistensi
- Sebuah penumpang-orang (9–15 kursi) dan sebuah van panel kargo menghadapi tujuan yang berbeda persetujuan dan rute lisensi; negara tubuh dan kursi menghitung pada PI.
- Konfirmasikan ** LHD / RHD **, bahasa cluster, dan apakah ada konversi (ambulans, kemah, shuttle) dilakukan di Cina atau post- impor.
- Kontainer vs RoRo: di ~ 5.5 m dan atap tinggi, mengkonfirmasi metode stowage yang sebenarnya dari sebuah rencana beban daripada mengasumsikan 40HQ cocok dengan tinggi-atap panjang tubuh.

## Meminta Kuotasi Ekspor Saat Ini
Tidak ada harga ekspor statis dan tidak ada Cina MSRP ditangkap dalam paket penelitian ini; tidak ada yang ditemukan. Bertanyalah dengan ** Negara Tujuan Yang Diseting Model Code / Body

## Pertanyaan Yang Sering Muncul
Berapa kursi yang dimiliki V90? Versi penumpang berkisar 9–15 kursi tergantung pada kode model homologat; tidak ada jawaban tunggal tanpa kode.
Mesin apa yang digunakan? A SAIC PAULLIAN 2.0 L turbo- diesel di 110 kW (150 PS) atau 130 kW (177 PS) grade,  with 375 or 400–420 N·m.
** Apakah itu return-wheel drive? ** Ya, mesin depan RWD, dengan roda belakang ganda yang tersedia pada konfigurasi yang sesuai.
** Mana gearboxes ditawarkan? ** 6-speed otomatis atau ZF 8-speed otomatis, tergantung pada kelas.
Mengapa harus kukutip kode model? Dasar roda, atap, kursi, poros dan GVW berbeda di konfigurasi homologated V90; hanya kode yang memperbaiki spesifikasi.
...
| V90 2025 130 kW / 420 N·m | 16888 Otomatis | CN | https://m.16888.com/news/2026/0728/24803230.html | 2026-09-03 | _ BERDECAT | 130 kW / 420 N·m, ZF 8AT, 9–15 kursi (kursi tunggal-sumber) |
...
- ** Referensi pasar **: Cina, platform Xinta V90 (referensi pasar Cinese-; konfigurasi -spesifik)
- ** Metode verifikasi **: Multi-database cross-check; konfigurasi-matriks logika; tunggal-sumber kursi ditandai

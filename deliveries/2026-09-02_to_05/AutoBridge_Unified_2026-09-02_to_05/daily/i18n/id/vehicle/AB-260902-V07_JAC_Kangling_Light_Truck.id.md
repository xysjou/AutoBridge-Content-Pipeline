# JAC Kinginging (康铃) Lingpao L6 Light Truck - Chassis Family, Pengumuman Membangun dan Ekspor Catatan Sourcing
## SEO Metadata
- ** Judul SEO **: JAC Kangling Lingpao L6 Light Truck: Chassis, GVW & Driveline for Importers
- ** Meta Deskripsi ** JAC 1Ka Lingpao (Kanging) L6 truk ringan yang dijelaskan oleh keluarga chassis - Anhui- Cummins 2.5 daya diesel tangga, 4T/5T belakang axle, beberapa anggota pengumuman MIIT, dan bagaimana pin pembangunan ekspor yang tepat.
- ** Sugested URL **: / kendaraan / jacket-kang-lampu-truk /
- ** H1 **: JAC Kanging Lingpao L6: Matching Chassis, Model Pengumuman dan Superstruktur untuk Order Ekspor
- ** Primary Keyword **: JAC Kingpao Kilpao L6 light truck spesifikasi ekspor
- ** Second Search Terms **: JAC Lingpao L6, HFC4DE3 Anhui Cummins 2.5, HFC1043 truk ringan, China 4.5t GVW truk diesel, JAC 1Ka ekspor truk ringan, truk dropside Kafling
- ** Internal Link Sugestions **: / guide / commercial- truk-e-procurement-china /; / guide / import- chanese- chance- sauso /; / kendaraan / foton- aumarks-kulkas-truk /
- *** Sugestions Gambar **: pandangan samping dari dropside L6; resmi chasss- frame dan tata letak belakang-axle; mesin teluk dari HFC4DE3 2.5 diesel; perbandingan dari dropside / box / saham badan; single-row-row 1920 mm taksi
- ** ALT Saran **: "JAC Lingpao L6 4x2 truk diesel cahaya"; "Lingpao L6 180 mm frame chassis dan 4T/5T belakang axle"; "Anhui Cummins HFC4DE3 2.5-litre mesin diesel"
...
Fakta-fakta tingkat platform berikut diambil dari ** JAC Kendaraan Komersial resmi Lingpao L6 tabel konfigurasi (cv.jac.com.cn, VERIFIED, diperiksa 2026-09-03) ** dan stabil di seluruh keluarga:
| Butir platform | Nilai resmi JAC- |
|---|---|
| Lebar taksi | 1920 mm (standard-width / 33-mid taksi), single- row dan half-cab |
| Basis kemudi utama | 3365 mm (versi panjang 3600 mm ada di kereta listrik terpilih) |
| Bagian frame Chassis | 180 × 65 × 4.5 mm |
| Axle depan | 2 T |
| Axle belakang | 4 T / 5 T (diperkuat 10, 000 N / 13, 000 N pilihan pada beberapa baris) |
| Rasio kandar Final- | 4.875 / 4.33 (4.11 pada baris yang dipilih) |
| Keluarga bahan bakar / listrik ditawarkan | Zhiwei S25 (Q25A petrol- style), * Ankang 2.5 (Anhui-Cummins HFC4DE3 diesel) **, Ankang 3.0 cold- rantai, YN30 gas / dual-bahan bakar, Dekang 160B/C, DHE155 |
diesel yang paling relevan untuk ekspor adalah ** Ankang (安康) 2.5 **, menggunakan Anhui - Cummins ** HFC4DE3 ** keluarga. Tabel JAC daftar tiga akhiran - ** HFC4DE3-2E5 / - 2EA / - 2E9 - di 111 / 117 / 125 kW **, dengan torque langkah * 360 dan 458 N·m *. Hal ini penting karena rekan sering mengutip angka "160 hp / 460 N·m" yang tidak cocok dengan setiap akhiran; langkah daya dan torsi harus dibaca dari akte mesin dan pengumuman yang tepat.
## Satu Pembuatan Pengumuman Perwakilan (basis data, CROSS _ CHECWD)
Untuk menunjukkan bagaimana deretan platform menjadi sebuah truk beton, bangunan yang ditangkap adalah ** dropside HFC1043P21K4C7S, 4 × 2 **, dengan angka dari 360che/ 卡车之家 data pengumuman dan silang JACROSS _ CHECD; ditangkap 2026-09-02, kembali cek terhadap tabel JAC 2026-09-03):
| Butir | HFC1043P21K4C7S dropside (setiap data pengumuman) |
|---|---|
| Kandar / pangkalan roda | 4×2 / 3365 mm |
| Overall L × W × H | 5.995 × 2.20 × 2.48 m |
| Taksi | Single- baris, 1920 mm, 3 kursi |
| Mesin | Anhui- Cummins HFC4DE3 series, 2.499 L inline- 4 diesel, China VI |
| Gearbox | JAC ML645B 6-speed manual (Fast 8-speed digunakan pada tertentu L6 variants) |
| Rem | Rem penuh dengan rem parkir musim semi |
| Krab / muatan berperingkat / GVW | 2.565 t / 1.735 t / **4.495 t** |
| Axle depan / belakang | 2 T (1600 kg dapat dialokasikan) / 4 T (2895 kg grup), rasio 4.875 |
| Ban | 7.00R16LT 8PR, enam roda |
| Mata air leaf | 4 / 5+6 |
| Tubuh dropside | 4.18 × 2.10 × 0.40 m |
### Mengapa "L6" yang sama bisa menunjukkan bobot yang berbeda
Pengumuman Suster membangun membawa tubuh yang berbeda dan karena itu massa yang berbeda: kotak (厢式,  HFC5043XY… series)  and  pancang (仓栅,  HFC5043CCY… series) bodies are heavier,  with curb weight around 2.7–2.8 t  and  Muatan rated mendekati 1.5 t di sama ~ 4.495 t GVW. Jangan pernah menyalin muatan dropside yang ada di kotak atau membangun reefer - baca kembali dari sertifikat pengumuman tubuh itu.
## Mesin, Emission dan Driveline: Apa yang harus Pin pada Proforma
- ** Enjin akhiran dan kekuatan langkah **: tulis kode HFC4DE3-2Ex penuh dan kW / N nya, bukan hanya "Cummins 2.5". Catatan China VI (国六) adalah standar Cina; itu bukan, dengan sendirinya, bukti GCC, UNECE atau penerimaan emisi - mendapatkan tujuan emisi secara terpisah.
- ** Gearbox **: konfirmasi manual JAC 6-speed versus Fast 8-speed digunakan pada beberapa varian, dan jangan asumsikan otomatis ada untuk baris listrik yang dipilih.
- ** Axle dan rasio **: pilih 4 T vs 5 T poros belakang dan 4.875 vs 4.33 terakhir drive terhadap tingkat rute dan dimuat GVW; tabel resmi menegaskan kedua adalah pilihan pabrik.
- ** Rem / ban **: rem udara dengan parkir musim semi dan 7.00R16LT 8PR × 6 pada pembuatan ditangkap - konfirmasi ketersediaan ban dan standar layanan rem di tujuan.
## GVW, Body dan Superstruction (inti dari pembelian truk cahaya)
Pada sekitar 4.5 t GVW L6 duduk di klasik Cina cahaya kelas truk. Untuk sebuah perintah ekspor, kaitkan empat angka yang dikombinasikan dokumen Cina: *** berat batasi, muatan rasial, GVW dan destination- muatan berlapis ** (yang dapat berbeda setelah tubuh lokal fitmen). Decide dropside vs box vs stake vs reefer, record internal body diments and material, and state whether the superstructure is factory- lached or local coachbuilt. Sebuah kotak pendingin atau isolasi secara mahakarya mengangkat beban dan memotong muatan bersih - melihat halaman Foton Aumark reefer untuk bagaimana chassis, kotak dan unit pendingin ditentukan secara terpisah.
## Apa AutoBridge Adds Selain Parameter Situs
Situs parameter publik daftar satu konfigurasi pada suatu waktu dan jarang mengekspos bahwa nomor milik * berbagai model pengumuman *. Kerangka editorial kami merekomendasikan: (1) memetakan truk yang dikutip kembali ke ** Model pengumuman MIIT dan tepat HFC4DE3 akhiran **, sehingga label "160 hp" tidak secara diam-diam diperlakukan sebagai sebuah membangun 150 hp; (2) mempersiapkan * VIN / pengumuman / prenounce / prefication / student catatan konsibilitas *** sebelum deposit; dan (3) menghitung muatan untuk * tubuh sebenarnya yang dikirim daripada memundurkan diri. Langkah pengenalan versi itu mencegah kesalahan urutan L6 yang paling umum.
## Verifikasi Pembeli Luar Negeri Sebelum Pembayaran
- Abaikan lembar spesifikasi pabrik ** JAC dan sertifikat pengumuman MIIT untuk kode model yang tepat ** (misalnya, HFC1043P21K4C7S) dan kaitkan setiap figur basis data untuk itu.
...
| L6 HFC5043XY… box/announcement parameters | 360che (卡车之家, DB komersial) | CN | http://product.m.360che.com/m815/203872_param.html | 2026-09-02 | _ BERDECAT | Model keluarga nouncement, mesin / gearbox, bobot tubuh |
| Parameter L6 perwakilan dropside | 360che (卡车之家) | CN | http://product.m.360che.com/m815/203878_param.html | 2026-09-02 | _ BERDECAT | HFC1043P21K4C7S dimensi, bobot, axles, tubuh, ban |
| L6 Baris cepat - 8 / varian | 360che (卡车之家) | CN | https://product.360che.com/m772/193093_index.html | 2026-09-03 | SINGLE _ SOURCE | Alternatif 8-speed gearbox, varian spread |
* Keyakinan pada standar AutoBridge: VERIFIED membutuhkan sebuah badan standar produsen-pemerintah; meja JAC sendiri memenuhi bar itu untuk fakta-fakta platform. Bobot yang paling banyak diumumkan dari 360che adalah yang dikotori oleh keluarga JAC tapi tetap harus cocok dengan sertifikat yang tepat. Tidak ada harga yang dinyatakan; harga daftar dalam negeri adalah waktu - sensitif dan tidak pernah digunakan sebagai sebuah figur ekspor. ♪
...
- *** Referensi pasar **: Cina nilai-penjualan / pengumuman konfigurasi (bukan model tahun penumpang)
- ** Metode verifikasi **: Profacturer-tabel platform resmi + iklan-kendaraan database; per- build angka cocok dengan model pengumuman; harga sengaja diabaikan

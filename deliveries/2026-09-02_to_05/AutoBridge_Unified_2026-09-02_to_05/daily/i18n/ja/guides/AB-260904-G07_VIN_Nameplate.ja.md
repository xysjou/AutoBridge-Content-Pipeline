...
|---|---|---|---|---|---|---|
| ギガバイト16735-2019 ロード車両 — VIN、標準テキストPDF | SAC/TC114 (国内自動車標準化) | CN の | 以下は、 //203.83.237.36/upload/202108/10/202108101324047215.pdf | 2026-09-04 | 検証済み(プライマリ) | 17-char構造、標準テキスト |
| GB 16735-2019標準ステータスページ | SAMR がオープン | CN の | 以下は、 //openstd.samr.gov.cn/bzgk/std/newGbInfo?hcno=E2EBF667F8C032B1EDFD6DF9C1114E02 のリリース | 2026-09-04 | 検証済み(プライマリ) | 現在の状態は、2004を取り替えます |
| SAMRプラットフォーム・GB16735-2019 詳細 | サーム | CN の | 以下は、 //std.samr.gov.cn/gb/search/gbDetailed?id=94E9AF238E3052A4E05397BE0A0AD366 の | 2026-09-04 | 検証済み(プライマリ) | 標準的な状態 |
| ロードバイク車製品アクセスレビュー要件(GB16735の必須引用) | MIIT公式PDF | CN の | 以下は、 //wap.miit.gov.cn/cms_files/filemanager/ 1226211233/attach/20259/9d0824a8e8a84abf858f3cb96a6d7385.pdf のファイル | 2026-09-04 | 検証済み(プライマリ) | 必須条件、一貫性の要件 |
| VINセグメントの説明 | パシフィックオート | CN の | 担当: .pcauto.com.cn/x/5100/51002243.html の | 2026-09-04 | シングル_ソース | 位置レベルの説明 |
※ブロックされたノート:「中国語WMIはL / H」から始まるが、実際にはUNVERIFIEDではなく、WMIプレフィックスメーカマッピングやVINの宛先フォーマットはスコープ外です。 ふりがな

| 道路车辆 车辆识别代号 (VIN) GB16735-2019 条文 (百科载体) | 百科 (国标条文载体) | CN の | 以下は、 //m.baike.com/wiki/%E8%BD%A6%E8%BE%86%E8%AF%86%E5%88%AB%E5%8F%B7%E7%A0%81/1470666 | 2026-09-04 | シングル_ソース | VIN=WMI+VDS+VIS 共 17 位 (以标准正文为准) |

...
|---|---|---|---|---|---|---|
| 中国語ブランドソフトウェアの章(自己開発コックピット、中国語デフォルトレイヤー) | 電気自動車中国(産業) | CN→グローバル | 以下は、 //www.electricautochina.com/the-ultimate- 2026-b2b-export-guide-for-top-rated-chinese-car-brands-pr/ の特長 | 2026-09-02 | シングル_ソース | 業界**pattern/exampleのみ**、一般化されていません |
| BYDシーライオン07 ウクライナのローカリゼーションケース | NEV Fix(ローカライズサービス) | CN→マルチ | 以下は、 //nevfix.net/blog/byd-sealion- 07-ukraine-localization-case.html の一覧 | 2026-09-02 | シングル_ソース | **ブランド固有の例**:中国唯一の問題; BYDアカウントの英語スイッチ(モデルごとに再確認) |
| Denza Z 欧州 Google/Gemini対国内コックピット | Xueqiu (引用リリース) | CN→EU(CN→EU) | 以下は、 //xueqiu.com/ 9837237227/399831947 の | 2026-09-02 | シングル_ソース | **輸出対国内スタック(ユニバーサルなし)の例** |
| 検証チェックリストのPer-VINソフトウェア | StarVia Auto(輸出サービス) | CN→グローバル | 以下は、 //www.starviaauto.com/ja/blog/making-chinese-ev-software-work-locally | 2026-09-02 | シングル_ソース | Five-check acceptance method |
| 多言語/RTL の輸出標準 | CCID 赛迪 / ノイソフトワンコア 取材(業界メディア) | 営業拠点 | 担当: //www.ccidnet.com/hlw/93237.jhtml のファイル | 2026-09-02 | シングル_ソース | RTL/アラビアレイアウトの検討 |
| 中国の車OSの英語版B2Bの輸出ガイド | 電気自動車中国 | CN の | 以下は、 //www.electricautochina.com/the-ultimate- 2026-b2b-export-guide-for-chinese-car-os-english-version/ の特長 | 2026-09-02 | シングル_ソース | 英文 HMI、刷机成本 (行业口径、待官方核验) |
| 中国汽车出海，智能化为何"水土不服" | 汽车之家・车家号 | CN の | 以下は、 //chejiahao.m.autohome.com.cn/info/ 26145241 ?is=pc から | 2026-09-02 | シングル_ソース | 海外用户 UI 翻译 / 手机互联问题 |

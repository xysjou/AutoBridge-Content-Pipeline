...
-  fifth-wheel position, タイヤのサイズ  and  燃料タンク容量** ルートの地形  and  法的重量。
...
## 排出および燃料の現実
中国VI ディーゼルは EGR + DOC + DPF + SCR を使用し、**ultra 低い硫黄ディーゼルおよび DEF (AdBlue)** を要求します。 輸出前に、中国-VI が受け入れられているか、異なる排出ビルドが必要であるかどうか、(a) の宛先燃料硫黄レベルは、後処理システム、(b)、および(c) 動作気候における DPF 再生条件をサポートします。 中国のVI
...
## よくある質問
**J6P 460 ジッキー・CA6DM2-46E6、  an 11.05 L inline-6 China-VI diesel at about 460 PS  and  2300 N·m.
4×2、6×4、8×4、6×4は、一般的なラインホールの選択です。
AMTは10–16-speedマニュアルとオプションです。 正確なギアボックスモデルの名前。

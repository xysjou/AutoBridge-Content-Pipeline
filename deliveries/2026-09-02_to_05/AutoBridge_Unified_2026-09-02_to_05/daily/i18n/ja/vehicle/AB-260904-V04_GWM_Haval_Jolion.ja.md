...
## ツイート メタデータ
- **SEOタイトル**: ハーバル・ジョリオン/ハヴァル・チュリアン・アイデンティティ&マーケット・スペシャリティ・スペックス — 輸出ガイド
- **メタ 記述**: GWM独自の歴史は、中国ハヴァルチュリアン(哈弗初恋)がベースモデルレベルでハヴァルジョリオンとして海外で販売されていますが、中国1.5Tや海外のHEVパワートレインは市場によって異なり、合併してはならない。
- **混雑URL**: /vehicles/haval-jolion/
- H1 **: GWM の馬力の縄: 中国および海外のパワートレインによってケプトのアパートが付いている OEM 確認された名前のアイデンティティ
- **主なキーワード**: 馬場のjolionの陶磁器の specsの輸出
- **二次検索条件**: ハーバーチュリアン ジョリオンの同種、ジョリオン1.5T、ジョリオン・ハイブ海外、GWMの歴史 ジョリオン・南アフリカサウディ、ジョリオン次元
- **内部リンクの提案**: /guides/vin-nameplate-verification-chinese-vehicles/; /guides/emission-fuel-compatibility-china-vehicles/; /vehicles/chery-fulwin- t9/
- **イメージ提案**: Jolion front three-quarter; 1.5T対HEVバッジ比較。 後部貨物; GWMの歴史ページアイデンティティノート
- **ALT提案**:「海外EVとハヴァル・ジョリオン・チャイニーズ1.5TコンパクトSUVは別々に保たれました」
...
|---|---|---|---|---|---|---|
| GWMの企業歴(中国海外版=JOLION、南アフリカ/サウジアラビア、HEVタイ) | 大きい壁モーター(OEM) | ブランドHQ | 以下は、 .gwm.com.cn/history.html のサイトをリニューアルしました。 | 2026-09-04 | 検証済み(プライマリ) | サム・モデラー ベースアイデンティティ |
| ヘイヴァルチュリアン1.5Tオートパラメータ | シエナオートデータベース | CN の | 以下は、 //db.auto.sina.cn/car/50026/ の | 2026-09-04 | シングル_ソース | 中国の次元、1.5T、110 kWのホイールベース |
| オーストラリアのジョリオン1.5Tの電力と寸法 | テンセント(レビューを投稿) | ユウ | 担当: //news.qq.com/rain/a/20210717A03BJX00 のファイル | 2026-09-04 | SINGLE_SOURCE(海外) | 210 N·mの 7DCTの  430/1130 L — AU only |
| ジョリオン・プロ・ハイフ・オーストラリア・ローンチ | オートホーム・ケジアオ | ユウ | 以下は、 //chejiahao.m.autohome.com.cn/info/15525734 | 2026-09-04 | SINGLE_SOURCE(海外) | 海外HEVシステム |
| ジョリオン 2025 ベトナム (海外拠点) | iFeng自動 | サインイン | 以下は、 //auto.ifeng.com/c/8ggPMnGNmuJ の | 2026-09-04 | SINGLE_SOURCE(海外) | 海外HEV腐食 |

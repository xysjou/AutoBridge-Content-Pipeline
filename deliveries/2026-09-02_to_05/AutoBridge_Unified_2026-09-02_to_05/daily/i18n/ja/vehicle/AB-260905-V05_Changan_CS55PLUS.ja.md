...
## バイヤーのコンテキストと生成境界
This page covers only the **third-generation Changan CS55 PLUS (2024) with the petrol (ICE) powertrain**. **スーパーハイブリッドバージョンは別々のライン**で、異なるボディとパワートレインの数字で、ここでマージされていません。 参照の市場は**中国**です。

## ガソリン力訓練および次元
- **ボディ**: 4539 / 1865 / 1680 mm、 ホイールベース 2656 mm; cargo 475–1415 L.
- **エンジン**:新蓝鲸 NE 1.5T、141 (192Ps) kW。
- **トランスミッション**:7DCT 湿式双离合。
- **性能/経済**: 0–100 km/h 7.9 s; WLTC燃料消費量 6.94.
...
**排出の標準は何ですか。** 目的地の規則から中国- 6 を確認します。 排出量/燃料ガイドを参照してください。
**6.94 L/100 km 実世界図?** WLTC ラボの値です。実際の使用は異なります。
**99、900のRMB輸出価格ですか。** いいえ — 国産発売参照。
**ホイッチトランスミッション?** 7-speedウェットデュアルクラッチ(7DCT)をキャプチャラインに。


## ソースと検証
| ソース | 組織図 | マーケット | ティアー | 自信の秘境 | ページの先頭へ | 対応する事実 |
|---|---|---|---|---|---|---|
| CS55 PLUS 参数配置の特長 | 搜狐汽车车型库 | CN の | T2 | CROSS_CHECKED(クロス) | 以下は、 //db.auto.sohu.com/ model_6091/config ?sliding= 1 と 選択されたトリムID= 177241 | 尺寸、轴距、动力、变速箱、油耗、行李厢 |
| 第三代CS55PLUS上市 | 人民网重庆 | CN の | T3 | CROSS_CHECKED(クロス) | 担当: //cq.people.com.cn/n2/2023/0918/c367647-40575106.html | 上市、价格区间 |
| CS55 PLUS 超擎混动参数の特長 | 搜狐汽车 | CN の | T2 | CROSS_CHECKED(クロス) | 担当: //db.m.auto.sohu.com/ model_6091/a/1065482609_121117078 の | 混动版区分 (不得混入燃油) |

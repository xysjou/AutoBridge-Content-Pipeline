...
- Một vị trí vận động nhỏ (và do đó trục được điều khiển của nó) nên được đọc từ bảng tên/ ký hiệu; các tờ tham khảo sửa chữa năng lượng và phạm vi điểm nhưng không phải bố trí ổ đĩa.
1. ** Bước chính xác trong phạm vi  and  Động cơ** khớp với băng đĩa VIN — 30 kW đường băng với 50 kW đường ống trên là những xe khác nhau.
2. **Sat số đếm** (4 có thể là 5) cho đơn vị cụ thể.
3. **Charing Connectionor** — cổng GB/T của Trung Quốc tương thích với tiêu chuẩn đích; xác nhận bộ sạc điện tử tương thích.
4. **Battery vận chuyển tài liệu** — UN38.3 bản tóm tắt và giấy tờ DG trên một hướng dẫn sử dụng pin IMDG 42-24; xe cộ BOV phân loại theo quy tắc hiện tại.

...
## Bước 4 — Xây dựng văn bản xuất bản theo thứ tự nhất quán
Một lời tuyên bố trong sạch dựa trên những tài liệu nhất quán:
1. ** Chứng nhận xuất khẩu** bao gồm sản phẩm/HS chính xác;
2. **Customs xuất khẩu dạng khai báo**;
3. **Cmercial invoice**;
4. **Danh sách truy nã**;
5. **Certifate of born**;
6. **Trid-party báo cáo đánh giá** Nơi cần thiết;
7. ** For EVs/hybrids:** ắc quy ** UN38.3 báo cáo kiểm tra và MDS**, cộng với giấy tờ về chất lượng nguy hiểm của đại dương. Theo tu chính án IMDG 42-24 (từ 2026-01-01) một phương tiện chạy bằng li-ti-on-battery là mật mã UN3556, không phải di sản chung UN3171; áp dụng tài liệu hướng dẫn sử dụng/SOC trên các thông tin thực tế vận chuyển EV và các nhà mang (xem hướng dẫn xử lý đại dương EV).
Tên, VINs, số lượng, giá trị và mã nguồn của hệ thống máy tính phải đồng ý qua hóa đơn, danh sách đóng gói, B/L và giấy phép — cả phong tục lẫn người môi giới đích đến đều bác bỏ những bộ không nhất quán.

## Bước 5 — Công ty Enterprise/Pages sau khi làm giấy
...
- Từ UN38.3/MSDS hồ sơ về vụ đặt cửa trước.

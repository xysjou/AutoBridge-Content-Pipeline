...
- ** Descrição do Meta**: Mercado chinês JAC Junling V6 caminhão de carga leve placa azul: Yunnei D25 diesel, linha Ankang 160, caixa de carga, GVW / carga, ea caverna de massa de fonte única.
- ** H1 **: JAC Junling V6 (2024/2025) — Especificações do camião ligeiro de mercado chinês e verificações de exportação
- **Chave Primária**: JAC / 江淮 骏铃V6 轻卡（Light Truck） specs export
...
- ** Intenção de pesquisa**: 了解 JAC / 江淮 骏铃V6 轻卡（Light Truck） 中国版规格、配置与出口适配性（车型参数页）
...
The **JAC Junling V6 (骏铃V6, 2024/2025)** is a Chinese-market diesel light cargo truck in the sub-4.5 t blue-plate class used for city/regional distribution. Os compradores de veículos comerciais devem ancorar na GVW, carga útil e caixa de carga antes da guarnição da cabina. O mercado de referência é **China**; As massas requerem confirmação de homologação.

## Chassis e trem de potência identificados
- **Motor**: 云内 D25TCIF1 2.5L 柴油 150马力; torque 400 N·m.
- ** Linha de trem de energia**: 安康160 + 6挡全铝变速箱 + AAM后桥.
- **Massa (espelho de fonte única)**: kerb 2.565, GVW 4.495, carga útil nominal 1.735.
- ** Caixa de carga interior**: 约4220×2075×400.
...
|---|---|---|---|---|---|
| motor d25 | 云内 D25TCIF1 2.5L 柴油 150马力 | - Não, não, não. | CHINA | FONTE ÚNICA | 卡车之家镜像 |
| binário d25 do motor | 400 | N.m. | CHINA | FONTE ÚNICA | 卡车之家镜像 |
| Powertrain ankang160 | 安康160 + 6挡全铝变速箱 + AAM后桥 | - Não, não, não. | CHINA | FONTE ÚNICA | 卡车之家镜像 |
...
**What is the blue-plate class?** Sub-4.5 t GVW city truck in China; O licenciamento de destino difere.
...
|---|---|---|---|---|---|---|
| 骏铃V6 车型解析（卡车之家，经今日头条镜像，按镜像域降一级T3） | 卡车之家官方号（今日头条镜像） | NC | T3 | CROSS_CHECKED | http://m.toutiao.com/group/7281117707461247523/ | 动力链, 后桥, 自重, 总质量, 载质量 |
| 骏铃V6 配置（卡车之家镜像） | 卡车之家官方号（今日头条镜像） | NC | T3 | CROSS_CHECKED | http://m.toutiao.com/group/6889691682774876685/ | 云内D25参数, 货厢 |
| 骏铃V6 车型（卡车之家镜像） | 卡车之家官方号（今日头条镜像） | NC | T3 | CROSS_CHECKED | http://m.toutiao.com/group/6807685915310293507/ | 安康160, 变速箱 |
| 骏铃V6 二手信息（仅线索T4，不作参数依据） | 58同城二手车 | NC | T4 | CROSS_CHECKED | https://m.58.com/sz/huochec/59653082843796x.shtml | 市场存在性线索 |
| JAC Local oficial dos motores | Anhui Jianghuai Automobile JAC 江淮 (OEM) | NC | T1 | VERIFICADO | https://www.jac.com.cn/ | Identidade de marca/modelo-linha e autoridade OEM |
...
- ** MODEL_TOPIC_ MATCH**: caminhão de luz JAC Junling V6 exato

...
- ** Certificado de homologação de veículos/contentores (车辆批准证明书)**: certifica que o veículo ou contentor rodoviário cumpre os requisitos de construção (nomeadamente a capacidade de selagem do compartimento de carga). Um veículo que não possa ser selado de forma fiável não é elegível. Estes são distintos: aprovar o veículo não é o mesmo que emitir um livrete para uma transferência.

## Controlo do compartimento vedado
Uma vez afixados selos, o compartimento de carga deve permanecer selado em trânsito; qualquer ruptura, trans-carga ou dano deve ser tratado ao abrigo do procedimento TIR em vez de informalmente. É por isso que a segurança de carga e a matéria de construção do compartimento antes da partida.

## Linha temporal da China e a expansão de 2026
A China aderiu em 2016, passou para a implementação a nível nacional em 2019 e as medidas aduaneiras capturadas em 2026 China **expandem o âmbito de aplicação aplicável** (incluindo cenários adicionais, como o tráfego de obrigações de comércio electrónico transfronteiras). Trate a lista de escopo precisa 2026 e detalhes efetivos como sensitivos ao tempo e confirme contra o atual anúncio do GACC.

## Lista de verificação de funcionamento
1. Confirmar a rota entre as partes contratantes TIR e escolher um operador/associação autorizado TIR.
2. Assegurar que o veículo/contentor é elegível e obter o certificado de homologação.
3. Preparar a caderneta TIR e alinhá-la com a declaração de exportação.
4. Preservar os selos aduaneiros em trânsito; tratar as excepções através do procedimento TIR.
5. Confirm the current 2026 scope for your cargo type with GACC before booking.

## Limites
Este guia não lista todas as partes contratantes, taxa de garantia ou linha de escopo 2026, que são sensíveis ao tempo e específicas da rota, e não são cotadas taxas.

## Perguntas Frequentes
**Carnet TIR vs homologação do veículo?** A caderneta é a garantia de transferência; a homologação certifica o veículo/contentor selável.
** Por que é tão importante selar?** Os compartimentos fechados são o suporte da garantia de trânsito; as pausas devem seguir o procedimento TIR.
**Quando a China se juntou?** 2016 adesão, implementação nacional de 2019, com uma expansão de 2026 escopo.
...
- **Mercado de referência**: CN 出境 + TIR 缔约国 (国际公约框架)

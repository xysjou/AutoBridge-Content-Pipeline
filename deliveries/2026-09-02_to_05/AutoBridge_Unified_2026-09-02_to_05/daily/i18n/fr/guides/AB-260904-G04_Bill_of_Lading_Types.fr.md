...
- **Article 80 — Transfert de connaissement**: a **report (nommé) B/L n'est pas transférable**; un **ordre B/L** virement par **endossement spécial ou endossement blanc**; un **dédocteur B/L** virements **sans endossement**. C'est pourquoi les factures « à ordre/blanc » sont l'instrument qui préserve le contrôle — et pourquoi elles ne peuvent généralement pas être simplement libérées par télex.
...
- **Article 87 — Règles de livraison**: sous une ligne B/L**, la livraison est faite au destinataire ** nommé**; sous une ligne B/L**, au destinataire **endossé**; sous une ligne B/L**, au détenteur **; un document électronique de transport ** transférable** est remis à son détenteur ****. Ces règles déterminent exactement qui est habilité à collecter le véhicule.

## Lorsque le risque se situe dans la pratique
- **Avant le paiement intégral, télex et SWB sont tous deux main release forward availability**, car aucun original négociable n'est entre les mains du chargeur (la distinction de l'article 80/81). Faites correspondre ces deux options à ** T/T** prépayé ou à une position entièrement sécurisée.
- **Les factures d'ordre/de commande ne peuvent généralement pas être libérées par télex** — leur négociabilité (art. 80) est le mécanisme de contrôle.
...
2. Cette destination/consigne accepte-t-elle la libération du télex et quel est le mode de livraison prévu à l'article 87?
...
- Les citations légales utilisent le ** 2025-revised Code maritime en vigueur 2026-05-01 **; le libellé de l'article avant la révision ne doit pas être considéré comme étant actuel.

## Foire aux questions
**Quelle est la zone maritime Les articles du code régissent le transfert et la livraison en B/L?** Art. 80 (transfert: droit/commande/porteur), art. 81 (autres documents de transport tels que SWB) et art. 87 (transfert au destinataire/endee/titulaire désigné).
...
**Une lettre de transport maritime est-elle un document de titre?** Non — en vertu de l'article 81, il atteste le contrat et la réception, mais n'est pas négociable; le destinataire désigné recueille l'identité.
**Un projet de loi peut-il être publié par télex?** Généralement non; son art. 80 négociabilité est le mécanisme de contrôle.

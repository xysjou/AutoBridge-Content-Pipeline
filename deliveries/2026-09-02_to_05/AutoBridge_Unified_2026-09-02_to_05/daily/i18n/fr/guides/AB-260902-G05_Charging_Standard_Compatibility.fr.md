...
- **Description détaillée**: Une charge d'EV du marché chinois en Europe, au Japon ou en Amérique du Nord? GB/T 20234.3/27930 explique, la carte de connecteur par région, les entrées de version d'exportation, les adaptateurs et la direction ChaoJi.
- **URL suggérée**: /guides/chinese-ev-chargement-norme-compatibilité/
- ** H1 **: Un VE chinois sera-t-il facturé outre-mer? GB/T, CCS2, CHAdeMO et NACS Compatibilité expliquée
- **Mot-clé principal**: GB/T CCS2 CHAde Compatibilité des exportations standard de charge MO
- **Conditions de recherche secondaires**: adaptateur de charge d'exportation pour EV chinois, GB/T 20234.3 DC charge rapide, protocole GB/T 27930, CCS2 export version EV, ChaoJi standard
...
- **Suggestions d'image**: carte standard du connecteur mondial; comparaison GB/T vs CCS2; entrée export-version en usine; avertissement de conformité de l'adaptateur
- ** Suggestions ALT**: "Carte mondiale des normes de connecteurs à recharge rapide DC"; "Inlets de recharge de CCS2 et de GB/T"; "Inlet d'exportation de VE chinois CCS2"
...
|---|---|---|
| **GB/T 20234.3 ** (DC) + **GB/T 27930 ** (communication CAN) | Chine (véhicules nationaux chinois) | GB/T 20234.3-2023 élève la limite supérieure à ** 1500 V / 800 A** (sources industrielles croisées) |
...
| **NACS** | Amérique du Nord | Déployer en Amérique du Nord (déploiement de 2026 non officiellement vérifié ici) |
...
Domestic Chinese EVs generally ship with **GB/T** DC charging and the GB/T 27930 CAN-based communication handshake. Lorsque le réseau de destination fonctionne principalement ** CCS2 (Europe), CHAdeMO (Japon) ou NACS/ CCS1 (Amérique du Nord)**, cela crée le goulot de compatibilité que l'importateur doit concevoir autour. Il est essentiel que **GB/T et CCS2 n'aient pas de compatibilité physique directe — un adaptateur est nécessaire pour les relier** (par comparaison avec l'industrie EVSE), et un adaptateur doit également faire fonctionner la poignée de main de communication, et non pas simplement s'adapter mécaniquement.
...
Un graphique standard vous indique que GB/T diffère de CCS2; il ne vous indique pas si *ce VIN* sera chargé. La méthode recommandée est d'enregistrer **inlet physique, protocole de poignée de main et cote de chargeur embarqué comme une note liée au VIN**, de distinguer un adaptateur matériel ** (mécanique seulement) d'une passerelle de protocole (GB/T 27930 handhake)** dans le fichier d'achat, et de confirmer l'effet de légalité et de garantie de l'adaptateur ** dans la destination** avant le dépôt plutôt qu'après l'arrivée.
...
**Une taxe de VE GB/T chinoise peut-elle être directement appliquée sur CCS2 européen ?** Non — GB/T et CCS2 sont physiquement incompatibles; vous avez besoin d'une version d'exportation de CCS2 d'usine ou d'un adaptateur adapté et conforme localement.
**Qu'est-ce que GB/T 27930 ?** Il s'agit du protocole de communication basé sur CAN utilisé aux côtés du connecteur DC GB/T 20234.3 en Chine; la poignée de main compte autant que la forme de la prise.
...
| GB/T, CCS2, Type 2, NACS, CHAdeMO comparé | evse-chargers.com (industrie) | Mondial | https://www.evse-chargers.com/news/understanding-ev-charging-standards-gb-t-ccs2-type-2-nacs-and-chademo-compared-283319.html | 2026-09-02 | _CHECTURE | GB/T--CCS2 nécessite un adaptateur; matrice de compatibilité |
...
| Guide de l'adaptateur GB/T-T-CHADEMO B2B | Auto électrique Chine (industrie) | Mondial | https://www.electricautochina.com/comprehensive-b2b-guide-to-gbt-to-chademo-adapters-for-exported-chines/ | 2026-09-02 | _CHECTURE | Compatibilité des exportations goulot d'étranglement |

...
## Note d'assurance pour CIF et CIP
En vertu du CIF, le vendeur prend des dispositions pour l'assurance maritime minimale pour le bénéfice de l'acheteur; en vertu du CIP, le défaut est un niveau **plus élevé** de couverture (sous réserve de la règle et de toute modification convenue). Le montant assuré précis et les clauses sont convenus dans le contrat/la politique — ce guide ne reproduit pas les textes de la CPI A1–A10, qui restent la publication de la CPI liée au droit d'auteur ci-dessous, et ne cite aucun fret ou prime.

## Un chemin de sélection pour les commandes de véhicules
1. Identifier la chaîne de transport: l'océan pur contre le multimodal.
2. Correspondez au terme qui contrôle le chariot principal et qui peut assurer/dédouaner de façon plus fiable.
3. Alignez le terme avec le mode de paiement (le flux de documents sous L/C doit correspondre à l'Incoterm).
4. Évitez le DDP à moins que le vendeur ne puisse légalement gérer l'importation de destination, les droits et la TVA/TPS.
5. Indiquer précisément le lieu/port désigné — un terme sans point précis est un différend qui attend d'être prononcé.

## FAQ
**FOB ou FCA pour un conteneur?** FCA s'adapte généralement mieux aux mouvements containerizzato/multimodal que FOB.
**Le CIF signifie-t-il que le vendeur porte un risque à destination?** Non — le risque passe à l'expédition même si le vendeur paie le transport/assurance à destination.
**CIF contre couverture CIP?** Le CIP est un défaut de paiement à un niveau d'assurance supérieur à celui du CIF, sous réserve d'un accord.
...
|---|---|---|---|---|---|---|
| 国际贸易术语图文精讲 (Incoterms2020 共 11 种 两大类) | 中国贸促会广西分会 | NC | T1 | VÉRIFIER | https://www.ccpitgx.org/webcpitgx/2025/rcepjiedu_0624/15195.html | 11 术语, 按运输方式分类, 风险费用划分 |
| 2020 国际贸易术语详解 (FOB 风险点改为装上船) | 浙江省贸促会 | NC | T1 | VÉRIFIER | http://www.ccpitzj.gov.cn/art/2020/8/17/art_1229557691_11515.html | FOB/CFR/CIF, 船舷 → 装上船 |
| 跨境电子商务贸易术语 (风险转移教材) | 清华大学出版社 | NC | T3 | _CHECTURE | https://www.tup.tsinghua.edu.cn/upload/books/yz/095136-01.pdf | 风险转移, 象征性交货 |
| Règles de l'Incoterms 2020 (CCI) | Chambre de commerce internationale | NC | T1 | VÉRIFIER | https://iccwbo.org/business-solutions/incoterms-rules/incoterms-rules-2020/ | éditeur faisant autorité de Incoterms 2020 |
...
| Règles de la CCI (Propriétaire de la règle Incoterms 2020 — page dédiée) | Chambre de commerce internationale | ANNEXE | T1/T2 | VÉRIFIER | https://iccwbo.org/business-solutions/icc-rules/ | Index des règles de la CCI autorisant la confirmation Incoterms 2020 comme l'actuel terme protégé par le droit d'auteur et sa mise à jour par la CCI |
| FIATA — Pratique des transitaires dans le cadre des Incoterms | Fédération internationale des associations de transitaires (FIATA) | ANNEXE | T1/T2 | VÉRIFIER | https://www.fiata.org/ | Interprétation du point de livraison, du transfert de risque et des obligations de transport par l'expéditeur dans le cadre d'Incoterms |
...
- **Marché de référence**: INT(国际商会规则框架)

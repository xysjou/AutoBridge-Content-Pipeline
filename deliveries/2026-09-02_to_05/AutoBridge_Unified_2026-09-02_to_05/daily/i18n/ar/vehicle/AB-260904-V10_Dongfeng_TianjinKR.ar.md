# Dongfeng Tianjin KR (天锦KR) Refrigerated Truck: Chassis, Super structure and GVW for Export
...
- **Internal Link Suggestions**: /guides/vehicle-export-hs-code-classification/; /guides/export-vecle-document-package/; /vehicles/jmc-shunda/

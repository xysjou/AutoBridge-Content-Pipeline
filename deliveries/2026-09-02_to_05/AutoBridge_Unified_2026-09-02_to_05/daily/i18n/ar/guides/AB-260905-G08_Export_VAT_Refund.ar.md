...
- ** المبلغ الإجمالي المقتطع**: /الإرشادات/الآلية - الصادرات - عمليات استرداد
...
ترتيبات التصدير في الصين تستخدم طريقتين رئيسيتين ** ينطبق على الإعفاء من (免抵退)**: إعفاء من إنتاج الصادرات، وتقييد ضريبة القيمة المضافة على المدخلات مقابل ضريبة القيمة المضافة على الناتج المحلي، وتسترد المبالغ المتبقية. A **foreign-trade/commercial enterprise** that buys and resells for export generally applies **exemption-refund (免退)**: the export sale is exempt and the corresponding input VAT is refunded. استخدام الطريقة الخاطئة للنوع الكيان هو خطأ أساسي في تقديم الملفات.
...
| GACC — export declaration as VAT-refund verification basis | General Administration of Customs of China (海关总署 GACC) | CN | T1/T2 | مفقود | http://www.customs.gov.cn/ | تضاهي بيانات إعلانات التصدير الجمركية من جانب السلطات الضريبية للتحقق من استرداد ضريبة القيمة المضافة من الإعفاء من الأموال |
| مؤشر سياسات استرداد ضريبة القيمة المضافة للتصدير (صفحة صافحة) | State Taxation Administration (国家税务总局 STA) | CN | T1/T2 | مفقود | https://www.chinatax.gov.cn/chinatax/n810341/n810755/ | عمود سياسة التأهل الضريبي الذي يحمل إعلانات استرداد ضريبة القيمة المضافة الحالية الإعفاء (لم يُثبت وجود أي سعر نقض هنا) |
## استعراض التحرير

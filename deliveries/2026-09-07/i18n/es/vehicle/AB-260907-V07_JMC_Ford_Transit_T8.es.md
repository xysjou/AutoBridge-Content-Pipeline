...
## La matriz de la base de rueda/roof

La línea se construye en tres base de ruedas — ** 3000, 3300 y 3750 mm ** — combinado con techos medianos y altos y con cuerpos de pasajeros (bus) versus carga (van). Dos puntos de referencia trabajados ilustran la difusión (mantenga cada uno ligado a su propia configuración):
...
- etiqueta cualquier Transit de mercado de exportación como una construcción separada hasta que exista un documento OEM de la misma modelo.

## Límite de dirección y exportación

El mercado chino referenciado T8 es **accionamiento de mano izquierda**. Elegibilidad de mano derecha y cualquier especificación de exportación de fábrica requieren pruebas OEM separadas. Debido a que las furgonetas se convierten con frecuencia (minibus, refrigerado, ambulancia, taller), confirman que la base de ruedas/roof elegida y la conversión están cubiertas por la aprobación del tipo de destino en lugar de asumir una transferencia de interior chino.

## Verificación del comprador antes del depósito

| Check | Medida |
|---|---|
| Geometría | Fijar la base de rueda (3000/3300/3750), techo (medium/high) y cuerpo (passenger/cargo) por escrito. |
| Cargo | Confirme las dimensiones/volumen de los datos de JMC para el constructor de cuerpos antes de diseñar una conversión. |
| Motor | Salida de la unidad 2.3T 8AT o 2.0T 6MT a OEM/MIIT; mantener las líneas separadas. |
| Control de transmisión | Especifique RWD o 4WD y la categoría de licencia de masa/destino bruto. |
| Identidad | Trate JMC T8 y Ford Transit global como relacionados hasta que OEM pruebe el mismo modelo; verifique la garantía/partes. |
| Exportación | Obtenga pruebas separadas de RHD/export-spec; verifique el combustible, la aprobación de emisiones y la conversión; reconcilie el VIN antes del pago final. |

## FAQ
** ¿Cuántas llantas y techos tiene el Tránsito T8? **

Three wheelbases (3000/3300/3750 mm) with medium  and  techos altos, en pasajeros  and  cuerpos de carga - especificar la combinación exacta.

**¿Cuál es la versión de carga más grande? ################################################################################################################################################################################################################################################################

La larga carga de alto rendimiento referencias 5998 × 2164 × 2775 mm con un interior alrededor de 3.5 × 1.83 × 1.98 m  and  ≈13 m³ (single-source, confirmar oficialmente).

**¿Qué motores se ofrecen? ################################################################################################################################################################################################################################################################

Un diesel 2025 2.3T citado en 128 kW / 430 N·m con un 8AT, y un diesel 2.0T separado con un 6MT; mantenerlos distintos y confirmar salidas por VIN.

**¿Es el chino T8 igual que un Ford Transit global? **

No en la evidencia aquí: está construido por JMC para China y se trata como un modelo relacionado hasta que una declaración de OEM del mismo modelo prueba lo contrario.

** ¿Hay una versión de la mano derecha? ################################################################################################################################################################################################################################################################
...
| 江铃官方网站 (车型线身份;exact-trim 以官方 / 公告终核, 不证明与全球 Tránsito 同型) | 江铃汽车 (JMC) | CN | T1 | VERIFIED | https://www.jmc.com.cn/ | 车型线身份 |

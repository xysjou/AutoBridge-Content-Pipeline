# SAIC Maxus Xintu V90 Van Diesel: une configuration-Matrix léger commercial, pas un modèle unique
## Métadonnées SEO
- **Titre SEO**: SAIC Maxus V90 Spécifications pour fourgon diesel et guide de configuration d'exportation
- **Description meta**: Chinese-market  SAIC  Maxus V90 wide-body diesel light van —  SAIC  π 2.0T diesel (110/130 kW), 6AT/ ZF 8AT, RWD avec roues arrière doubles en option, deux empattements, 9–15 sièges par homologation.
- **H1**: SAIC Maxus Xintu V90 (Marché chinois): Configuration des fourgonnettes diesel et contrôles d'exportation
- **Mot-clé principal**: saic maxus v90 spécifications de fourgon diesel
- **Termes de recherche secondaires**: Empattement maxus V90, V90 ZF 8AT, Autobus léger Maxus 9-15 sièges, exportation de fourgons diesel à large corps, fourgon à deux roues arrière
- **URL suggérée**: /vehicles/saic-maxus-v90-specs/
- **Intention de recherche**: Comprendre SAIC Maxus Xintu V90 (Marché chinois): Configuration du fourgon diesel et contrôles d'exportation: ce qu'un exportateur de véhicules/pièces doit vérifier, documenter et décider avant de s'engager dans une commande.
- **Suggestions de liens internes**: /vehicles/faw-jiefang-j6p-tractor-specs/ ; /vehicles/farizon-xingxiang-v6e-specs/ ; /guides/vehicle-coc-type-approval-dossier/
- **Suggestion d'image**: profilé latéral à toit haut à longe roue
- **Texte ALT**: SAIC Fourgonnette à empattement long Maxus V90
- **Portée du schéma**: Article + véhicule (aucun produit/offre/prix/réexamen/ratification)

## Contexte acheteur: Commandez un code de configuration, pas un nom
Le Xintu V90 est une plateforme commerciale à large corps** vendue en minibus passager, fourgonnette et châssis-cabine nue, sur plusieurs empattements, hauteurs du toit, nombre de sièges et roues arrière simples/doubles. Il n'y a pas de " V90 spec ". L'exportateur a pour tâche de fixer le code de modèle ** exact homologué (公告型号)**, puis de lui faire correspondre le moteur, la boîte de vitesses, l'essieu, la carrosserie et les sièges, car la certification de destination est effectuée sur cette configuration spécifique. MARCHÉ DE RÉFÉRENCE: **CHINE**.

## Moteur et ligne d'entraînement (regard diesel commercial)
...
Comme l'empattement, le toit, les sièges et le choix de l'essieu arrière se combinent en de nombreux codes homologués, une ligne de spécification copiée d'un V90 ne peut être appliquée à un autre — demander la feuille de construction pour le code de modèle précis avant de citer.

## Spécifications commerciales à la réconciliation par unité
1. **Code du modèle/annonce exacte** → puissance du moteur, GVW, sièges, type de carrosserie.
2. **Téléchargement/VBV et essieu arrière** (roue arrière simple ou double) pour la charge prévue.
3. **Étape d'émission** (standard chinois pour le diesel) par rapport aux exigences de destination; tolérance à la qualité du carburant diesel.
4. **Catégorie de licence de type Body** dans la destination (minibus passager vs marchandises van vs châssis pour la conversion).
5. **Spare-pièces et service** pour le moteur SAIC π et la boîte de vitesses ZF/ 6AT sur le marché.

## Considérations relatives aux exportations
- Un transporteur de personnes (9–15) et un fourgongonnette sont confrontés à des itinéraires d'approbation et de délivrance de licences différents; indiquer que le corps et le siège comptent sur le PI.
- Confirmer **LHD/RHD**, langage de cluster, et si une conversion (ambulance, campeur, navette) est faite en Chine ou après l'importation.
- Conteneur vs RoRo: à ~ 5.5 m et toit élevé, confirmer la méthode d'arrimage réelle d'un plan de charge plutôt que de supposer 40HQ convient à un corps long de toit élevé.

## Demande de contingentation à l'exportation actuelle
Aucun prix à l'exportation statique et aucun PDSF chinois n'ont été saisis dans ce dossier de recherche; aucun n'est inventé. Demande avec **Pays de destination · Code/Body · Sièges · Power & Gearbox · LHD/RHD · Port de destination · Incoterm**.

## Foire aux questions
**Combien de sièges un V90 a-t-il?** La version passagers s'étend sur 9–15 places selon le code de modèle homologué; il n'y a pas de réponse unique sans le code.
**Quel moteur utilise-t-il?** A SAIC π 2.0 L turbodiesel en 110 kW (150 PS) ou 130 kW (177 PS) grades,  with 375 or 400–420 N·m.
** Est-ce une traction arrière?** Oui, moteur avant RWD, avec roues arrière doubles disponibles sur les configurations appropriées.
**Les boîtes de vitesses sont-elles offertes?** Un 6-speed automatique ou un ZF 8-speed automatique, selon le grade.
**Pourquoi dois-je citer un code modèle?** L'empattement, le toit, les sièges, l'essieu et le GVW diffèrent selon les configurations homologuées V90; seul le code fixe les spécifications.

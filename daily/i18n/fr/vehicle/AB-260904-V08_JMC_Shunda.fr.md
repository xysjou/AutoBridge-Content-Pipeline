...
## Noyau commercial: GVW, charge utile et corps de cargaison
| Point | Petit camion Shunda (référence de la Chine) |
|---|---|
| Moteur | JX493ZLQ6D diesel, ** 2.499 L ** (ne fusionnez pas avec le 2.8 L 493) |
| Puissance | ** 90 kW (-122 PS)**; il existe une version 116 PS distincte — correspond à la taille |
...
## Châssis et note du corps-buissier
L'empattement 2800 mm et le cercle de virage 5.5 m s'adaptent à la distribution urbaine. Lorsqu'un acheteur ajoute une boîte, un groupe frigorifique ou une autre superstructure, la **charge utile finale doit être réévaluée pour le véhicule terminé** — le chiffre du châssis seul n'est pas la cote du camion fini.
...
5. ** Classification SH** (véhicule de marchandises 87.04; les organismes à vocation spéciale peuvent déplacer des positions) selon le guide du code SH.

## Demande de contingentation à l'exportation actuelle
Aucun prix à l'exportation n'est publié. Demande avec **Pays de destination · Quantité · Version du moteur · Type de corps · LHD/RHD · Port de destination · Incoterm**.
...
- **Marché de référence**: Chine, Shunda JX493ZLQ6D petit camion (référence du marché chinois; charge utile par certificat; pas une spécification globale)
- ** Méthode de vérification**: vérification croisée de la base de données commerciale; versions des moteurs séparées; notation juridique reportée à l'annonce officielle

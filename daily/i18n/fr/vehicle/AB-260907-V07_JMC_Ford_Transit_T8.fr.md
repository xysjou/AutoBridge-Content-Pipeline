...
## Métadonnées SEO
- Titre SEO: JMC Ford Transit T8 Chine-Market Van Specs et contrôles d'exportation -AutoBridge
- Description meta: Référence du marché chinois pour le JMC Ford Transit T8 grande fourgonnette: trois empattements, toits moyens/hauts, deux lignes de diesel gardées séparées, volume de chargement, et pourquoi il n'est pas supposé identique à la Ford Transit globale.
- H1: JMC Ford Transit T8 (Quanshun T8): Une grande référence de fourgonnette de marché chinois construite autour de l'empattement, du toit et du volume de fret
- Mot-clé principal: JMC Ford Transit T8 spécifications d'exportation
- Termes de recherche secondaires: JMC FordFord Transit T8; Transit T8 dimensions; T8 volume de fret; 2.3T diesel 8AT fourgonnette; exportation chinoise de gros fourgonnettes; Quanshun T8
- URL suggérée: /vehicles/jmc-ford-transit-t8/
- Intention de recherche: Comprendre JMC Ford Transit T8 (Quanshun T8): Un grand fourgon de référence pour le marché chinois construit autour de l'empattement, du toit et du volume de fret: ce qu'un exportateur de véhicules/pièces doit vérifier, documenter et décider avant de s'engager à une commande.
- Suggestions de liens internes: /vehicles/saic-maxus-g90/, /vehicles/qingling-isuzu-kv100/, /guides/verify-chinese-car-export-supplier-history/
- Suggestion d'image: Une fourgonnette à toit haut de JMC Ford Transit T8 montrée du profil latéral pour afficher sa longueur
- Texte ALT: Profilé latéral d'un haut toit de JMC Ford Transit T8 sur sol neutre
- Portée du schéma: Article + véhicule (aucun produit/offre/prix/réexamen/ratification)
La JMC Ford Transit T8 (JMC FordFord Transit T8) est la plateforme de gros fourgons/grands bus construite par Jiangling Motors en Chine, vendue en passagers et en cargaisons sur de multiples empattements et hauteurs de toit, avec une traction arrière et des configurations à quatre roues motrices. Pour un acheteur commercial, la logique de commande est géométrique: le bas de roue × la hauteur du toit × le style de la carrosserie × le moteur définit le véhicule, et un "Transit T8" sans ces qualificatifs est sous-précisé. Cette page est une référence du marché chinois. Il maintient les deux lignes diesel séparées et — critiquement — ne pas assimile le Quanshun T8 construit par JMC avec le Ford Transit global: sans une déclaration de même modèle OEM, ils sont liés, pas prouvés identiques.
...
| Configuration | Dimensions de référence | Empattement |
| --- | --- | --- |
| Base moyenne, toit moyen (exemple) | 5498 × 2068 × 2465/2485 mm | 3300 mm |
| Base à roues longues, cargo à toit élevé | 5998 × 2164 × 2775 mm; l'intérieur de la cargaison -3.5 × 1.83 × 1.98 m; volume ≈ 13 m³ | Longue |
La longueur de 5998 mm est significative: Dans de nombreux marchés, il se trouve à la limite de la licence de conduite commerciale légère, de sorte qu'un acheteur devrait confirmer la catégorie de permis de destination et la masse brute du véhicule avant de commander la version la plus longue. Dimensions intérieures du fret and the ≈13 m³ volume are source unique and doit être confirmé contre les données officielles de la structure/configuration JMC avant qu'une conversion ne soit conçue autour d'elles.
## Deux lignes diesel — ne fusionnez pas
| Ligne | Référence du marché chinois | Boîte de vitesses |
| --- | --- | --- |
| 2.3T diesel (2025) | 128 kW (174 PS) / 430 N·m | 8-speed automatique (8AT) |
| 2.0T diesel | Ligne diesel séparée à sortie inférieure | Manuel 6-speed (6MT) |
...
La longue référence de fret à toit élevé 5998 × 2164 × 2775 mm avec un intérieur d'environ 3.5 × 1.83 × 1.98 m and ≈13 m³ (source unique, confirmer officiellement).
...
| --- | --- | --- | --- | --- |
| JMCOEMofficial website | JMCOEMofficial website | CHINA | https://preview.jmc.com.cn/config.html?car_type=2&brand_id=1025&configure_id=892&car_category=2 | Référence de spécification et de portée |
| Ford ChinaOEMofficial website(JMC Ford合资方) | Ford ChinaOEMofficial website(JMC Ford合资方) | CHINA | https://www.ford.com.cn/cross-model-compare-detail?keys=2-3T-cy-dz-zd-hy-3seats+new-transit-T8 | Référence de spécification et de portée |
| Truck Home(360che) | Truck Home(360che) | CHINA | https://product.m.360che.com/m726/181569_param.html | Référence de spécification et de portée |
| Autohome | Autohome | CHINA | https://m.autohome.com.cn/config/spec/1022487.html?platform-key=m | Référence de spécification et de portée |
| PCauto | PCauto | CHINA | https://m.pcauto.com.cn/baike/1579485/ | Référence de spécification et de portée |
| Sohu Auto | Sohu Auto | CHINA | https://db.m.auto.sohu.com/model_7460/config?sliding=1 | Référence de spécification et de portée |
| Autohome Used Cars | Autohome Used Cars | CHINA | https://m.16888.com/c/215286/options/ | Référence de spécification et de portée |

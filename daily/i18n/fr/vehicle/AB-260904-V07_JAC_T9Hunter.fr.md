...
## Châssis et empattement: Standard vs Long
| Point | Empattement standard | Empattement long |
|---|---|---|
| Longueur hors tout | **5330 mm** | **5620 mm** |
| Largeur/hauteur | 1965 1920 mm | 1965 1920 mm |
| Empattement | **3110 mm** | **3400 mm** |
| Lit standard (L×W×H) | **1520 × 1590 × 470 mm** | lit plus long sur le châssis 3400 mm |
Les dimensions standard de la base de roues sont vérifiées entre le site d'exportation de JAC OEM et une source structurée chinoise; les chiffres de la base de roues longues sont vérifiés entre deux sources chinoises. La longueur du lit est la façon la plus claire de distinguer les deux châssis; enregistrer les dimensions internes de l'empattement et du lit contre le VIN.

## Groupe motopropulseur (continuation diesel: moteur, boîte de vitesses, carburant, émissions)
| Point | T9 Chasseur diesel — référence du marché chinois |
|---|---|
| Moteur | 2.0T en ligne- 4 turbo diesel |
| Puissance/couple | **125 kW 410 N·m** |
| Boîte de vitesses | **ZF 8-speed automatique (8AT)** |
| 4WD | **BorgWarner temps partiel 4WD (2H/4H/4L) + verrouillage différentiel arrière** |
| Demande de consommation de carburant | 7.6 L 100 km — **réclamation du fabricant**, non un résultat mesuré |

Ces éléments du groupe motopropulseur chinois reposent actuellement sur une source de médias chinois unique, à côté du site d'exportation OEM**; pour le marché chinois*, ils sont donc **SINGLE_SOURCE** — les citer comme "** à finaliser par rapport à la fiche de configuration du fabricant (以厂商配置单终核)**", et non comme des chiffres chinois vérifiés à deux sources. L'existence d'une valeur OEM-exportation ne renforce pas la confiance du marché chinois. Combustible/émissions: diesel; confirmer la tolérance au soufre de destination et la voie d'émission (un étalonnage Chine-VI n'est pas lui-même approuvé à l'étranger).

## Conducteur, remorquage et charge utile — Les étiquettes du marché sont importantes
- ** Partie-temps quatre roues motrices (BorgWarner)** avec ** 2H 4H 4L ** et un **rear différentielle serrure** sur le document 4x4 (singe-market-source; finaliser contre la feuille de construction).
- ** Capacité de remorquage 3500 kg est un chiffre d'usine de JAC du marché d'EXPORT (marché EXPORT)** provenant du site d'exportation des OEM. Il ne doit pas être écrit comme valeur d'homologation/annonce chinoise ou comme numéro à l'échelle du système; la cote de freinage sur le document d'homologation de destination est ce qui régit l'utilisation à l'étranger.
- **Payload 1000 kg est un chiffre du marché de la CHINE, VERIFIÉ** par l'intermédiaire du site officiel de la cueillette JAC chinois (avec un soutien à l'exportation-OEM).
- La disponibilité du DHD apparaît sur les listes d'exportation, mais la matrice exacte d'approvisionnement du DHD doit être confirmée par un canal officiel du CAC, non supposé.

## Points de configuration de la version et de l'ordre
1. **Chassis/lit**: standard (3110 mm) vs long (3400 mm) — la longueur du lit décide de la ligne.
2. **Moduletrain**: 4x4 avec 2H/4H/4L et verrouillage arrière vs n'importe quelle version 4x2; état explicitement.
3. **Étiquette de marché sur la capacité**: 3500 kg remorquage données d'usine d'EXPORT; 1000 kg charge utile cote de la Chine; conciliez les deux avec la cote de destination.
4. ** Confiance du groupe motopropulseur chinois**: 125 kW 410 N·m /ZF 8AT/4WD sont une source unique pour la Chine — finaliser contre la feuille du fabricant.
5. **Le traitement aval du diésel et le soufre des combustibles** selon le guide sur les émissions et la compatibilité des carburants; **la classification SH** selon le guide sur le code SH à l'exportation.

## Vérification de l'acheteur étranger avant paiement
- VIN-to-chassis (standard/long) et dimensions du lit; 4WD mode et présence de verrouillage arrière sur la feuille de construction.
- Traiter 3500 kg remorquage comme des données d'usine d'exportation seulement; confirmer le remorquage/charge utile noté sur l'homologation **destination**.
- Côté direction (LHD/RHD) confirmé officiellement; émissions et compatibilité diesel-carburant.
- Ensemble de documents sur la liste de contrôle du conditionnement des documents d'exportation.

## Demande de contingentation à l'exportation actuelle
Aucun prix à l'exportation statique n'est publié. Demande avec **Pays de destination · Quantité · Lit standard/long · LHD/RHD · Port de destination · Incoterm**.

## Foire aux questions
**Quel moteur et boîte de vitesses le chasseur T9 utilise-t-il?** Un diesel 2.0T (125 kW 410 N·m) avec un automatique ZF 8-speed; pour le marché chinois, il s'agit d'un carburant unique en attendant la fiche de configuration de l'usine.
**Est-ce qu'il a une traction à quatre roues motrices de faible portée?** Oui — BorgWarner à temps partiel 4WD avec 2H/4H/4L et un verrouillage différentiel arrière sur le 4x4. documenté
**Table des matières ou lit long?** L'empattement 3110 mm/ 5330 mm au total ou 3400 mm/ 5620 mm; la longueur du lit diffère en conséquence.
**Le chiffre de remorquage 3500 kg est-il une valeur certifiée chinoise?** Non — c'est un chiffre d'usine JAC du marché d'exportation; la charge utile 1000 kg est la valeur cotée en Chine, et les cotes de destination doivent être confirmées séparément.
...
|---|---|---|---|---|---|---|
| JAC T9 spécifications officielles | Site d'exportation de moteurs JAC (OEM) | EXPORTATION | https://jacen.jac.com.cn/t9-launch/specs.html | 2026-09-04 | VÉRIFIER (OEM) | Identité de la MODÈLE; ** 3500 kg remorque (EXPORT)**; dimensions en maille |
| Nouvelle configuration de produit Hantu | JAC Fonctionnaire chargé du ramassage (OEM) | NC | https://pickup.jac.com.cn/qxht/index.html | 2026-09-04 | VÉRIFIER (OEM) | MOE_MODEL identité; ** 1000 kg charge utile (CHINE)** |
| Hantu standard long corps et dimensions du lit | Auto-home·Chejiahao | NC | https://chejiahao.m.autohome.com.cn/info/6777343 | 2026-09-04 | _CHECTURE | 5330/5620, empattement, lit |
| Dimensions de la couche de shuilage T9 (lit long) | PCauto | NC | http://m.pcauto.com.cn/x/2947/29474511.html | 2026-09-04 | _CHECTURE | Corroboration des lits longs |
| Hantu (outre-mer T9) groupe motopropulseur et génération | Auto Sohu | CN/Exportation | https://www.sohu.com/a/1068531202_122480923 | 2026-09-04 | SOURCE UNIQUE (Chine) | 2.0T/125/410/ZF8AT/4WD, 7.6 réclamation |
...
* Note de confiance: identité SAME_MODEL via deux sites JAC OEM; châssis standard/long recoupé; motorisation chinoise SINGLE_SOURCE (finale contre la feuille du fabricant); remorquage 3500 kg uniquement EXPORT et jamais une valeur d'homologation chinoise; 1000 kg charge utile est Chine VERIFIED. La matrice RHD et le prix à l'exportation ne sont pas indiqués. *
...
- **Marché de référence**: Identité CHINA+EXPORT; remorquage EXPORT; charge utile CHINA; groupe motopropulseur chinois à source unique
- **Méthode de vérification**: identité SAME_MODEL dual-OEM; étiquettes de confiance par marché; chiffres d'exportation non mis à jour pour l'homologation chinoise

...
| Élément | Traitement |
| --- | --- |
| Fonction générale ad-valorem | 6% de CIF (valeur en douane) pour l'origine non préférentielle |
| IVA (TVA) | 19% sur la valeur en douane CAF + droit — facturé même lorsque le droit est de 0% en vertu de l'ALE |
| préférence pour l'ALE pour l'origine chinoise admissible | Ad-valorem doudo 0%, sous réserve d'un certificat d'origine de l'ALE valide et de la règle propre au produit |
| Frais de port/logistique | Autres, transitaires/par route |

...
## Les acheteurs de séquence obtiennent le plus souvent en arrière
La bonne commande est **douane libre d'abord, registre deuxième**:
...
- ** Facture commerciale, liste d'emballage, connaissement, certificat d'origine. **
- Les directives du transitaire pour l'autorisation de Dubaï recommandent de maintenir la facture ** conforme au B/L et au certificat d'origine** (noms des parties, VIN, valeur, origine) – rapprocher ces documents pour réduire le risque d'une détention.
- Les documents côté exportation en provenance de Chine (licence, déclaration, papiers de batterie EV) supportent, mais ne remplacent pas, les dépôts côté EAU.

## GCC/GSO Conformité: la porte entre l'autorisation et l'enregistrement
- Les véhicules doivent satisfaire aux prescriptions de conformité **CGC Standardization (GSO)**; comprendre quel organisme délivre/survoit le certificat pertinent après la réorganisation de l'AEMF→MoIAT.
- Un **certificat de conformité national chinois n'est pas un accès au marché du CCG** — confirmez la route exacte de certification/approbation de type du CCG pour le modèle avant l'expédition (voir le guide du dossier d'approbation de type du CDC).
...
Après la mainlevée en douane, l'acheteur s'applique à la RTA avec (déclarée): valide **assurance**, une **inspection de véhicule** et **documents d'identité/d'autorisation de commerce**, puis reçoit le Mukiya. Les inscriptions de la flotte ou de la compagnie diffèrent des inscriptions individuelles; confirmer si une entité continentale ou une entité de zone franche modifie la documentation.
...
|---|---|---|---|---|---|---|
| Guide des taxes et des apurements au Moyen-Orient (Saudi/Dubai) | matériel de transport de marchandises | EAU | https://m.11467.com/product/d43094475.htm | 2026-09-03 | _CHECTURE | Documents d ' approbation; facture/cohérence B/L/CO; séquence RTA/Mulkiyé | 11467
| Liste des documents d ' exportation de VAN vers Dubai | matériel de transport de marchandises | EAU | https://m.11467.com/product/d31835834.htm | 2026-09-03 | _SENSIBILISATION DU TEMPS | Reported ~5% duty/~5% VAT; GCC/GSO + ESMA/MoIAT note | 11467

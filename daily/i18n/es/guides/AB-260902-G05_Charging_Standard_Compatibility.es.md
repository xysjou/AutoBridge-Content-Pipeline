...
Estos conectores DC son físicamente mutuamente incompatibles: no se puede conectar una pistola GB/T en una toma CCS2. La entrada AC (de baja/noche) también difiere por mercado y debe ser verificada por separado; un coche puede cargar rápidamente en un estándar mientras que su entrada AC todavía necesita atención.

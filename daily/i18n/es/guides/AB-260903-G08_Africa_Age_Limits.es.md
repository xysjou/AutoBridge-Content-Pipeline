...
- No reutilizar las figuras de la vieja reenvío 7-year (Kenya) o 12-year (Nigeria) — son superadas por los instrumentos primarios citados aquí.
...
**¿Cuál es el límite de edad de los autos usados de Kenia?** Material de normas primarias (KEBS DKS 1515: 2025 § 4.7.1, corroborado por KRA) establece vehículos de pasajeros a no más de **ocho años del año de primer registro**, con una tapa de un año en la brecha de fabricación a primer registro; las excepciones de uso especial son estrechas.
**¿Cuál es el límite de edad de los automóviles usados de Nigeria?** El Portal de Comercio de Ventanas Únicas de Nigeria establece que los vehículos **más de 15 años están prohibidos de importación**, mide a partir del año de fabricación, con un impuesto NAC; la reproducción de la lista de prohibición de aduanas es consistente en 15-year figure.
...
| Procedimiento de importación de automóviles (HS 8702–8705; vehículos más de 15 años prohibidos; NAC levy; redacción de dirección para volver a confirmar) | Nigeria Portal de Comercio de Ventanas Únicas | NG | https://tip.nsw.gov.ng/procedures/automobiles | 2026-09-05 | VERIFIED | Nigeria 15-year-from-manufacture ban; NAC levy; HS scope |
| Prohibición de la importación de aduanas Reproducción de listas — vehículos de motor usados por encima de 15 años de fabricación | Lex Artifex LLP (reproducción de la lista de aduanas de Nigeria) | NG | https://www.lexartifexllp.com/uz/list-of-contraband-goods-in-nigeria/ | 2026-09-05 | CROSS_CHECKED | Corroborato la prohibición basada en la fabricación 15-year (producción secundaria) |

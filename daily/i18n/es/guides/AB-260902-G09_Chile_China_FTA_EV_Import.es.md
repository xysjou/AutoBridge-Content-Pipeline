...
| --- | --- |
| Función general de la Asamblea General | 6% de CIF (valor de los átomos) para el origen no preference |
| IVA (IVA) | 19% sobre valor aduanero CIF + deber - cobrado incluso cuando el deber es de 0% bajo el TLC |
| Preferencia de los TLC para clasificar el origen chino | Ad-valorem duty 0%, condicional a un certificado de origen válido de la ALC y a la regla específica del producto |
| Cargos portuarios y porta-logísticos | Otros, más adelante y más específicos |
...
- Volver a verificar los cambios de propuesta/estatales a la fecha de embarque.

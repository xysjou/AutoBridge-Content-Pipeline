...
Institute Cargo Las cláusulas son publicadas por la Asociación de Mercados de Lloydd (LMA) y la Asociación Internacional de Subescritura de Londres (IUA)**; las palabras actuales (A)/(B)/(C) — referencias de cláusula ** CL382 (A), CL383 (B), CL384 (C)— entraron en vigor 1 de enero de 2009 ** (texto oficial de LMA; confirmado por una fuente primaria).

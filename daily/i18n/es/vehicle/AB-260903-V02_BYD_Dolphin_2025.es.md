# Delfín BYD 2025 (China): batería, rango CLTC y dos grados de motor para importadores
## Metadatos SEO
- **Título SEO**: BYD Delfín 2025 China Espec: batería, rango " controles de exportación
- **Meta descripción**: 2025 Chinese-market  BYD  Dolphin — 44.928/60.48 kWh Blade Battery, 70 vs 150 kW grados,  420/520 km  CLTC , DiPilot, con disciplina China-vs-overseas-spec para compradores.
- **H1**: BYD Delfines 2025 (Marco chino): Variedades, batería, ciclo de rango y verificación de exportación
- **Palabra clave principal**: byd delfín 2025 gama de las especificaciones de la batería
- **Términos de búsqueda secundarios**: BYD Delfines 44.9 kWh, Delfín 60.48 kWh Caballero, Delfín CLTC 420 520, BYD pequeña EV exportación, Delfín DiPilot, China EV GB/T carga
- **URL sugerida**: /vehicles/byd-dolphin/
- **Intención de búsqueda**: Comprender BYD Delfín 2025 (Marco chino): Variantes, Batería, Ciclo de rango y Verificación de exportaciones: lo que un exportador de vehículos/partes debe verificar, documentar y decidir antes de comprometerse a un pedido.
- **Sugerencias de enlaces internos**: /vehicles/byd-yuan-plus/ ; /vehicles/farizon-xingxiang-v6e-specs/ ; /guides/chinese-ev-charging-standard-compatibility/ ; /guides/ev-shipping-un3171-imdg-compliance/
- **Sugerencia de imagen**: estándar vs Knight comparación de grado
- **Texto ALT**: BYD Delfín 2025 dos grados de batería
...
- No relabel CLTC 420/520 como gama WLTP o EPA para clientes extranjeros.
- Donde una hoja de destino Dolphin utiliza WLTP/NEDC, cite **that** figura del mercado y mantenerla separada (referencia regional del mismo nombre – no un equivalente de trim-for-trim).
- Grabar tanto el nombre de la categoría china como su batería kWh en la nota de construcción, por lo que una etiqueta "420 " no es sustituida por una categoría diferente.

## Carga, software y ADAS (los cheques específicos de EV)
- **Connector:** Los edificios chinos utilizan la interfaz de carga GB/T; confirman la entrada de destino y si una puerta de entrada de adaptador/protocolo es aceptable (ver la guía estándar de carga). Un adaptador mecánico no garantiza la compatibilidad de apretón de manos.
- **ADAS:** la línea china ofrece **DiPilot** con ACC/AEB/Lane-Departure Assist en las categorías aplicables (fuente individual; confirme el conjunto de características de la calificación exacta).
- **Infotainment/OTA:** verifique el idioma UI, la capacidad de aplicación/servidor y OTA fuera de China **en el VIN** en lugar de asumir que una unidad de cabeza del mercado chino funciona sin cambios en el extranjero.
- ** Capacidad de CA/DC:** confirmar a bordo de la carga de AC y cualquier disposición de carga rápida de DC por grado en lugar de en toda la línea.
...
**¿Cuál es la diferencia entre las calificaciones del delfín?** Las calificaciones estándar utilizan un motor 70 kW con un paquete 44.928 kWh y 420 km CLTC; el Caballero utiliza 150 kW con 60.48 kWh y 520 km CLTC.
**¿Son cifras de rango de China CLTC comparables a WLTP?** No — cito CLTC como CLTC; utilice la propia hoja WLTP/NEDC del mercado de destino para rangos extranjeros.
**¿El delfín extranjero es idéntico al coche de China?** Comparte el nombre y el linaje de plataforma, pero la batería, el rango certificado y el equipo difieren por mercado; no los trate como 1: 1 equivalentes sin confirmación de BYD.
**¿Se cobra un delfín chino en el extranjero sin modificaciones?** Verifique la entrada GB/T contra la infraestructura de destino en el VIN; un adaptador solo puede no resolver las diferencias de protocolo.
...
| 2025 Página oficial delfín (red del oceano) | BYD Auto (**manufacturer official**) | CN | https://www.byd.com/cn/ocean-home/models/haitun/2025haitun | 2026-09-05 | VERIFIED (OEM; ámbito de identidad) | Ancla OEM para la identidad modelo de la 2025 China Dolphin, batería Blade LFP y e-platform 3.0; la página pública es una página de modelo dinámico y no publica una tabla de espectro numérico estática, por lo que los números de grado abajo son llevados por controles cruzados independientes |
| Delfín 智驾版 (DiPilot) página oficial modelo | BYD Auto (**manufacturer official**) | CN | https://www.byd.com/cn/ocean-home/models/haitun/haitun-zhijia | 2026-09-05 | VERIFIED (OEM; ámbito de identidad) | Identidad OEM para la línea de grado de conducción inteligente (DiPilot) y suspensión trasera independiente de cuatro enlaces |
| 2025 Tabla de grado/batería/fuera delfines | Base de datos modelo Autohome Q | CN | https://www.autohome.com.cn/ask/24636224.html | 2026-09-05 | SINGLE_SOURCE (sólo soportando) | Página de Q ларитерительного Q перете — sólo el contexto de apoyo, NO se utiliza como una pierna de control cruzado decisiva por regla de calidad de fuente |
| 2025 Tabla de configuración del parámetro del delfín | 太平洋汽车 PCauto config | CN | https://price.pcauto.com.cn/s48492/config.html | 2026-09-05 | CROSS_CHECKED | Tabla independiente de China (dimensionable): CLTC 420/520 líneas,  44.9/60.48 kWh, matricia de grado — pierna de comprobación cruzada decisiva # 1 |

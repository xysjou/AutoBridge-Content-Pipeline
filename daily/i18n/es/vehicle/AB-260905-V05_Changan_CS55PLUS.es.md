...
- **Meta Descripción**: Tercera generación del mercado chino Changan SUV de gasolina CS55 PLUS: Blue Whale NE 1.5T, 7DCT, dimensiones, uso de combustible WLTC, y por qué el híbrido es una línea separada.
...
- **Segundary Search Terms**: Changan CS55 PLUS export; tercera generación CS55; Blue Whale 1.5T; SUV de gasolina china; 7DCT
...
Esta página cubre sólo el ** tercera generación Changan CS55 PLUS (2024) con el motor de gasolina (ICE)**. La versión **super-hibrid es una línea separada** con diferentes figuras de cuerpo y de potencia y no se fusiona aquí. El mercado de referencia es **China**.
...
- ** Referencia de lanzamiento nacional chino (siempre que tenga en cuenta el tiempo)**: 9.99–11.39 — referencia nacional, no precio de exportación.
...
| motor | 新蓝鲸NE 1.5T | - | CHINA | SINGLE_SOURCE | 搜狐车型库 |
...
Para un SUV de gasolina, los cheques críticos de orden son la etapa **emisión y compatibilidad de combustible** en el país de destino, no el rango eléctrico. La calibración de China- 6, OBD y el grado de combustible (lo que espera 92/95 RON) deben conciliarse con los estándares de destino; el consumo WLTC capturado es una figura de laboratorio que varía con el combustible y la carga. Las diferencias detalladas por equipo de freno necesitan la hoja de configuración OEM. Mantenga la línea híbrida en su propia página en lugar de promedio de gasolina y números híbridos.
...
**Is 6.94 L/100 km a real-world figure?** It is a WLTC lab value; el uso real varía.
...
- **MODEL_TOPIC_MATCH**: exactamente Changan CS55 PLUS Gen3
- IMAGE_RIGHTS_STATUS #
- **ALT (idiomas 12)**:

...
## MPV Cúrculo: Carácter de asientos, espacio y pasajero
| Tema | Trumpchi E8 PHEV (referencia china) |
|---|---|
| Cuerpo | MPV de tamaño mediano |
| Longitud / ancho / altura | **4920 / 1900 / 1760 mm** |
| Base de ruedas | **2930 mm** |
| Diseño de asientos | ** 2+2+3, siete asientos** |
| Plataforma | GAC Global Platform Modular Architecture (GPMA 3.0 L); acero de alta resistencia alrededor de 75% (fuente individual) |
| Peso de la curvatura | 2175 kg |
| Tanque de combustible | 50 L |

La base de ruedas 2930 mm y 2+2+3 son la historia comercial: asientos independientes de capitán de centro y una tercera fila utilizable. Confirme la configuración exacta de asientos en el VIN, ya que los cambios de la unidad MPV a menudo alteran la especificación de la médula media.

## PHEV Powertrain (carging-port E8)
| Tema | Detalle |
|---|---|
| Motor | 2.0ATK híbrido dedicado (4B20L1), 103 kW / 180 N·m (unos 140 PS sólo motor) |
| Motor frontal | 134 kW / 300 N·m |
| Transmisión híbrida | 2-speed DHT |
| Batería | Litio terno, ** 25.57 kWh ** |
| Gama eléctrica | ** 150 km CLTC** |
| Exportación de energía | 3.3 kW descarga externa (V2L) y 5.5 kW V2V (fuente individual; confirma por OEM) |

## PHEV vs Glory HEV - Mantener el tipo de energía visible
- ** E8 Nueva Energía (esta página): PHEV** — puerto de carga exterior, batería de tracción 25.57 kWh, funcionamiento eléctrico de 150 km CLTC.
- ** E8 Gloria (荣耀): HEV** — ningún puerto de carga; se autocarga y no se puede conectar.
- El cociente de la gama eléctrica PHEV o la carga para una unidad de HEV de Gloria (o la fijación de un PHEV contra el equipo HEV) es el desajuste recurrente en este placa de nombre. Los precios de guía chinos también difieren (PHEV de aproximadamente RMB 209, 800; Gloria HEV de aproximadamente RMB 166, 800 - referencias domésticas y sensibles al tiempo solamente).

## Verificación del comprador de ultramar antes del pago
1. ** Tipo de energía en el VIN** — PHEV (puerto de carga) vs Glory HEV (sin puerto), declarado antes de cualquier frase de rango.
2. **Disposición de asiento** — 2+2+3 especificación de siete asientos y de medio punto confirmada por recortado.
3. **Conector de cambio** vs estándar de destino; ternary-lithium battery shipping documents (UN38.3 summary) per the IMDG 42-24 guide.
4. ** V2L/V2V reclamaciones de potencia de exportación** confirmadas en la hoja OEM (fuente individual aquí).
5. **Clase de registro híbrido de destino y documentos** por lista de verificación de documentos de exportación.

## Solicitar una calificación de exportación actual
No se publica precio de exportación. Los precios de los guías chinos son **referencias domésticas, sensibles al tiempo, no FOB/CIF**. Solicitar presupuesto en directo con **Destination Country · Cantidad · PHEV o HEV Trim · LHD/RHD · Puerto de destino · Incoterm**.

## Preguntas frecuentes
**¿Es el Trumpchi E8 un híbrido enchufable o un híbrido auto-explotación?** La nueva energía E8 es un PHEV con un puerto de carga; la Gloria E8 es un HEV no cargado — especificar cuál.
**How many seats?** A 2+2+3 seven-seat MPV on a 2930 mm wheelbase.
**¿Cuál es la gama eléctrica?** 150 km CLTC para el PHEV documentado.
**¿Pueden los dispositivos externos de energía E8?** Listas de cobertura china 3.3 kW V2L y 5.5 kW V2V; confirmar en la hoja de ajuste OEM exacta.
...
|---|---|---|---|---|---|---|
| Mesa oficial de configuración de Trumpchi E8+ | GAC Trumpchi (OEM) | CN | https://www.gacmotor.com/configtable?id=811 | 2026-09-04 | VERIFIED (OEM) | PHEV powertrain, batería, dimensiones, asientos |
| E8 (PHEV) lanzamiento, tamaño y electrificación | Southern Metropolis Daily | CN | http://m.toutiao.com/group/7281953819724988991/ | 2026-09-04 | CROSS_CHECKED | Dimensiones, motor, batería |
| E8 showroom: tamaño/motor/batería | YouCheYiHou | CN | http://m.toutiao.com/group/7282038365669982759/ | 2026-09-04 | CROSS_CHECKED | Motor, peso, V2L/V2V |
| E8 GPMA arquitectura & acero de alta resistencia | Yangcheng Evening News PDF | CN | https://ep.ycwb.com/epaper/ycwb/resfile/2023-12-13/A11/ycwb20231213A11.pdf | 2026-09-04 | SINGLE_SOURCE | Plataforma, ~ 75% HSS |
| Trumpchi E8 Nuevos config de línea completa de energía | PCauto config | CN | https://car.pcauto.com.cn/360/s47354/r1/config.html | 2026-09-04 | CROSS_CHECKED | Dimensiones, 25.57 kWh, rango CLTC |
...
* Nota de confianza: página OEM capturada; ratio de acero de plataforma y V2L/V2V figuras son de un solo recurso. PHEV y Glory HEV deliberadamente separados; referencia del mercado chino solamente. *
...
- **Mercadillo de referencia**: China, E8 Nueva energía PHEV (referencia del mercado chino; CLTC declaró; Gloria HEV separados; no una especie global)
- **Método de verificación**: OEM config anclado; división de tipo energético aplicada; elementos de un solo recurso marcados

...
## Fahrwerk und Radstand: Standard vs Long
| Position | Standardradstand | Langer Radstand |
|---|---|---|
| Gesamtlänge | **5330 mm** | **5620 mm** |
| Breite/Höhe | 1965 / 1920 mm | 1965 / 1920 mm |
| Radstand | **3110 mm** | **3400 mm** |
| Standardbett (L × W × H) | **1520 × 1590 × 470 mm** | Längeres Bett auf dem 3400 mm-Chassis |
Die Standardabmessungen des Radstands werden zwischen dem JAC-Export-OEM-Standort und einer chinesischen strukturierten Quelle abgeglichen; die Zahlen für den langen Radstand werden in zwei chinesischen Quellen abgeglichen. Bettlänge ist der klarste Weg, um die beiden Chassis auseinander zu halten; Radstand und Bett Innenabmessungen gegen die VIN aufzeichnen.

## Antriebsstrang (Dieselfokus: Motor, Getriebe, Kraftstoff, Emission)
| Position | T9 Hunter Diesel — chinesischer Marktreferenz |
|---|---|
| Motor | 2.0T Reihen-4 Turbodiesel |
| Leistung/Drehmoment | **125 kW / 410 N·m** |
| Getriebe | **ZF 8-speed Automatik (8AT)** |
...
1. **Chassis/Bett**: Standard (3110 mm) vs. lang (3400 mm) – Bettlänge entscheidet die Linie.
2. **Drivetrain**: 4x4 mit 2H/4H/4L und Hecksperre vs. jeder 4x2 Version; explizit angeben.
3. **Market Label on Capacity**: 3500 kg Schleppen = EXPORT Fabrikdaten; 1000 kg Nutzlast = China-Rating; Abgleichen mit der Bestimmungsortbewertung.
4. **Chinesisches Antriebsstränge-Vertrauen**: 125 kW / 410 N·m /ZF 8AT/4WD sind Single-Source für China - finalisieren Sie gegen das Herstellerblatt.
5. **Dieselnachbehandlung und Kraftstoff Schwefel** nach dem Leitfaden für die Emissions-/Kraftstoffverträglichkeit; **HS-Klassifizierung** nach dem HS-Code-Leitfaden für die Ausfuhr.

## Übersee-Käufer-Überprüfung vor Zahlung
- VIN-to-Chassis (Standard / lang) und Bettabmessungen; 4WD Modus und Hecksperre Präsenz auf dem Baublatt.
- Behandeln Sie 3500 kg Schleppen als Export Fabrikdaten nur; Beurteilen Sie das Schleppen / Nutzlast auf der ** Ziel ** Homologation.
- Lenkseite (LHD/RHD) offiziell bestätigt; Emissions- und Dieselkraftstoff-Kompatibilität.
- Dokumentsatz für die Checkliste Exportdokumentenpaket.

## Beantragen Sie eine aktuelle Ausfuhrquote
Es wird kein statischer Ausfuhrpreis veröffentlicht. Erkundigen Sie sich bei **Zielland · Menge · Standard / Langbett · LHD / RHD · Zielhafen · Incoterm **.

## Häufig gestellte Fragen
**Welchen Motor und welches Getriebe verwendet der T9 Hunter?** Ein 2.0T Diesel (125 kW/410 N·m) mit einer ZF 8-speed Automatik; für den chinesischen Markt sind diese Single-Source-Single-Source-Single-Source-Single-Source-Single-Source-Single-Source-Single-Source-Single-Source-Single-Source-Single-Source-Single-Source-Single-Source-Single-Source-Single-Source-Single-Source-Single-Single-Single-Single-Single-Single-Single-Single-Single-Single-Single-Single-Single-Single-Single-Single-Single-Single-Single-Single-Single-Single-Single-Single-Single-Single-Single-Single-Single-Single-Single-Single-Single-Single-Single-Single-
**Hat es einen Allradantrieb mit geringer Reichweite? ** Ja — BorgWarner Teilzeit 4WD mit 2H/4H/4L und einer hinteren Differentialsperre auf dem dokumentierten 4x4.
**Standard oder langes Bett? ** Beide: 3110 mm Radstand/ 5330 mm insgesamt oder 3400 mm/5620 mm; Bettlänge unterscheidet sich entsprechend.
**Ist die 3500 kg Zugfigur ein chinesischer zertifizierter Wert?** Nein — es ist ein Exportmarkt JAC Fabrik Figur; Nutzlast 1000 kg ist der China-Rating-Wert, und Ziel Ratings müssen separat bestätigt werden.
...
- **Referenzmarkt**: Identität CHINA+EXPORT; Abschlepp-EXPORT; Nutzlast CHINA; chinesischer Antriebsstrang aus einer Hand
- **Verifizierungsmethode**: Identität des SAME_MODEL-Systems mit zwei OEM-Systemen; Vertrauenssiegel pro Markt; Exportzahlen, die nicht auf die chinesische Homologation aufgewertet wurden

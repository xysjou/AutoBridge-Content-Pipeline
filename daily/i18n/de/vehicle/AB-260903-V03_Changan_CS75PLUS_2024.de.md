...
|---|---|---|
| Maximalleistung | 138 kW (≈188 PS) | 171 kW (≈233 PS) |
| Maximaldrehmoment | 300 N·m | 390 N·m |
| Übertragung | Aisin 8-speed Automatik | Aisin 8-speed Automatik |
| Antrieb | Vorderradantrieb | Vorderradantrieb |
| Kraftstoff | Benzin (Turbo); Bestätigung der Güte und Bestimmungskraftstoff/Emissionsstufe | Benzin (Turbo) |
...
Es wird kein statischer Ausfuhrpreis veröffentlicht. Die ungefähr RMB 121, 900 chinesische Ausgangszahl ist eine ** inländische, zeitsensitive Referenz nur - nicht ein FOB / CIF Zitat **. Erkundigen Sie sich bei **Zielland · Menge · Trim & Motor · LHD / RHD · Zielhafen · Incoterm **.

...
| Position | 55 Version | 120 Version |
|---|---|---|
| Frontantriebsmotor (PMSM) | 132 kW (180 PS) 316 N·m | 145 kW (197 PS) 325 N·m |
...
- **Modes**: EV (charge-depleting) und Hybrid (charge-sustaining) Betrieb; Ladung-Sustaining Kraftstoffverbrauch wird um 3.8 L 100 km (NEFZ) zitiert. Erklären Sie den Kunden für eine Exportflotte, dass der Kraftstoffverbrauch in der realen Welt vom Ladeverhalten abhängt - ein PHEV, der ohne Aufladung betrieben wird, verhält sich wie ein Hybrid, kein Elektrofahrzeug.
- **Top Speed**: 185 km/h.
## Batterie, Aufladung und Zwei-Bereiche-Disziplin
Ein PHEV trägt **zwei ** Range-Nummern, die Käufer verschmelzen: ** Nur elektrischer Bereich** (Zyklus angeben): 120 NEFZ = 101 WLTC) und eine separate **kombinierte Kraftstoff- und Batteriereichweite ** (eine ~ 1245 km chinesische Laborfigur ruht auf einer einzigen Quelle und muss als zitierte chinesische kombinierte Nummer dargestellt werden, niemals als elektrische Reichweite). Die Gebühren unterscheiden sich nach Version und Grad: Bestätigung der fahrzeugseitigen AC-Fähigkeit, **ob DC-Schnellladung in der gewählten Klasse enthalten ist**, GB/T-Steckverbinder im Vergleich zur Zielinfrastruktur,  und die Kraftstoffqualität 1.5L engine expects — a PHEV benötigt sowohl einen Ladepfad als auch einen Motordienst/Kraftstoffpfad.
## Abmessungen und Kabine
4765 × 1837 × 1495 mm, Radstand 2718 mm, viertürige fünfsitzige Monocoque-Limousine; Reifen 225/60 R16 auf erfassten Klassen. Bestätigen Sie das Leergewicht nach Batterieversion auf der Konformitätsplatte.
## Was AutoBridge über einen Spec-Tisch hinausfügt
...
## Vor Zahlung
- Fix ** 55 oder 120 **,  with matching motor (132/145 kW)  and  battery (8.32/18.32 kWh) on the VIN build sheet.
...
Es wird kein statischer Ausfuhrpreis veröffentlicht; der RMB 79, 800–125, 800 China Glory Edition Guide Preis ist eine ** inländische, zeitkritische Referenz, nicht eine FOB / CIF Figur **. Erkundigen Sie sich bei **Zielland · Menge · Version (55/120) & Grade · LHD/RHD · Zielhafen · Incoterm**.
## Häufig gestellte Fragen
**Was unterscheidet sich zwischen 55 und 120 ?** Der 120 hat eine 18.32 kWh-Batterie, einen stärkeren 145 kW-Motor, eine längere elektrische Reichweite und eine schnellere Beschleunigung; der 55 verwendet 8.32 kWh und 132 kW.
**Ist der 1.5L der Hauptantrieb?** In DM-i ist es hauptsächlich ein Generator Assist; Der Elektromotor bietet primären Antrieb.
**Warum zwei Elektrostreckennummern?** China Labels NEDC und WLTC (120 NEDC = 101 WLTC); immer den Zyklus zitieren.
...
|---|---|---|---|---|---|---|
| BYD QIN PLUS DM-i offizielle Regionalseite (en-bh = Bahrain Länderseite) | BYD (**Beamter des Herstellers**) | Export **Bahrain (regionale en-bh-Seite; nicht VAE) ** | https://www.byd.com/en-bh/car/qin-plus-dmi | 2026-09-03 | **VERIFIZIERT (Scope: nur Qin Plus DM-i)** | 18.3 kWh Packung, bis 197 hp/145 kW, 7.3 s für den benannten Qin Plus DM-i |
| Glory Edition 55/120 Config | Autohome (汽车之家) | CN | http://dealer.autohome.com.cn/2116572/spec_66744.html | 2026-09-02 | CROSS_CHECKED | Abmessungen, 1.5L 81 kW, 132 kW Motor, E-CVT, Reichweite |
| Glory Edition Launch Details | Autohome Chejiahao | CN | https://chejiahao.m.autohome.com.cn/info/18481020 | 2026-09-02 | CROSS_CHECKED | 145 kW/325 N·m, 18.32 kWh, kombiniertes Angebot |
| Qin Plus Konfiguration | Xcar (爱卡) PCauto Guazi | CN | https://newcar.xcar.com.cn/m72508/config.htm | 2026-09-02 | CROSS_CHECKED | Bordsteingewicht, Radstand, NEFZ/WLTC, Batterie |
| 汽车之家 (车家号) 秦 PLUS DM-i 荣耀版上市 | 汽车之家 | CN | https://chejiahao.m.autohome.com.cn/info/14654247 | 2026-09-02 | SINGLE_SOURCEN | 发动机 81kW/135N·m、电机 132kW/145kW、指导价 7.98-12.58 万 |
| 瓜子二手车 参数页 | 瓜子二手车 | CN | https://m.guazi.com/qichecanshu/c163518812263347.html | 2026-09-02 | SINGLE_SOURCEN | 55KM 版电池 8.32kWh、电机 132kW/316N·m、电耗 11.4 |
| 太平洋汽车 参数页 | 太平洋汽车网 | CN | https://price.pcauto.com.cn/m126873/config.html | 2026-09-02 | SINGLE_SOURCEN | 轴距 2718mm、油耗、0-100 加速 |

*Vertrauenshinweis (AutoBridge-Standard): Die Großbatterieausgabe/das Großbatteriepaket wird auf der BYD-eigenen regionalen Qin Plus DM-i-Seite (en-bh/Bahrain) VERIFIZIERT; detaillierte Zahlen der China-Version sind CROSS_CHECKED. Die kombinierte Zahl ~ 1245 km ist SINGLE_SOURCE und eine kombinierte Zahl im chinesischen Zyklus. Überseeische Zahlen werden nur von BYD-Seiten verwendet, die explizit "Qin Plus DM-i" nennen; keine SAME_ MODEL-Beziehungen zu einem anders benannten BYD PHEV werden ohne expliziten OEM-Beweis abgeleitet (RELATED_MODEL ≠ SAME_MODEL). *
## Editorial Review
...
- **Referenzmarkt**: China 2024 Glory Edition PHEV (Exportplattformnamen variieren)
- **Verifizierungsmethode**: OEM-Exportseite + Multi-Datenbank-Kreuzprüfung; Elektro-Visualisierung von Reichweiten- und Testzyklen

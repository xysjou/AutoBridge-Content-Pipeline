...
Der Emgrand ist Geelys volumenstarke Kompaktlimousine und ein natürlicher Kandidat für preissensible Einstiegsmärkte. Die Falle für einen Importeur ist generationenübergreifend: Diese Seite behandelt das ** 4th-generation 2024 chinesische Marktauto (REFERENZMARKT): CHINA**  while an **all-new 5th generation launched in China in November 2025** with a longer body, Längerer Radstand  and  einen niedrigeren Startpreis. Quoting a 2024 unit against 5th-gen dimensions — or vice versa — ist der häufigste Bestellfehler bei dieser Baureihe. Behandeln Sie jede Zahl unten als **Chinesische Referenzspezifikation**; Motorabstimmung, Emissionsstufe und Ausrüstung für den Bestimmungsmarkt unterliegen der örtlichen Zulassung, nicht diesem Blatt.

## Chinesisch-Marktvariante und Antriebsstrang (ICE-Fokus: Motor, Getriebe, Kraftstoff, Emission)
| Position | 4th-gen Emgrand 2024 (China Referenz) |
|---|---|
| Körperbauart | 4-door, 5-seat Limousine |
| Motor | 1.5L naturally aspirated inline-4 petrol |
| Maximalleistung | 93 kW (≈127 PS) |
| Maximaldrehmoment | 127 N·m (Single-Source; bestätigen Sie auf dem genauen Trimmblatt) |
| Übertragung | 5-speed Handbuch **oder ** CVT |
| Antrieb | Vorderradantrieb |
| Kraftstoff/Note | Benzin; bestätigen Sie die Kraftstoffqualität und die Bestimmungsemissionsstufe (China-6 spec ist nicht, von sich aus, Euro-Zertifizierung) |
...
- **Neuer: ** 5th Generation, China startet November 2025 (TIME_SENSITIVE; Verfügbarkeit und Spezifikationen ändern sich je nach Markt).
- Empfohlene Praxis: Zustandsgenerierung ** und ** Modelljahr ** und ** Produktionsdatum auf dem PI. Ein "Geely Emgrand" -Label allein ist mehrdeutig in 2024–2026.

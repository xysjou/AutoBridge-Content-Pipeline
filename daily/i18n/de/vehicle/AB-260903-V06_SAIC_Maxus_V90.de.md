...
## Kommerzielle Spezifikationen für die Abstimmung pro Einheit
1. **Genaues Modell/Ankündigungscode** → Motorleistung, GVW, Sitze, Körpertyp.
2. **Payload/GVW und Hinterachse** (Einzel-/Zweirad) für die vorgesehene Last.
3. **Emissionsstufe** (China Diesel Standard) vs Bestimmungsziel; Toleranz der Dieselkraftstoffqualität.
4. **Körpertyp-Lizenzkategorie** im Bestimmungsort (PKW-Minibus vs. Güterwagen vs. Fahrgestell für den Umbau).
5. **Spare-Teile und Service** für den SAIC π Motor und das ZF/6AT Getriebe im Markt.

## Ausfuhrbedenken
- Ein Personenbeförderer (9–15 Sitze) und ein Frachtwagen haben unterschiedliche Genehmigungs- und Lizenzierungswege; auf dem PI ist die Zahl der Karosserie und des Sitzes anzugeben.
- Bestätigen Sie **LHD/RHD**, Clustersprache und ob eine Konvertierung (Krankenwagen, Wohnmobil, Shuttle) in China oder nach dem Import erfolgt.

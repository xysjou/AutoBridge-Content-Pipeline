...
## SEO Metadaten
- **SEO Titel**: China Vehicle Export Document Package Guide — GB/T 21085-2020 Current Standard
...
- ** Primäres Schlüsselwort**: Fahrzeugexportdokumentpaket Werkszertifikat GB/T21085
...
- **Interne Linkvorschläge**: /guides/vin-nameplate-verification-chinese-vehicles/; /guides/ev-shipping- un3556-imdg-compliance/; /guides/china-export-certificate-of-origin/
- **Bildvorschläge**: Layout des Dokumentbündels; Zeitleiste des aktuellen vs. Entwurfs; Dateisplit inländische vs. Exportdatei
- **ALT Vorschläge**: "Current GB/T21085-2020 certificate versus mandatory 20260041-Q-339 draft"
...
- **WÄHRENDER STANDARD: GB/T 21085-2020 *Kraftfahrzeug-Fabrikzertifikat *** — ein **empfohlener ** nationaler Standard, ausgestellt 2020-04-28, in Kraft 2020-11-01, und ** als noch aktuell auf 2026-01-27 ** bewertet. Das Fabrikzertifikat wird vom produzierenden Unternehmen ausgestellt.
- ** ZUKUNFT / ENTWURF: mandatory *Vehicle factory certificate*, plan number 20260041-Q-339** — intended to replace GB/T 21085-2020, assigned 2026-01-27 with a 16-month cycle and currently under approval; Der MIIT "GB 21085 —XXXX" Text ist ein ** Konsultationsentwurf**. Es ist **nicht veröffentlicht, nicht wirksam und darf niemals als aktuell oder obligatorisch in einem käuferorientierten Dokument gekennzeichnet werden.
...
In einem früheren Entwurf wurde beschrieben, wie Fahrzeuge, die aus importierten unvollständigen Fahrzeugen oder über mehrstufige Fertigung fertiggestellt wurden, nur eine Fabrikbescheinigung für ganze Fahrzeuge erhalten würden. Die ** einzige Quelle dieser Regel ist ein Konsultationsentwurf **; es wird **nicht durch den aktuellen GB/T 21085-2020 Text oder eine aktuelle Regelung bestätigt **, so dass es **nicht als aktuelle Anforderung angegeben wird ** hier. Behandeln Sie eine solche Vereinbarung von Fall zu Fall, bis ein nicht entwurfsgebundener Entwurf vorliegt.
...
- Für ein **neues Energiefahrzeug**: Batterie ** UN38.3 Testzusammenfassung **, Gefahrgut-Verpackungszertifikat, falls zutreffend, und MSDS (verlinkt mit dem IMDG Versandführer).
...
1. Bestätigen Sie, dass das Werkszertifikat unter **aktuellem GB/T 21085-2020 ** ausgestellt wird – fordern Sie nicht den noch nicht veröffentlichten obligatorischen Standard.
...
4. Für NEVs, bereiten Sie UN38.3/MSDS pro dem gebuchten Carrier (Empfehlung).
...
|---|---|---|---|---|---|---|
| GB/T 21085-2020 Fabrikzertifikat (aktuell) | SAMR openstd | CN | https://openstd.samr.gov.cn/bzgk/std/newGbInfo?hcno=1FBD2FBDA2AAFED7B856221F3FF5EFFB | 2026-09-04 | VERIFIZIERT (primär) | Aktueller Standard/Status/Daten |
| SAMR-Plattform · GB/T 21085-2020 Details | SAMR | CN | https://std.samr.gov.cn/gb/search/gbDetailed?id=A47A713B75CF14ABE05397BE0A0ABB25 | 2026-09-04 | VERIFIZIERT (primär) | Ausgabe/Wirkungsdatum/Prüfungstermine |
| Obligatorischer Standardplan 20260041-Q-339 (zukünftig, in Entwicklung) | SAMR | CN | https://std.samr.gov.cn/noc/search/nocPlanDetailed?id=49850161EF55CEAEE06397BE0A0AC481 | 2026-09-04 | TIME_SENSITIVE (primär) | Entwurf/zukünftiger Status |
| SAMR-Mitteilung, 24 verbindliche Standardpläne zuzuweisen | SAMR/SAC | CN | https://www.samr.gov.cn/cms_files/filemanager/1647978232/attach/20261/82b38302792642c083f8d8ff5144fd7f.pdf | 2026-09-04 | VERIFIZIERT (primär) | Planzuweisung |
| MIIT GB21085 —XXXX Konsultationsentwurf (nicht aktuell) | MIE | CN | https://www.miit.gov.cn/cms_files/filemanager/1226211233/attach/20263/0bc57c477169401e840a5a60c06b5d83.pdf | 2026-09-04 | ENTWURF (primär) | Nur Draft-mehrstufiger Text (vom aktuellen Wortlaut blockiert) |
| Arbeitsregeln für die Zulassung von Kraftfahrzeugen (Dateien zum Exportverkauf) | Xiantao Stadtgov | CN | https://www.xiantao.gov.cn/ztzl/zcwj1/zc1/202510/t20251029_5800319.shtml | 2026-09-04 | VERIFIZIERT (primär) | Kontrollbescheinigung + Lizenzexemplar |
| Ausfuhrdatei für ganze Fahrzeuge | NetEase | CN | https://www.163.com/dy/article/KJSNGPO20556820S.html | 2026-09-04 | CROSS_CHECKED | Übergabesatz, NEV/Übersetzungsempfehlungen |
*Entwurf für ein Gate: Mehrstufige Ausgaberegeln und der obligatorische Ersatz sind DRAFT/FUTURE und von den aktuellen Anforderungserklärungen ausgeschlossen; NEV/Übersetzungsposten sind redaktionelle Empfehlungen. *

## Editorial Review
- **AutoBridge Export Editorial Team · Methode nach unserer [Editorial Policy](/redaktionelle Politik/)
- **Zuletzt überprüft**: 2026-09-05
- **Referenzmarkt**: Chinesische Fahrzeugdokumente (Abnahme von Zielort-CoC ausgeschlossen)
- **Verifizierungsmethode**: Aktuelles GB/T21085-2020 verankert auf SAMR; Entwurf/Zukunftsstandard explizit unter Quarantäne gestellt

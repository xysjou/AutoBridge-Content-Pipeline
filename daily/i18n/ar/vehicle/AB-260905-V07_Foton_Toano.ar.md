...
The **Foton Toano (图雅诺, 2026)** هي شاحنة كبيرة ديزل للسوق الصيني/light bus offered across many wheelbases and seat counts. لأن مصفوفة البديل واسعة، هذه الصفحة مكتوبة حول ** تشكيلات محددة فقط** بدلا من مشهد واحد ضمني "توانو". السوق المرجعية** الصين**.

## الأبعاد المحددة، والقوة، والمقعد
- ** الجسم الشائك (X5)**: 4990 × 1980 × 1990، قاعدة العجلات 3070 mm.
- ** قاعات العجلات الطويلة**: 3510（X5长轴）/3750（经典长轴，车长5990×2000） mm.
- ** 2.5T من مصباح الديزل**: 400 N·m من طراز عتاد الـ 6MT.
- **Seats**: 3/5/6/7/9/14/15/17（随版本）.
- ** مذكرة تحويل**: F2.8NS6B177L：2780mL/130kW，属冷藏改装上装 — الجسم المبرّد هو تجهيز إضافي (upfit), ليس تحديد لـ (بواس)

## جدول مواصفات مصدق عليه (مراجع السوق الصينية)
| المواصفات | القيمة | الوحدة | السوق | الثقة | مذكرة المصدر |
|---|---|---|---|---|---|
| x5 دون سن | 4990×1980×1990 | مم | CHINA | SINGLE OURCE | 搜狐对比 |
| x5 قاعدة متحركة قصيرة | 3070 | مم | CHINA | SINGLE OURCE | 搜狐对比 |
| خيارات قاعدة العجلات الطويلة | 3510 (X5)/ 3750 (经典长轴، 车长، 5990، × 2000) | مم | CHINA | SINGLE OURCE | 搜狐对比 |
| engine 2 5t torque | 400 | N m | CHINA | SINGLE OURCE | 大众网 |
| إرسال | 6MT | - | CHINA | SINGLE OURCE | 大众网 |
| خيارات مقعد | 3/5/6/7/9/14/15/17（随版本） | - | CHINA | صرخات | 大众网 + 搜狐 |
| مذكرة تحويل مبردة | F2.8NS6B177L：2780mL/130kW，属冷藏改装上装 | - | CHINA | SINGLE OURCE | 大众网 |

## تركيز المشتريات في فان: اختيار تشكيلة واحدة، وفصل المقتطفات
ويجب على المشترين من فان أن يصلحوا قاعدة العجلات، وارتفاع السقف، وحساب المقاعد (الجوازات) أو مخططات الشحن، والمحرك قبل مقارنة الأسعار. أما مصفوفة الطاقة الكاملة التي تبلغ ISF2.8 وكميات فتتم إشعالها فيتم القبض عليها دون أن تُحتجز** في انتظار ورقة من طراز OEM؛ ولم تُعامل القيود التي تُدخل في الأعاصير إلا كقناة. وجهاز التبريد أو سيارة الإسعاف هو هيكل حساس على شكل فوضوي**، ويحتاج إلى تقييمه الخاص للشحن/العزل/التبريد.

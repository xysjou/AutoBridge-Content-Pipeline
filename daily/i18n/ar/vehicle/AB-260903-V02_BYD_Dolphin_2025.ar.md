...
- ** المُدير:** وتستخدم البنايات الصينية واجهة الشحن GB/T؛ وتتأكد من مدخل الوجهة، وما إذا كان بوابة مقبولة (انظر دليل المعايير للشحن). المكيف الميكانيكي لا يضمن التوافق بين المصافحة
- ** خط الصين يعرض ** ديبول** مع لجنة التنسيق الإدارة على الدرجات المنطبقة (مصدر خارجي، تأكيد مجموعة سمات الصف بالضبط).
- ** التحقق من اللغة المستخدمة في النقل غير المشروع وغير المستعمل، وقابلية ووكالة التجارة الدولية خارج الصين ** عن شبكة المعلومات الشخصية** بدلا من افتراض أن وحدة رئيس السوق الصينية تعمل بدون تغيير في الخارج.
...
5. **EV shipping paperwork** — UN38.3 MSDS plus the ocean dangerous-goods classification, بموجب تعديل IMDG 42-24 (الطلب من 2026-01-01) مركبة ذات طاقة الليثيوم أو أيونية مصنّفة UN3556، (أ) ليس الإرث العام UN3171؛ تطبيق تفاصيل دعم البرامج على كل من صحيفة وقائع الشحن الإلكترونية الحالية والناقل (انظر دليل الامتثال للمحيطات EV).
...
- ** طريقة الفرز**: (أ) التحقق من مصادر متعددة؛ وظل نطاق دورة النطاق ونطاق السوق متميزين لكل قاعدة من قواعد - قاعدة السلع الأساسية

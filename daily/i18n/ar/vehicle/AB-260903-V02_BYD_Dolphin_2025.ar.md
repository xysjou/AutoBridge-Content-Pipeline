...
- ** مقترحات داخلية بشأن الروابط**: /حلقات/حلقات/بضائع من نوع يوان/ب؛ /حلقات/عناصر تغنيكسيانغ - v6e-specs/؛ /مبادئ توجيهية/مقارنات بين المستوى الصيني والمتوسط/؛ /مبادئ توجيهية/تكلفة تصل إلى un3171-imdg-compliance/
- ** اقتراحات تتعلق بالصور**: مقارنة قياسية برتب الفرسان؛ ومذكرة بود باتري؛ وموانئ الشحن GB/T؛ وشاشة التناوب/الاحتواء؛ وشاشة الجلوس الخلفية
...
الدلافين هو مضرب بواسطه بطاريه مدمجه على المزيج الإلكتروني 3.0 مع كتيبة ل. بالنسبة لـ "إي في" ، الأمر هو "الدرّاجة ** الدراجة ** حرف ** حرف محرك / شحن/أو برمجة، وليس رقماً واحداً من خطّات الرأس. وتغطي هذه الصفحة خط السوق الصيني البالغ 2025 ** (REFERENCE MARKET: **. و أيضاً يبيع (بي دي) شارة " دولفين " في الأسواق الخارجية هذا هو استمرارية الاسم  **not** a 1: مطابقـة مقاسـيـة مـن الـ 1 مـن المواصفات - أحجام البطاريـات الخارجية دورات النطاق المصدق عليها (WLTP/NEDC)  and  المعدات تختلف  and  يجب أن يقرأ من صحيفة الوجهة لم يُستدل من أرقام الصين هذه

## موتورز غراديس، بطاريتان (مراجعة الصين)
| البند | Standard grades (活力/自由/时尚) | Knight grade (骑士版) |
|---|---|---|
| دراجة | 70 kW / 180 N·m | 150 kW / 310 N·m |
| Battery (LFP) | 44.928 kWh | 60.48 kWh |
| نطاق لجنة التجارة الدولية | 420 km | 520 km |
| الهيئة LW × ×H | 4125 / 1770 / 1570 mm | 4150 / 1770 / 1570 mm |
| Wheelbase | 2700 mm (كلاهما) | 2700 mm |

محرك ثابت ومحرك معا**: الأزواج البالغ عددهم 150 kW / 310 N·m مع مجموعة أكبر من الـ 60.48 kWh على درجة الفارس. تقديم " دولفين " بدون تسمية يترك كل من القوة و المدى غامض

## تأديب دورة مياه الأمطار (CLTC ليست WLTP/EPA)
The 420/520 km figures are **China CLTC**. دائماً ما يقتبس من الدورة بجانب الرقم
- لا تُعيدي تَرَدُّمَ شركة CLTC 420/520 كمدى للشركة العالمية للدب أو وكالة حماية البيئة بالنسبة للزبائن في الخارج.
- حيث تُستخدم ورقة دولفين مقصدها (WLTP/NEDC) تشير إلى رقم السوق** وتُبقيها منفصلة (مراجعة الاسم نفسه الإقليمية - ليس ثلاثية مقابل ثلاثي)
- سجل اسم الصف الصيني وبطارية كه على ورقة البناء لذا "420" علامة ليست بديلة من درجة مختلفة

## الشحن والبرمجيات والتجهيزات (الفحوص الخاصة بالمركبات)
- ** المُدير:** وتستخدم البنايات الصينية واجهة الشحن GB/T؛ وتتأكد من مدخل الوجهة، وما إذا كان بوابة المكيِّف/البروتوكول مقبولة (انظر دليل المعايير للشحن). المكيف الميكانيكي لا يضمن التوافق بين المصافحة
- ** خط الصين يعرض ** ديبول** مع لجنة التنسيق الإدارية/مجلس الإدارة/مساعدة الإدارة على الدرجات المنطبقة (مصدر خارجي، تأكيد مجموعة سمات الصف بالضبط).
- ** المعلومات/المكتب:** التحقق من اللغة المستخدمة في النقل غير المشروع وغير المستعمل، وقابلية التطبيق/الخدمة، ووكالة التجارة الدولية خارج الصين ** عن شبكة المعلومات الشخصية** بدلا من افتراض أن وحدة رئيس السوق الصينية تعمل بدون تغيير في الخارج.
- ** قدرة لجنة المساعدة الإنمائية:** تؤكد على متن السفينة AC charging وأي حكم من ترتيبات الشحن السريع في العاصمة حسب الرتبة وليس على امتداد الخط بأكمله.
...
3. ** موصل بين GB/T و/أو مقصد**، حكم لجنة التنسيق الإدارية/الدول، وأي مشروعية مكيفة.
4. ** قائمة خاصة بالحزب الديمقراطي** للصف المحدد؛ **** تم اختبار اللغة/اللغة** على شبكة الإنترنت.
5. **EV shipping paperwork** — UN38.3 / MSDS plus the ocean dangerous-goods classification, بموجب تعديل IMDG 42-24 (الطلب من 2026-01-01) مركبة ذات طاقة الليثيوم أو أيونية مصنّفة UN3556، (أ) ليس الإرث العام UN3171؛ تطبيق تفاصيل الوثائق/مكتب دعم البرامج على كل من صحيفة وقائع الشحن الإلكترونية الحالية والناقل (انظر دليل الامتثال للمحيطات EV).

## طلب تخصيص موارد التصدير الحالية
ولا يُنشر أي سعر ثابت للصادرات. The RMB 99, 800 Chinese starting figure is a **domestic, time-sensitive reference, not an FOB/CIF price**.: إجراء تحقيق مع ** بلد الاستضافة؛ الكمية؛ الدرجة (البطانة/الحركة) · LHD/RHD; ميناء الوجهة; Incoterm**.

## الأسئلة المتكررة
**What is the difference between the Dolphin grades?** The standard grades use a 70 kW motor with a 44.928 kWh pack  and  420 km من لجنة مكافحة الإرهاب؛ ويستخدم الفرسان 150 kW مع 60.48 kWh و520 km من كلوريد الكربون.
** هل توجد أرقام عن النطاقات التي تقارن بها لجنة التجارة الدولية في الصين، مقارنة بالمجموعة العالمية للأفضليات التجارية؟** لا، اقتباس من مركز التجارة الدولية كمركز للتداول، استخدام ورقة سوق الوجهة الخاصة WLTP/NEDC للمجموعة الخارجية.
** هل دولفين الخارج متطابق مع سيارة الصين؟ ** وهي تشاطر الاسم والخط المنصّي، ولكن البطارية، والنطاق المصدّق والمعدات تختلف حسب السوق؛ ولا تعاملها على أنها 1: 1 معادلة دون تأكيد من جانب شعبة التنمية.
...
|---|---|---|---|---|---|---|
| 2025 إطلاق دولفين (الخاصة، البارامترات) | IT Home / Toutiao | CN | http://m.toutiao.com/group/7389073901650723378/ | 2026-09-03 | صرخات | 44.928 kWh، 70 kW، 420 CLTC، السعر المحلي (TIME_SENSITIVE) |
...
| 2025 دولفين ديبلوت | Xincheping / Toutiao | CN | http://m.toutiao.com/group/7389115620090053159/ | 2026-09-03 | SINGLE OURCE | وصف خاص للجنة التنسيق الإدارية/مجلس الإدارة/رابطة الدول المستقلة |
...
| 2025 درجة الدلافين/درجة الرطب/الجدول المقسم | قاعدة بيانات نموذجية لنموذج أوتوما | CN | https://www.autohome.com.cn/ask/24636224.html | 2026-09-05 | SINGLE_SOURCE (supporting only) | AI-aggregated QA page — supporting context only, not used as a decisive cross- check leg per source-quality rule |
...
| BYD Dolphin 2025 official brochure | أستراليا (موظف مسؤول عن إدارة شؤون السيارات/المساهم) | الاتحاد الأفريقي | https://bydautomotive.com.au/brochures/BYD-DOLPHIN-2025.pdf | 2026-09-05 | VERIFIED (OEM; export-market scope) | OEM brochure confirms Blade LFP 44.9/60.48 kWh  and  70/150 kW motor lines  and  (أ) الأبعاد؛ NEDC 410/490  and  : مبلغ 340/427 من دولارات الولايات المتحدة هو أرقام دورة الصادرات  and  are NOT used as China CLTC 420/520 |

* ملاحظة منظار الدليل: BYD's official China pages (linked above) anchor the 2025 Dolphin's model identity, بطارية " لوفل "  and  "النسخة الإلكترونية 3.0"  and  the official BYD Australia 2025 brochure independently confirms the 44.9/60.48 kWh battery  and  70/150 kW motor lines (on export NEDC/WLTP cycles, (أ) أبقيت منفصلة عن الأرقام الصينية. The China grade values — 70 kW/44.928 kWh/420 km CLTC  and  150 kW/60.48 kWh/520 km CLTC — rest on a genuine same-fact cross-check by two independent Chinese parameter tables verified reachable on 2026-09-05 (PCauto s48492 config  and  سلسلة الأوتومايوم 6139 كوريج (أ) مدعومة بموسوعة دار تكنولوجيا المعلومات/المبنى؛ The Autohome * page is AI-aggregated and is deliberately not used as a decisive leg. مشروع سابق اسمه "Xcar" بدون URL - الذي لم يُدعم الاستشهاد به تم إزالته (لم يتم القبض على صفحة Xcar التي يمكن الوصول إليها). ربطت الصف بالضبط إلى مدونتي المعلومات و شبكة المعلومات قبل أن تطلب ولا تعد لجنة التجارة الدولية دورة الصين إلا ولا تعادل أبداً ما وراء البحار من دبليو إل بي سي/نيد؛ نفس الاسم في الخارج الدلافين هي مبانٍ سوقية مميزة Writing-AI controlled patch 2026-09-05: وتُقيّم خطوط البطاريات/الأجهزة التي تدعمها الآن منظمة أوم إي إم (نشرة الاتحاد الأفريقي، نطاق الصادرات) وقيم لجنة التجارة الدولية الصينية ذات الأثر المُعدّل بواسطة جدولين مستقلين للثقة، مما يُنقل الصفحة من النظام الإلكتروني الجديد للتنمية في البلدان النامية. RESEARCH (China CLTC confidence CROSS_CHECKED, not OEM-VERIFIED). ♪

## استعراض التحرير
- ** مستعرض/مراجع**: [فريق تحرير تصدير أوتو بريدج] (/مؤلف/) - طريقة لكل [سياستنا الانتخابية] (/سياسة التحرير/)
- ** لم يُستعرض بعد**: 2026-09-05
- ** سوق الإحالة**: الصين، 2025 دولفين (المراجع إلى السوق الصينية؛ وبقيت البنى ذات الاسم في الخارج منفصلة)
- ** طريقة الفرز**: (أ) التحقق من مصادر متعددة؛ وظل نطاق دورة النطاق ونطاق السوق متميزين لكل قاعدة من قواعد المبادرة/المصادر - قاعدة السلع الأساسية

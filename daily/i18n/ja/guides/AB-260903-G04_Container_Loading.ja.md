...
容器の中のEV/hybridは依然として牽引電池を運びます: 海上危険物に関する文書や、SOC/state-of-charge命令に従う。 リチウムイオン電池車は、IMDGの改正42-24 (2026-01-01からの必須)の下の区分UN3556です、 旧総体UN3171ではない。 現在のEVの出荷ファクトシートとキャリアごとのドキュメント/SOCの詳細を適用します(EVオーシャンコンプライアンスガイドを参照してください) 12を切断/受信する キャリアごとのVシステムと内部燃焼のSOPはEVをカバーし、想定していません。
...
|---|---|---|---|---|---|---|
| 車両の固定面ビュー (2/box、8ストラップ) | 貨物用材料 | 営業拠点 | 以下は、 //m. 11467.com/product/d42473652.htm | 2026-09-03 | シングル_ソース | 2-SUV ノルク; ~ 8 ストラップ; wheel method (one source) | https://m.11467.com/product/d42473652.htm
...
| 中国ヨーロッパ鉄道車ローディング(3/box) | ハルビン鉄道/トウティアオ | CN の | 担当: http://m.toutiao.com/group/6748371578787987979/ の | 2026-09-03 | シングル_ソース | Three-per-box sedan/rail reference (one source) |
...
| 容器/装置参照 | 世界配送協議会 | インフォメーション | 以下は、 https://www.worldshipping.org/ は、 | 2026-09-05 | 検証済み | 標準的な貨物コンテナと荷計画のためのライナー機器のコンテキスト |

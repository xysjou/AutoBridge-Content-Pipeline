...
|---|---|---|---|---|---|---|
| サイネージミキサートラック製品ライン(容量/エンジンブランド) | サイネージグループ(OEM公式、CN-言語サイト) | CN/グローバル製品 | 以下は、 https://www.sanyglobal.com/cn/product/concrete_machinery/truck_mixer/ は、 | 2026-09-03 | 検証済み | 6–7/8–9/10 m³ bands; 日野/中国/Weichai/Sany力 |
...
| SANY integrated frame / 20 m³ mixer | フーナンデイリー/トウティアオ | CN の | 担当: http://m.toutiao.com/group/6705156123395097102/ の | 2026-09-03 | CROSS_CHECKED(クロス) | 統合フレームエンジニアリング、大型クラスコンテクスト |

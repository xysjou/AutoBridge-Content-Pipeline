...
**JAC Junling V6 (骏铃 V6 の)、  2024/2025)** is a Chinese-market diesel light cargo truck in the sub-4.5 t blue-plate class used for city/regional distribution. 商用車買い手は、タクシーのトリムの前にGVW、ペイロード、貨物箱に固定する必要があります。 参照の市場は**中国です; マスは、均質な確認が必要です。

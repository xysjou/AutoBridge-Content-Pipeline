...
## シャーシとパワートレインが特定
- **エンジン**:云内 D25TCIF1 2.5L 柴油 150 马力;トルク400 N·m。
- **力鍛ライン**:安康 160 + 6 挡全铝变速箱 + AAM 后桥。
- **測定(単一ソース ミラー)**:kerb 2.565、GVW 4.495の定格ペイロード1.735.
- **車庫箱内**:约 4220 × 2075 × 400.

## 規格表(中国市場参照)
| 仕様 | バリュー | ユニット | マーケット | 自信の秘境 | ソースノート |
|---|---|---|---|---|---|
| エンジン d25 | 云内 D25TCIF1 2.5L 柴油 150马力 |  | 日 時 分 | シングル_ソース | 卡车之家镜像 |
| エンジン d25トルク | 400 | ナ・ム | 日 時 分 | シングル_ソース | 卡车之家镜像 |
| パワートレイン ankang160 | 安康160 + 6挡全铝变速箱 + AAM后桥 |  | 日 時 分 | シングル_ソース | 卡车之家镜像 |
| 車両重量 | 2.565 | ツイート | 日 時 分 | シングル_ソース | 卡车之家镜像 |
| ギヴュ | 4.495 | ツイート | 日 時 分 | シングル_ソース | 卡车之家镜像 |
| 定格ペイロード | 1.735 | ツイート | 日 時 分 | シングル_ソース | 卡车之家镜像 |
| 貨物箱の内部 | 约4220×2075×400 | ミリメートル | 日 時 分 | シングル_ソース | 卡车之家镜像 |

## 軽いトラックの輸出点検: 固まりは正弦源を必要とします
エンジンと貨物箱のデータが、ミラーリングされたトラックデータベースのソースから来ています。一方、**GVW/kerb/payloadは単一のミラーに残り、360cheの正式なページ、JAC OEM材料またはMIITアナウンスに対して確認しなければなりません**彼らはローディングまたは均質化のために使用される前に。 タイヤ、リアアクスル比、燃料タンクサイズは捕獲しません。 輸出入・右手ドライブ仕様は、ここには設立しておりません。

市配給業者は、最も頻繁に紛争を引き起こす秩序構成点を買います**これは、目的地の市場における法的ローディングを支配している。 中国の青版の評価、 工場のペイロード  と仕向地の軸重制限は三つの異なる数値である; トラックは三つのうち最も甘い値ではなく、拘束力のある仕向地ルールに合わせて仕様を決めるべき. ホイールベースと貨物箱の長さも回転サークルとローカルの長さ制限と相互作用するので、ボリュームを最大化するために選ばれたボックスは、狭い都市ルートに厄介な車を作成することができます。 GVW を、確認して下さい kerb の固まり, ペイロード, ホイールベース  と荷台寸法をプロフォーマ上で対になる一式として,  and  沈殿物の前に各固まり図をソースに結びます製造者を要求して下さい。
...
## よくある質問
**ペイロード図は最終ですか?** それらはここに単一ソースです。それらに依存する前に、均質化で確認します。
**RHD版はありますか?** これらソースに確立されていない。

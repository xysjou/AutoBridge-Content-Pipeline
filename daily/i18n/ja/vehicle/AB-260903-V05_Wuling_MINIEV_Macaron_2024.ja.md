...
買い手が混同する二つの主要数値は **range grades (170 vs 215 km CLTC)**  and  **充電方法**。 主に充電速度が遅く、100 km/hのトップスピードで、これは、都市/短距離製品です。 納期と高速道路の機能を、納期後に顧客に発見するのではなく、書面で設定します。
...
- ホイールベース: ** 2010 mm **
ちょうど3 mの長く、  マカロンは中国市場で最小級の4席EVの一つ. 四席の席がプレゼントされます。 リアスペース  と荷室容量は軽自動車並みである — "4-seat" means occasional four-up urban use,  not four-adult comfort. 小さい足跡はまたローディングの利点です: 従来車よりもコンテナ単位が多ければ多いが、その正確なカウントは、**測定されたロードプランと、キャリアの承認されたスタウジ**(コンテナロードガイド参照)に依存しています。長さだけで固定された数字を引用しません。

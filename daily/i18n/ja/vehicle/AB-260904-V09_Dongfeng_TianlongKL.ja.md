...
343 kW と 337 kW の数字は、異なるベースで許容対正**の電力です。 ラベルを一つではなく、ラベルを両方提示します。 Torque plateau (1100–1600 rpm) けん引登坂性能で重要となる.
...
## よくある質問
**なぜ二つの出力値があるのか (343  and  337 kW)?** 343 kW は定格電力  and  337 kW純力 — 同じ465 PSエンジンの異なる測定ベース。

...
- 2900 mmの  7（5门，平开门） (five doors, — トリムで確認します。
...
| phevの最高速度 | 180 | h | 日 時 分 | シングル_ソース | 汽车之家车家号 |
...
MPV ICE または PHEV であるかどうかです。 PHEV **電池容量  and  純電気範囲は確実に捕獲されません  and  は、  and  シングルソースで高速充電レスト; これらを前提から満たさない。 救急車、VIPシャトル、または車椅子の変換は、このMPV上に構築された上フィットであり、別の特別車両評価に属しています。

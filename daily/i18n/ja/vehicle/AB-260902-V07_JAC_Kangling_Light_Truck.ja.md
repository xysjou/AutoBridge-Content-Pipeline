...
| | Zhiwei S25 (Q25Aガソリン式)、**アンカン2.5 (アンホイCummins HFC4DE3ディーゼル)**、 アンカン3.0のコールド チェーン、YN30ガス/二重燃料、Dekang 160B/C、DHE155 |
...
| | 2 T (1600 kg 可) 4 T (2895 kg グループ), 比率 4.875 |
...
- 捕獲された造りのばねの駐車および7.00R16LT 8PRの× 6が付いている空気ブレーキは- タイヤの可用性およびブレーキ サービス標準を先の確かめます。
...
*AutoBridge標準ごとのConfidence: 検証はメーカー/政府/規格ボディを要求します; JAC独自のテーブルは、プラットフォームの事実のためのバーを満たしています。 Detailed per-announcement weights from are CROSS_CHECKED against the JAC family but still must be matched to the exact certificate. 価格は述べていません。 輸出用として使用されていない国内リストの価格は時差が大きいです。 ふりがな 360che

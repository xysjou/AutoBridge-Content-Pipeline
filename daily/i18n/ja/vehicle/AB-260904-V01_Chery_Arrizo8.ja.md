...
## SEOメタデータ
- **SEOタイトル**: Chery Arrizo 8 仕様 & 輸出バイヤー ガイド (1.6TGDI の中国参考)
- **メタディスクリプション**: 中国語市場 チェリーアリゾ8 — 1.6T ケンペン 145 kW / 290 N·m、7DCT、4780 mm ボディ、問題のトリムの区別、および注文する前に輸入業者が確認する。
- **H1**: チェリーアリゾ8: 中国の市場仕様と輸出検証ノート
- **主要キーワード**: チェリーアリゾ8仕様輸出
- **関連検索語**: Arrizo 8 1.6TGDIのChery Arrizo 8次元、艾瑞泽 8の輸出、Kunpeng SQRF4J16の中国の密集したセダンの輸出
- **推奨URL**: /vehicles/chery-arrizo-8/
- **検索意図**: チェリーアリゾ8を理解する:中国市場仕様と輸出検証ノート:車両/部品輸出業者が確認しなければならないもの、文書を文書化し、注文をコミットする前に決定する必要があります。
- **内部リンク候補**: /guides/vin-nameplate-verification-chinese-vehicles/ ; /guides/emission-fuel-compatibility-china-vehicles/ ; /guides/export-vehicle-document-package/
- **画像候補**: アリゾ州前三丁目8
- **ALTテキスト**: チェリーアリゾ 8 1.6TGDI 中国の市場セダン
...
|---|---|
| 油圧エンジン | 1.6 T | 税制 昆布ターボチャージインライン- 4(SQRF4J16ファミリー) |
| 最高の力 | 145 kW (≈197 PS) |
| 最高のトルク | 290 N·m |

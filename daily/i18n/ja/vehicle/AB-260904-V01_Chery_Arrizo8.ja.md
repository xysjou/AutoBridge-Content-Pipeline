...
ICE の調達の決定は、**Engine コード、ギアボックスの種類、および排出ステージに集中します**。 カタログ名ではなくVINに照らして三つを確定する; 中国の6校正が目的地の均質化を必要とする理由については、排出/燃料互換性ガイドを参照してください。
...
- パワーパワー  トルク数値は中国の二つの構造化データベースで交差確認される; **ドア、ドライブレイアウト、トップスピードは単一ソース**で、工場構成シートに正確なユニットを再確認する必要があります。

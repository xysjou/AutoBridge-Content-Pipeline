# ジェットワーダー・デッシング(Dasheng): 三つのパワートレインを分けて保つ中国市場コンパクトSUVリファレンス
## SEOメタデータ
...
|---|---|---|---|---|
| 1.5T (2024) | 115 kW (156 PS) / 230 N·m | 6-speed ウェット デュアル クラッチ | 2024 | single source — によって確認します。 VIN/OEM|
| 1.6T | 145 kW (197 PS) / 290 N·m | 7-speed ウェット デュアル クラッチ | 越境年線 | CROSS_CHECKED |
| 1.5TD (2025) | 135 kW (184 PS) / 290 N·m | 7-speed ウェット デュアル クラッチ | 2025 | single source — によって確認します。 VIN/OEM|

命名台は本物です。 2024 ** 1.5T ** と 2025 ** 1.5TD ** 異なる出力と異なる伝送(6DCT 対 7DCT)の異なる校正は、同様のバッジにもかかわらず、. The **1.6T** 三つのうち最も強く、二つの独立出典による裏付けが最も厚い. 「1.5 Dashing」という名前の注文は、両方の車に解決できます。 従って完全なエンジンの指定を書きます、 年 年  and  伝播するプロフォーマへの伝達。 シングルソース1.5Tと1.5TDラインの正確な出力は、Jetour公式設定シートまたは預金が支払われる前に、正確なMIITの均質化エントリに対して閉鎖する必要があります。

...
## SEO元数据
- **SEO标题**: XPeng  MONA  M03 China-Market  EV  Specs  and  导出购买者检查
...
- 车体:五门,五座式紧凑型电动回升/快车,单机前型永久磁铁发动机,前轮驱动(交叉检查).
- ** 2025 参考维度:** 4780×1896×1445 mm,轮基2815 mm;拖动系数 ** 编为0.194**。
- **2026型号列出4785 mm长**——年际小变化以匹配证书,而非不同的平台.

## 电池、射程和发动机——保持基质完好无损

| 元素 | 中国市场参考值 | 信心/说明 |
|---|---|---|
| 电池容量 | 低温灯包为** 51.8 kWh**和** 62.2 kWh** | single source — type索赔)按批次不同——与XPeng确认,不主张固定供应商|
| CLTC 范围 | ** 515 / 502 / 620 / 600 km **,每个带在一个特定的电池+发动机组合上 | single source — —绝不等同于WLTP/EPA|
| 汽车(前身PMSM) | ** 140 kW(190 PS)/225 N·m**和**160 kW(218 PS)/250 N·m** | single source |
| Claimed 0–100 km/h | ** 7.8 s/7.4 s** 相应电动机级 | single source|

四个范围数字不能互换的修饰: 每一个都属于特定的电池和运动的配对。 引文中写着:"M03, 620 km ",没有命名62.2 kWh包  and  匹配的马达不全,  and  将620 km射程与140 kW马达配对,将是一个矩阵错误. 搭建三柱线——电池~CLTC范围~马达,用于精确的SKU,并与XPeng官方配置表对齐关闭. 快速充电峰值电源和充电时间**此处没有说明**,因为没有记录准确的官方数字; 可从OEM获取,用于特定版本,而不是复制评论。
...
高端修饰搭载XPeng辅助驾驶和驾驶舱功能,但传感器集,软件功能和哪些功能被启用因SKU和中国市场软件环境而异. 对于出口买方来说,这是一个具体的风险: 中国市场头单位语,应用商店接入,地图数据和超空服务区可能与目的地不匹配. 在订购而不是依赖发射营销之前,测试精确的VIN软件和连接.

## 价格、方向和出口边界

中国指南价格仅是**时间敏感国内参考**,从未有FOB/CIF出口报价,在此不给出出口价格. 参考的中国车型为**左手驱动**;任何RHD或出口市场M03都需要单独的OEM证据,其电池/测距标准不应被假定为与中国SKU相同.

## 海外买方在存款前的核查

1. 锁定全矩阵:电池(51.8或62.2 kWh) → CLTC范围(515/502/620/600的其中之一) → 发动机(140或160 kW) 用于一个命名为SKU的电池.
2. 确认矩阵和电池供应商对XPeng官方单/MIIT条目的质疑;不要推断供应商。
3. 将CLTC的预期转换到目的周期;请求现实世界数据.
4. 分别验证充电连接器/标准及目标充电兼容性.
5. 请检查access-date=中的日期值 (帮助) 4780-vs-4785长度与确切的型号年 CoC.
6. 测试目的地的头单位语言、应用、地图和OTA服务区;在最后付款前核对VIN的文档。

## 财务问题
** MONA M03提供什么电池尺寸? * 报告迟交是因为需要翻译。 * 报告迟交是因为需要翻译。

中国市场LFP包51.8 kWh和62.2 kWh(单一来源,由SKU确认);准确的电池供应商按批次不同,在此不断言.

**What is the range?**

CLTC范围为515,502,620和600 km,每个都绑在一个特定的电池上-运动机对;这些都是CLTC的数字,而不是WLTP.

** 有哪些马达? * 报告迟交是因为需要翻译。 * 报告迟交是因为需要翻译。

一台140 kW/225 N·m或160 kW/250 N·m的前置永久磁铁发动机,  with claimed 0–100 km/h of 7.8 s  and  分别是7.4个.

** 拖动系数是什么  and  大小吗? * 报告迟交是因为需要翻译。 * 报告迟交是因为需要翻译。

Cd 0.194;2025型机车在2815 mm轮式机车库上长4780 mm辆,4785 mm型机车在2026.型机车上列出.

在我的市场里收费吗?  and  is there RHD?**

中国的充电标准兼容性以及任何RHD/出口建造都需要单独的OEM证据;不要假设它们与中国规格相同。

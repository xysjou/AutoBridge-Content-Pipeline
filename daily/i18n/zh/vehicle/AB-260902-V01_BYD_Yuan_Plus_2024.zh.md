...
- **内链建议**: /guides/chinese-ev-charging-standard-compatibility/ ; /guides/right-hand-drive-chinese-cars/ ; /guides/used-chinese-ev-inspection/
- **图片建议**: 前四分之三工作室视图
- **ALT文本**: BYD 袁加/阿托3 紧凑电机SUV
...
- 创纪录的中国DC快速充电峰值为70 kW(49.92)/80 kW(60.48);BYD出口材料列出某些市场建筑的110 kWDC数字.
...
## 尺寸和客厅
4455×1875×1615 mm,轮基2720 mm,五门五座单层紧凑型SUV(BYD出口单上确认的日记).
## 参数外的自动桥址
...
## 请求当前导出提示
不公布固定出口价格. 2024荣耀版的中国国内指南价格仅是**国内,时间性参考——不是离岸价格/CIF数字**. 与** 目的地港口查询 数量 目标港口
## 经常被问到的问题
元加车跟阿图3是同一辆车吗? 它是出口Atto 3的中国对应产品,但连接器,认证范围周期和软件因市场而异——证实了确切的构建.
** ** 因为中国在出口市场使用CLTC的同时使用NEDC/WLTP,而NEDC/WLTP则较为保守;总是说明周期并引用目的地自己目前的官方数字,而不是转换CLTC.
在中国这条线路中,一台150 kW/310 N·m前置发动机; 电池和设备的变体不同。

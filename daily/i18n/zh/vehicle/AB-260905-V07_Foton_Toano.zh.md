...
## 识别尺寸、动力列车和座位
- ** 短车体(X5)**:4990×1980×1990,轮基3070 mm.
- ** 长轮基**:3510(X5 长轴)/3750(经典长轴,车长 5990×2000)毫米。
- ** 2.5T 柴油机车**:400 N·m;变速箱6MT.
- ** 座椅**:3/5/6/7/9/14/15/17 (随版本)) (中文(简体)).
- ** 转换说明**: F2.8NS6B177L：2780mL/130kW，属冷藏改装上装 — a refrigerated body is an upfit, 而不是一个基号规格。

## 验证规格表(中市参考文献).
| 规格 | 数值 | 单位 | 市场 | 信心 | 来源说明 |
|---|---|---|---|---|---|
| x5 短暗处 | 4990×1980×1990 | 毫米 | 中国 | 资源 | 搜狐对比 维基月球 |
| x5 短轮基地 | 3070 | 毫米 | 中国 | 资源 | 搜狐对比 维基月球 |
| 长轮基选项 | 3510 (X5 3750 (经典长轴, 车长 5990 × 2000) (中文(简体)). | 毫米 | 中国 | 资源 | 搜狐对比 维基月球 |
| 发动机 2 5t 转矩 | 400 | 不详 | 中国 | 资源 | 大众网 维基月球 |
| 传输 | 6MT | - 说吧 | 中国 | 资源 | 大众网 维基月球 |
| 座位选项 | 3/5/6/7/9/14/15/17 (随版本) (中文(简体)). | - 说吧 | 中国 | 横跨 | 大众网+搜狐 (单位:千美元) |
| 冷藏转换纸条 | F2.8NS6B177L：2780mL/130kW，属冷藏改装上装 | - 说吧 | 中国 | 资源 | 大众网 维基月球 |

## Van采购重点:选择一个配置,将上档期分开
范买家必须在比较价格之前,先修补轮基,屋顶高度,座椅计数(乘客)或货物布局,并修补发动机. 完整的Cummins ISF2.8电源基质和每串电量的kerb/GVW质量**没有捕获,在OEM表之前被扣**;百科全书条目仅作为线索处理。 冷藏或救护车体是底盘上的**顶部结构**,需要自己的有效载荷/绝缘/冷藏评估。

## 付款前对海外买方的核实
1. 名称轮式基地(3070/3510/3750),座椅/货车布局和发动机按顺序排列.
2. 从Foton OEM/homologation获得GVW/kerb质量和完整的引擎矩阵.
3.
4. 确认柴油排放/燃料和(中亚公路路线的)TIR分别适用性。
5. 请求当前导出报价;无。

## 财务问题
它跨版本(3–17)范围;指定确切的构建.
** 为什么没有完整的ISF2.8个电源清单? ** 变体矩阵需要 OEM 锁; 它被扣住 。
** **
...
|---|---|---|---|---|---|---|
| 图雅诺 词条 (仅线索, T4 不作关键事实唯一依据) (中文(简体)). | 抖音百科 维基月球 | 氯化萘 | T4 | 横跨 | https://m.baike.com/wiki/%E5%9B%BE%E9%9B%85%E8%AF%BA/10989664 维基月球 | 型号谱系线索 维基月球 |
| 图雅诺 车型对比 (单位:千美元) | 搜狐汽车 维基月球 | 氯化萘 | T2 | 横跨 | https://db.auto.sohu.com/compare-list?sliding=1&trimsid=156097,166576 维基月球 | 短轴 长轴尺寸, 轴距 (中文(简体)). |
| 图雅诺 吉象流动服务车 (单位:千美元) | 大众网机械 维基月球 | 氯化萘 | T3 | 横跨 | http://www.dzwww.com/jixie/f25184ea8b1340967.html 维基月球 | 2.5T 动力, 扭矩, 座位 号 |
| 图雅诺 冷藏改装 (上装) (中文(简体)). | 大众网机械 维基月球 | 氯化萘 | T3 | 横跨 | http://www.dzwww.com/jixie/e79925a2501247453.html 维基月球 | F2.8NS6B177L 改装上装, 非原厂 VAN 参数 |

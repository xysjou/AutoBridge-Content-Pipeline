...
- ** UN3557 — 车辆、锂金属电池功率**;
- ** UN3558 — 车辆,钠离子电池动力**。
所有人都坐在**9级**. The older blanket **UN3171 ("battery-powered vehicle/equipment") sea transition ended on 31 December 2025**; 千万不要在UN3171上为锂离子车建造2026的订车. 完整分类矩阵和散装物品条目(UN3480/UN3481),见伴导[在IMDG 42-24下插入EV: (b) 分类矩阵(/指南/前载-un3556-imdg-compliance/);
## 双全车道:SP961对SP962
特殊规定既推动积水,又推动文书工作:
...
4. ** ** 备用或松散锂电池在** UN3480/UN3481 ** 下移动,而不是UN3556,需要自己的包装/文件路线(包括适用的危险货物包装证书)。 整车的救援从不覆盖放在一起的零部件。
5. ** 是一个单独的情况:它们需要** 明确承运人的批准**,往往不能按普通条件运输,而且绝不能重新贴上UN3556正常装运的标签。
## 版本和及时性(在每份文件上写这些)

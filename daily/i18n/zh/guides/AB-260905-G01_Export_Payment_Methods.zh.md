...
## 这五种手段实际上如何转移风险
- ** T/T(电汇)**是直接汇款。 押金保护出口商免受从建筑到订单单位的注销;余额计时保护买方不支付未发货的汽车。
- ** L/C(信用证)** 取代银行信贷,以取代买方信贷。 UCP600以下的信贷是不可撤销的,除非它另有明文规定,付款则以**符合列报** 的单据为根据。
- ** D/P(付款单据)**和**D/A(接受单据)**是通过银行收集的文件;银行处理单据,但**不**提供L/C类付款承诺。
...
## 任何付款期限都有可能取消
付款安全和遵守管理是分开的大门。 该指南不给各国银行排位,也不引用银行收费,这两笔收费都必须逐案获得.

# Foton Toano / Tuyano (2026) - Cinese- Market Besar Van (Bus Cahaya) Specs dan Ekspor Cek
...
- ** H1 **: Foton Toano / Tuyano (2026) - Cine- Market Besar Van (Bus Cahaya) Specs dan Ekspor Cek
...
- ** Cari Intent **: 了解 Foton / 福田 Toano / 图雅诺 大VAN（轻客） 中国版规格、配置与出口适配性（车型参数页）
- ** Internal Link Sugestions **: / wirabilitas / foton -toano /, / guide / ckd-skd-knocked down-kit-export- assemb- /, / guide / tir-transport- chin- central- asia /
...
The **Foton Toano (图雅诺, 2026)** is a Chinese-market diesel large van/light bus offered across many wheelbases and seat counts. Karena matriks varian luas, halaman ini ditulis di sekitar ** konfigurasi hanya diidentifikasi ** daripada sebuah menyiratkan "Toano" spec. Referensi pasar adalah ** China **.

## Dimensi tak dikenal, kuat dan tempat duduk
- ** Tubuh pendek (X5) **: 4990×1980×1990, wheelbase 3070 mm.
- *** Dasar roda panjang **: 3510（X5长轴）/3750（经典长轴，车长5990×2000） mm.
- ** 2.5T torque diesel **: 400 N·m; gearbox 6MT.
- *** Kursi **: 3/5/6/7/9/14/15/17（随版本）.
...
| Pangkalan roda pendek x5 | 3070 | mm | CHINA | SINGLE _ SOURCE | 搜狐对比 |
...
Pembeli Van harus memperbaiki pangkalan roda, tinggi atap, jumlah kursi (penumpang) atau tata letak kargo, dan mesin sebelum membandingkan harga. Pemotong ISF2.8 penuh matriks daya dan massa pertrim kerb / GVW adalah ** tidak ditangkap dan ditahan ** menunggu lembar OEM; ensiklopedia entri diperlakukan hanya sebagai memimpin. Tubuh yang didinginkan atau ambulans adalah sebuah struktur super di atas chassis dan membutuhkan muatan sendiri / isolasi / pendingin.

## Pembeli luar negeri verifikasi sebelum pembayaran
1. Pangkalan kendaraan bernama 3070/3510/3750, tata letak kursi / kargo dan mesin sesuai pesanan.
...
## PSD
Berapa kursi? Ini berkisar di seluruh versi (3–17); spesifikasikan pembuatan yang tepat.
Mengapa tidak ada daftar daya ISF2.8 penuh? Matriks varian membutuhkan kunci OEM; telah ditahan.
...
|---|---|---|---|---|---|---|
| 图雅诺 词条（仅线索，T4不作关键事实唯一依据） | 抖音百科 | CN | T4 | _ BERDECAT | https://m.baike.com/wiki/%E5%9B%BE%E9%9B%85%E8%AF%BA/10989664 | 型号谱系线索 |
| 图雅诺 车型对比 | 搜狐汽车 | CN | T2 | _ BERDECAT | https://db.auto.sohu.com/compare-list?sliding=1&trimsid=156097,166576 | 短轴/长轴尺寸, 轴距 |
| 图雅诺 吉象流动服务车 | 大众网机械 | CN | T3 | _ BERDECAT | http://www.dzwww.com/jixie/f25184ea8b1340967.html | 2.5T动力, 扭矩, 座位 |
| 图雅诺 冷藏改装（上装） | 大众网机械 | CN | T3 | _ BERDECAT | http://www.dzwww.com/jixie/e79925a2501247453.html | F2.8NS6B177L改装上装，非原厂VAN参数 |
...
- 2026-09-05
- ** MODEL _ TOPIC _ MATCH *: tepat Foton Toano van
- FAIL
- ** ALT (bahasa 12) *:

# GWM Poer (Pao / Ute) - Drivetrain, Bed, Chassis dan Peta Versi untuk Penimpor Pickup
## SEO Metadata
- ** Judul SEO **: GWM Poer / Ute Pickup: Drivetrain, Bed & Expor Panduan Versi
- ** Deskripsi Meta **: GWM Poer (Cina 炮 / GWM Ute) menjelaskan untuk pembeli pickup - bensin vs diesel, 8AT/9AT evolusi, satu-permintaan 4WD, standar vs tempat tidur panjang, muatan verifikasi dan bagaimana memperbaiki pembangunan ekspor tepat.
- ** Sugested URL **: / kendaraan / great- wall- poer /
- ** H1 **: GWM Poer (Pao): Fixing Drivetrain, Bed and Chassis Before You Orks a Pickup
- ** Primary Keyword **: GWM Ekspor spesifikasi pengambilan poer
- ** Akhir Pencarian Second **: GWM Poer diesel 2.4T, GWM ekspor Ute, GW4C20B bensin, GW4D24 diesel 480 Nm, bagus Penjemputan taksi ganda dinding, Poer 4x4 tempat tidur kargo
- ** Internal Link Sugestions **: / guide / right-hand-drive -chinese- mobil-mobil /; / guide / import- chanese- chince- chink -saso /; / guide / commercial- truck- s- procurement -china /
- *** Saran Gambar **: double-cab dengan tempat tidur; gas vs kartu diesel; 4WD selector; pengukuran tempat tidur; ladder- frame chassis
- "GWM Poer Door double-cab pickup"; "Poer loading bed dimensions"; "Poer four-wheels-drive selector and transfer case"
## Dimana Poer duduk di GWM Line- up
The GWM Poer (China nama 炮 / Pao; Beberapa pasar ekspor GWM Ute) adalah badan inti Great Wall - pada platform pengambilan bingkai, dijual di Timur Tengah, ANZ, Amerika Latin dan memilih pasar RHD di kedua jalur kemudi dan kedua bahan bakar. Nama meliputi ** penumpang (乘用版), komersial (商用版) dan off-road (越野版) ** membangun yang chassis, tempat tidur, suspensi dan transmisi berbeda - jadi versi harus tetap sebelum perbandingan apapun. Ini adalah halaman model yang selalu hijau: China ** 2024 penumpang membangun ** adalah referensi bernama (REFERENCE MARKET: CHINA), sementara data resmi GWM- saat ini (yang telah berevolusi menjadi 9AT dan terrevisi keluaran) ditampilkan secara terpisah daripada diam-diam menimpa 2024 angka.
## Penggerak: Petrol vs Diesel - dan Evolusi Model- Tahun untuk Menghormati
| Powertrain | China 2024 penumpang referensi (database, CROSS _ CHECWD) | Baris resmi GWM saat ini (terintegrasi) |
|---|---|---|
| Bensin | GW4C20B 2.0T, 140 kW (190 PS) / 360 N·m, ZF 8AT | GW4C20B, bersih 160 kW / 380 N·m, 8AT (per GWM pickup resmi config) |
| Diesel | 2.4T, 135 kW (186 PS) / **480 N·m** | GW4D24 2.4T, net 135 kW / 480 N·m, ** 9AT ** (resmi GWM); export Poer 2.4 lists ~181–183 PS / 480 N·m with 9-speed auto (GWM Jordan/UK official) |
Titik penguapan penting bukan satu pun nomor "benar" tapi ** output dan transmisi telah bergerak melintasi model tahun dan pasar *: mobil penumpang Cina 2024 menggunakan ZF 8AT, sementara GWM saat ini membangun pasangan diesel 2.4 dengan GWM 9AT. Selalu mengutip kode mesin (GW4C20B / GW4D24), kekuatannya pada lembar tepat, dan model transmisi - tidak pernah aktif "Poer". diesel 480 N·m adalah pilihan untuk penarik dan dimuat berjalan.
## Wheel Drive dan Chassis
- Drive 4 × 2 atau 4 × 4; penumpang 4 × 4 menggunakan sistem permintaan / permintaan on- torque- on-permintaan, ketika versi off-road menambahkan bagian-waktu jarak rendah, kunci dan peningkatan tyris / tyre. Negara 4 × 2 vs 4 × 4  and  the exact 4WD type.
- ** Chassis **: body-on- frame tangga frame frame, double cab duet- kursi; front double-wishbone / reat kaku aksele dengan daun atau coil set- oleh versi - konfirmasi suspensi belakang, karena mempengaruhi naik dan muatan.
- 3230 mm penumpang tempat tidur standar, 3470 mm tempat tidur panjang komersial. Jangan mencampur keduanya.
## Cargo Bed and Payload - Verify, Jangan Asumsikan
Untuk pickup tempat tidur dan muatan dinilai adalah inti komersial, dan mereka version- tergantung:
- Sebuah referensi passenger- bed sekitar 1520 × 1520 mm (internal) direkam dari sebuah sumber basis data tunggal; konfirmasi panjang internal / lebar / tinggi pada taksi / tempat tidur yang dipilih (standar vs lama perubahan mereka).
- ** Payload, GVW, penarik rating, peringkat axle dan indeks beban ban tidak dalam dasar fakta diverifikasi dan tidak ditemukan. ** Meminta mereka dari resmi GWM lembaran komersial untuk versi dan pasar tujuan yang tepat - mereka bervariasi dengan suspensi, roda dan passeng- vs rating komersial.
## Peta Versi untuk Ordering
| Versi | Karakter | Fokus pemesanan |
|---|---|---|
| 乘用版 Penumpang | Konfort taksi ganda, otomatis, on-permintaan 4WD | Trim, bensin / diesel, 4 × 2/4 × 4, tahun transmisi |
...
- Mencegah muatan / GVW / derek / rating axle dari lembar resmi sebelum harga armada.
- Konfirmasi dimensi tempat tidur dan apakah kapal / penutup / bar adalah pabrik atau aksesorasi.
- Cocok dengan garansi ke distributor tujuan; referensi lima tahun / 200,000 km hanya liputan domestik.
...
| Parameter Pao (drilbase / drive oleh versi) | 360che / Autohome | CN | https://product.360che.com/m792/198189_param.html | 2026-09-02 | _ BERDECAT | 3230/3470 pangkalan roda, versi drive / transmisi |
...
- ** Pasar Referensi **: Cina 2024 penumpang membangun + GWM-resmi ekspor saat ini membangun (ditampilkan secara terpisah)
- ** Metode verifikasi **: Profacturer-data resmi saat ini + data basis data cross- cek dari bernama 2024 build; model-tahun perbedaan diawetkan, bukan diratakan

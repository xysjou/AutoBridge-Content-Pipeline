...
## Pengenal Chassis (konfirmasikan kode model)
- Model terdokumentasi: ** DFH5180XLC (EX8) **; sebuah kode berkas baru ** DFH5180XLCG4 ** muncul di ** MIIT batch 410 **. Cocokkan kode pada sertifikat ke unit yang disampaikan - sebuah kode XLC reefer dan kode kargo polos adalah kendaraan yang berbeda lengkap.
- Kelas: ** Sasis GVW 18 t ** dengan ** 6.8 m kotak ** (lebar internal sekitar 2.45 m) pada ** 5000 mm roda **.
- Versi yang diajukan membawa Limiter kecepatan ** 89 km/h * (sumber tunggal; konfirmasi pada pengumuman).

## Powertrain dan Driveline
| Butir | Tianjin KR 6.8 m reefer (China referensi) |
|---|---|
| Mesin | Dongfeng Cummins ** B6.2NS6B245 **, inline- 6, 6.2 L diesel |
| Daya / torsi | **180 kW (245 PS) / 1000 N·m** |
| Gearbox | Cepat (Cepat Gear) ** 8JS105A/TA 8-speed ** |
| Axle belakang | Dana ** 416 **, rasio ** 4.11 ** |
| GVW | **18 t** |
| Emisi | Cina - 6 diesel |

## Superstruktur: Apa yang Pembangunan Tubuh putuskan (tidak tetap data chassis)
Berikut ini adalah pilihan yang lebih cocok yang ditentukan pada lembar build body build *, dan halaman ini sengaja tidak hard- kode mereka:
- *** Merek merek unit refrigerasi / model ** dan apakah itu belt-didorong atau memiliki motor listrik yang siaga.
- ** Jumlah zona suhu ** (single / multi- temp) dan set- point range.
- ** Material interilasi dan ketebalan panel ** dimensi interior dan rating beban lantai.
- Konfigurasi pintu, pintu samping, daging-rel / jalur fitmen.
Meminta lembar konfigurasi untuk pembangun tubuh ** sebagai dokumen terpisah dari sertifikat chassis; pembuat chassis tidak menjamin kinerja unit reager.

## Batas Versi: KR vs KR Plus
- ** Halaman ini: Tianjin KR, B6.2 245 PS, 6.8 m box, 5000 mm wheelbase. **
- The **KR Plus** uses a **D7.0NS6B330 (243 kW/330 PS)** engine, a ** 7.88 m box **  and  **5800 mm wheelbase** — a larger vehicle. Jangan gabungkan dimensi KR Plus atau kekuatan menjadi urutan KR.

## Verifikasi Pembeli Luar Negeri Sebelum Pembayaran
- Konfirmasi bentuk kandar axle / chassis pada sertifikat chassis DFH sebelum menyatakan pergolakan upfit; ini sengaja tidak disertakan dari angka referensi Cina yang tertangkap.
1. ** Model kode MIIT ** (DFH5180XLC / DFH5180XLCG4) pada sertifikat; GVW dan status speed- liiter.
2. B6.2 245 PS, Fast 8-speed, Dana 416/4.11 - cocok dengan VIN; KR Plus tetap terpisah.
3. Untuk unit reefer, zona, isolasi dan dimensi interior.
4. ** Diesel sulfur / after- treathers ** compatibility dan tujuan jenis persetujuan per panduan emisi-bahan bakar.
5. ** klasifikasi HS ** - sebuah reefer adalah kendaraan barang khusus-tujuan; konfirmasi heading / subheading (87.04 vs 87.05 batas) setiap panduan HS-code, dan rakit paket dokumen lengkap per checklist export- dokumen.

## Meminta Kuotasi Ekspor Saat Ini
Tidak ada harga ekspor yang diterbitkan. Bertanyalah dengan ** Negara Tujuan ** Chassis (KR / KR Plus) Unit & Penundaan Temperatur

## Pertanyaan Yang Sering Muncul
** Apakah unit pendinginan bagian dari chassis Dongfeng? * Tidak - chassis adalah Dongfeng, kotak terisolasi dan unit reefer adalah tubuh - pembangun upfit dan membutuhkan lembaran spesifikasi mereka sendiri.
** Apa panjang GVW dan kotak? ** 18 t GVW dengan 6.8 m kotak pada sebuah pangkalan roda 5000 mm untuk KR yang didokumentasikan.
Mesin mana? Dongfeng Cummins B6.2NS6B245 di 180 kW (245 PS) / 1000 N·m,  through a Fast 8-speed gearbox to a Dana 416 axle.
** Bagaimana KR berbeda dari KR Plus? ** KR Plus lebih besar: 330 PS D7.0 mesin, 7.88 m kotak, 5800 mm roda - tetap terpisah.
...
|---|---|---|---|---|---|---|
| Tianjin KR 6.8m reefer B6.2 powertrain / gearbox | 360che (Toutiao) | CN | http://m.toutiao.com/group/7031465452756828703/ | 2026-09-04 | _ BERDECAT | B6.2 245PS, Cepat 8-speed, Dana axle |
| Nine 6.8m cargo trucks: Konfig KR | 360che (Toutiao) | CN | http://m.toutiao.com/group/6961327956664779271/ | 2026-09-04 | _ BERDECAT | 6.8m, pangkalan roda, rasio axle |
| Tianjin KR 6.8m wheelbase & cargo box | 360che (Toutiao) | CN | http://m.toutiao.com/group/7155750645675377152/ | 2026-09-04 | _ BERDECAT | 5000 WB, lebar internal, GVW |
| DFH5180XLCG4 reefer - MIIT batch 410 | Sina Finance (mengutip MIIT) | CN | https://cj.sina.cn/article/norm_detail?froms=ttmp&url=https%3A%2F%2Ffinance.sina.com.cn%2Fstock%2Faigc%2Fxcsb%2F2026-08-07%2Fdoc-inimnrac4126512.shtml%3Ffinpagefr%3Dttzz | 2026-09-04 | _ BERDECAT | Kode berkas baru, batas kecepatan |
...
- *** Referensi pasar **: Cina, Tianjin KR DFH5180XLC reefer chassis (Referensi pasar Chinese-; chassis vs upfit dipisahkan; bukan spesifikasi global)
- ** Metode verifikasi **: MIIT- pengajuan jangkar; driveline cross- diperiksa; superstruktur ditangguhkan untuk body building

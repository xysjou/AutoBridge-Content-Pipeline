...
- Istilah pencarian sekunder: VAT refund on entry into comprehensive bonded zone; kebiasaan baris kedua baris pertama; VAT umum pembayar pajak yang terikat zona; penjualan lokal servis; zona terikat sendiri-gunakan peralatan pembebasan
...
Ketika barang-barang yang terikat dijual ke pasar domestik, perusahaan mungkin - dalam kebijakan dan subjek penanganan bea cukai - pilih dasar tariff: tugas levy dengan referensi ke impor bahan / masukan atau dengan referensi ke barang seperti yang disajikan pada pengajuan (customs declaration status) * (lintas diperiksa seluruh Dewan Negara dan teks kebijakan pabean). Pilihan "selektif tariff" ini memungkinkan bisnis memilih dasar yang sah yang cocok dengan situasi yang sebenarnya, tetapi pemilihan yang dibuat di bawah aturan untuk setiap gerakan rumah tangga, bukan pilihan bebas untuk mencampur basis di transaksi.
...
Garis pertama adalah batas zona-ke-luar negeri (terikat pada entri); garis kedua adalah batas zona-ke-pasar-domestik, di mana pajak diselesaikan sesuai status barang.

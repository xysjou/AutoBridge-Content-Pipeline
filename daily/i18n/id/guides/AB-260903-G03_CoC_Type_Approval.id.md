...
- ** EU - Seluruh Kendaraan Tipe Pendekatan (WVTA): ** Secara wajib seluruh akses pasar kendaraan, digambarkan oleh penyedia sertifikasi sebagai berbasis ** Peraturan (EU) 2018/858 *, yang diterapkan sepenuhnya dari 1 September 2020 dan diganti Directive 2007/46/EC; satu persetujuan diakui di seluruh negara anggota. * Verifikasi teks konsolidasikan saat ini dan setiap penerus bertindak pada EUR- Lex sebelum mengandalkan tanggal atau lingkup. ♪
...
Setelah satu tipe disetujui, ** Setiap kendaraan mengeluarkan tanda pengenal COC bahwa unit cocok dengan tipe yang disetujui **; CoC adalah dokumen yang bergerak dengan mobil ke meja pendaftaran tujuan. Dua perangkap:
- ** Cina 合格证 / 一致性证书 adalah dokumen pendaftaran / penerimaan domestik ** (berakar dalam perintah MIIT No. 50 dan aturan terkait) - itu adalah ** bukan ** sebuah EU WVTA CoC atau dokumen EEEU / EAC.
- Tujuan CoC hanya dapat dikeluarkan ** terhadap persetujuan tujuan yang valid **; Anda tidak dapat memproduksi sebuah EU CoC dari dokumen Cina saja.
...
1. ** Nama pasar tujuan pertama ** Kami mengidentifikasi rezim kendaraan sepenuhnya (WVTA / OTTS / GCC / nasional).
2. ** Konfirmasikan pemegang persetujuan dan perwakilan yang berwenang di pasar ** (EEEU secara eksplisit memerlukan satu).
3. ** Terpisah tiga tumpukan: ** Seluruh jenis kendaraan persetujuan; per- kendaraan CoC; komponen / sistem tanda.
4. ** Jauhkan Cina 合格证 di tumpukan Cina ** - menggunakannya untuk membuktikan konsistensi membangun, tidak pernah sebagai tujuan akses.
5. ** Tarik teks peraturan primer ** (EUR-Lex / UNECE / EEEU) untuk persyaratan tanggal; perlakukan rangkuman sertifikasi- sebagai navigasi, bukan otoritas.

## Apa Rekomendasi Panduan Ini Sebelum Melakukan Toling atau Deposisi
- Sebuah matriks dokumen yang ditulis oleh Abodorim, dengan pemilik persetujuan.
- Konfirmasi dari ** entitas mana yang mengeluarkan tujuan CoC ** dan itu mengacu pada nomor persetujuan dengan tipe yang valid.
- Sebuah ** component-mark inventaris ** yang tidak salah untuk persetujuan kendaraan whole-.
- Primary- sumber verifikasi dari setiap ** tertanggal regulasi ** (2018/858, TR CU 018/2011, Perjanjian 1958) sebelum penggubah-menghadapi klaim.

## Pertanyaan Yang Sering Muncul
** Apakah cukup Cina CoC untuk mendaftar di Eropa? ** Tidak - Cina 合格证 adalah dokumen domestik; pendaftaran Uni Eropa membutuhkan persetujuan jenis Uni Eropa dan Uni Eropa CoC.
Apa bedanya WVTA dan CoC? WVTA menyetujui jenis kendaraan di seluruh Uni Eropa; sebuah sertifikat COC setiap unit cocok dengan tipe yang disetujui.
** Apakah e- mark dan E-mark sama? ** Tidak - persegi panjang e terikat ke EU sepanjang- kendaraan / EC perizinan; lingkaran E adalah UNECE 1958 komponen / sistem persetujuan antara pihak-pihak kontraksi.
** Apakah E-mark pada bagian menyetujui seluruh kendaraan? ** Tidak; dukungan tanda komponen tapi jangan pernah ganti persetujuan tipe kendaraan mana pun.
...
| Peraturan (EU) 2018/858 (konsolidated 2021-09-26) pada type- persetujuan kendaraan bermotor - WVTA; whole-kendaraan vs | EUR- Lex (Database resmi Uni Eropa) | CN | https://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=CELEX:02018R0858-20210926 | 2026-09-04 | TERBATAI |  |
| Peraturan (Uni Eropa) 2018/858 (asli), Bab VI / Pasal 36 - produsen mengeluarkan CoC untuk setiap konf kendaraan | EUR- Lex | CN | https://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=CELEX:32018R0858 | 2026-09-04 | TERBATAI |  |
| 2018/858 Bab VI (CoC) resminya reproduksi | legislation.gov.uk (data resmi undang-undang Inggris | CN | https://www.legislation.gov.uk/eur/2018/858/chapter/VI/2018-05-30/data.pdf | 2026-09-04 | TERBATAI |  |
...
- ** Referensi pasar / ruang lingkup **: Global persetujuan sistem (China stack official; EU / EEEU / UNECE digambarkan dari sumber sekunder)
- ** Metode verifikasi **: Pemetaan framework dengan kesenjangan sumber primary-eksplisit ditandai per PRIMARY _ SOURCE _ SCOPE aturan

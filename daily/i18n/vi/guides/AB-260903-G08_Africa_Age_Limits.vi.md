...
| Mozbique* | - | Reported ≤8 years from registration to export; chuỗi bảo trì-có ích đã báo cáo | nguồn duy nhất phi nguyên tử — xác nhận |
| Sudan | - | Báo cáo có cột: hành khách 7 sever-light-goods 8 bus-heavy 10 năm, với phí vẫn có thể trả ngay cả khi tính tiền | nguồn duy nhất phi nguyên tử — xác nhận |
| Côte d'S braft | - | Không có một cái nón cố định nào báo cáo, nhưng bắt buộc CoC tuân theo và ghi chép bảo trì theo dõi | nguồn duy nhất phi nguyên tử — xác minh chương trình CoC |
...
*Evidence tiers: Kenya (KEBS+KRA) and Nigeria age rule (Single Window + Customs reproduction) are primary-anchored. Diễn đạt về tay lái của Nigeria và mọi dòng quốc gia khác vẫn không phải nguồn gốc và phải được xác nhận chính thức cho đúng loại xe trước khi giao hàng; no regional generalisation is made.*
...
- Thị trường tham chiếu: Châu Phi (nhiều quốc gia)

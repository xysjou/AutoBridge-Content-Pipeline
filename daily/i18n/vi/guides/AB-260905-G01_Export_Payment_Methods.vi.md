...
## Đọc một L/C cho các điều khoản mềm trước khi bạn chấp nhận nó
L/C không thể thay đổi chỉ an toàn như điều khoản của nó. Xem những điều kiện đặt tiền dưới sự kiểm soát của người mua hoặc bên thứ ba: một chứng nhận được ký bởi ứng viên, một tài liệu thanh tra và chấp nhận chỉ có người mua có thể xuất bản, một ngày chuyển hàng hay cổng mà bạn không thể đáp ứng, một tàu/một tài liệu mà ngân hàng phát hành sẽ không chấp nhận rõ ràng. Bởi vì thanh toán phụ thuộc vào một trình bày khuôn mặt, bất cứ điều khoản nào cho phép ứng viên chặn các tài liệu là điểm thương lượng để loại bỏ hoặc trung lập trước khi xác nhận tín dụng.

## Một lệnh thực tiễn cho xe
1. Khớp công cụ để tin tưởng và sắp xếp: tiền gửi + cân bằng T/T cho một người mua lặp lại; L/C cho một thị trường lớn đầu tiên hoặc xa lạ; tránh D/A và O/A trừ khi có bảo hiểm tín dụng hoặc bảo hiểm mạnh.
2. Trên một L/C, hãy đọc tất cả các tài liệu cần thiết chống lại những gì bạn có thể thực sự sản xuất và dòng thời gian (công trình, đặt chỗ, thanh tra, B/L).
3. Tái cấu trúc L/C với các mẫu đơn vị và Incoterntion để các tài liệu, mô tả đơn vị, lô hàng và đơn vị mới nhất có thể được thực hiện.
4. Giữ phí tổn ngân hàng và chi phí xác nhận ngoài số giả định — chúng thay đổi theo ngân hàng và nhạy cảm về thời gian; lấy chúng từ ngân hàng được đề cử.
5. Tọa độ với quy tắc định cư FX (xem hướng dẫn giao dịch-FX) vì vậy biên lai và xác thực là nhất quán.

## Nguy hiểm không gỡ bỏ thuật ngữ thanh công
Ngay cả một L/C sạch cũng không chữa được việc tiếp xúc với người mua/bank, phân loại sai, hoặc một điểm đến không thể nhập vào đơn vị. An ninh chi trả và sự tuân thủ quy định là hai cổng riêng biệt. Người hướng dẫn này không phân loại ngân hàng của các quốc gia và không trích dẫn các cáo buộc ngân hàng, cả hai đều phải nhận được trường hợp.

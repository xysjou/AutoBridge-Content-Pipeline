...
|---|---|---|---|---|---|---|
| ITAC Import Control（进口管制：约276个管制税号、所有二手/旧货物均需进口许可证、3-5工作日、ITA Act 2002(Act71)/海关法1964(Act91)） | Ủy ban quản lý thương mại quốc tế ở Nam Phi | ZA | T1 | VEII | https://www.itac.org.za/pages/import-control | 进口许可, 管制范围. 法律依据. 办理时限 — 南非进口管制 |
| CÀI CÀI 官网 (机构身份与进口管制 关税职能) | MỘT Nam Phi | ZA | T1 | VEII | https://www.itac.org.za/ | 主管机构身份 — 机构 |
| SARS & Excise(海关征管; 外籍注册车辆 TMS 申报 2026-06-01 起等当期通告) | Nam Phi phục vụ | ZA | T1 | T_ TIẾNG TÂM | https://www.sars.gov.za/customs-and-excise/ | 海关征管, 当期申报要求 — 南非海关税务 |
| NRCS (强制性规范与 lá thư của uy quyền, 含 Automotive 汽车类别) | Bộ điều khiển quốc gia để ép buộc các chi tiết | ZA | T1 | VEII | https://www.nrcs.org.za/ | 强制规范, LRA, 汽车类别 — 南非强制合规 |
| 南非拟调整中印进口车关税 (媒体报道, 仅 lần thời gian_BAR_ 背景, 税率须 SARS/ITAC 官方核). | 今日头条 (媒体) | ZA | T3 | T_ TIẾNG TÂM | http://m.toutiao.com/group/7601017507419324968/ | 关税调整动议背景  |
| Nhập khẩu một phương tiện có hai cánh tay hay đã dùng (chỉ thị chính thức) | Chính phủ Nam Phi | ZA | T1 | VEII | https://www.gov.za/services/services-organisations/import/importing-second-hand-or-used-vehicle | Nóac_permit — ITAC cho phép đầu tiên, nghĩa vụ trả cho Sars, tỷ lệ trên thời gian hiện tại |
| Thư có thẩm quyền cho xe hơi nhập khẩu hoặc tái thiết | Chính phủ Nam Phi | ZA | T1 | VEII | https://www.gov.za/services/register-motor-vehicle/letter-authority-respect-motor-vehicle | ncs_loa — NRCS LOA cần thiết cho phương tiện mới và được dùng trước khi nhập/ tồn tại |

...
| Phạm vi đã kết hợp | khoảng 1400 km **WLTC, nhà sản xuất** — nhãn dạng một nhà máy xác nhận, không đo |
| Đang nạp | DC about 20 min for 30–80%; Đồng hồ chạy chậm khoảng 3 h (Gập tắt nguồn; xác nhận trên OEM) |
...
2. **Battery dung tích và chu kỳ chu kỳ** - 32.66 kWh tầm xa so với phiên bản nhỏ hơn; nhãn CLTC vs WLTC và giữ cho các nhà sản xuất kết hợp- tầm nhìn yêu cầu.
3. **Sat số** (5 đấu 7) khớp với VIN.
4. **Charing  Connectionor và D.C/A phần cứng** tương ứng với tiêu chuẩn đích; PHEV battery shipping documents (UN38.3 summary) per the IMDG 42-24 guide.
...
| Fulwin T9 120 long-range flagship config | Tự động cấu hình nhà | CN | https://m.autohome.com.cn/config/spec/70272.html | 2026-09-04 | ĐÃ_ ĐÃ | 32.66 kWh, phạm vi điện, động cơ |
| Fulwin T9 battery & EV-range analysis | Autohome·Chejiaao | CN | https://chejiahao.m.autohome.com.cn/pingan/chejiahao/detailinfo/26113006 | 2026-09-04 | SINGLE_SOURCE | Pin, LC/WLTC, tính tiền lần |
...
- ** Thị trường chăm sóc khách hàng**: China, tiêu chuẩn Folwin T9 C-DM (tham khảo thị trường Trung Quốc; CLTC/WLTC betled; không phải là một suy đoán toàn cầu)
- ** phương pháp phân tích**: OEM conbig neo; chuẩn chống lại căn cứ xe đạp dài cô lập; nhà máy tuyên bố được cho là có

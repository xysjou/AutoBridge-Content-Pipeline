...
## Hộp cách ly (phần người mua bỏ qua)

| Mục | Giá trị tham chiếu |
|---|---|
| Hộp san hô A Kiệt | 4.085 × 2.10 × 2.30 m |
| Hộp Suyun | 4.08 × 2.10 × 2.10 m, about **18 m³** |

Hiệu suất hộp phụ thuộc vào độ dày và bảng điều khiển cách nhiệt (sandwich board, smand và mật độ), đánh giá độ tải sàn, dấu cửa và liệu nội thất có được gắn chặt thịt và lưỡi lê hay không — một cơ thể đá ngầm có đuôi là một tùy chọn được liệt kê. Để xuất khẩu, chỉ ra: cần thiết nhiệt độ bên trong đặt điểm, vật liệu bảng/ đồ họa, loại sàn (aminium srag vv.), phần/rar bộ sắp xếp cửa, và móc hoặc kệ vừa khít. Những vật nặng này (cơ thể được cách ly nặng — lưu ý rằng trọng tải tham khảo chỉ có giá 1.1 t ở 4.495 t GVW) và giá cả đáng kể.

## Tùy chọn hệ thống thu nhỏ

Tài liệu tham khảo bị bắt liệt kê ba tuyến đường phù hợp (chuyến bay, để xác nhận với người xây dựng):

- **Mặc định đơn vị đứng vững**: Thermo King T880 Đơn vị làm lạnh độc lập - đơn vị độc lập có động cơ riêng và giữ mát khi động cơ xe tải tắt, được ưu tiên cho công việc làm việc lâu dài, đậu xe hơi, da màu, da màu.
- **Domestic unit**: San Feng (三丰) 590, xếp hạng khoảng ** 18 °C ** cho hàng hóa đông lạnh.
- Cái hộp đựng thịt muMC để vận chuyển xác chết.
...
- Xác nhận hệ thống bảo hành lạnh và các bản địa sau giờ đóng cửa xác nhận bộ phận sau khi tan băng cho Yunnei và động cơ Cummins.
- Xác nhận LHD/RHD, Có sẵn lốp (7.00R16LT 8PR)  and  Cho dù cơ thể đá ngầm được lắp đặt nhà máy hay địa phương.

...
차량은 일반적으로 보증 ICC (A) 로로에서 가장 많이 본 손실 때문에, 포트 처리 - 사고 취급 손상, 도난, 찰상 및 치과 - (B) (C)의 명료 범위 밖에 떨어지는; 특정 이벤트가 여전히 배제, 첨부 파일 포인트 및 정책 단어에 따라 달라집니다. War 및 파업 덮개는 별도의 항목는 민감한 경로에 대해 추가로 구입했습니다.
...
- CIF에서는, 판매자는 최소한의 ICC(C) 커버만 차가 필요하지만 (A) — write ICC(A)는 계약과 신용의 모든 문자로 명시적으로, 또는 자신의 최고를 구입합니다.
- CIP에서, 기본 최소는 ICC (A) 구매자의 혜택 - 아직 assuming보다 인증서의 실제 조항을 확인합니다.
## 보험가치 설정 — 두 가지 다른 "110%" 규칙 (범죄 프리미엄 없음)
110% 컨벤션은 두 가지 명백한 상황에 따라 하나의 유니버셜 공식으로 합병되지 않아야 합니다 :
- 인코텀즈® 2020 (판매자의 보험 의무): Incoterms 보험 (CIF/CIP)이 필요한 경우, 판매자는 구매자의 이익을 위해 최소 110%의 계약 가격에 대한 커버를 얻을 수 있어야 합니다.
...
## "모든 위험"은 제외 - 및 EV 문제
ICC (A)는 넓지 않습니다, 절대: 그것은 기계적인 전기 고장, 정규적인 착용 및 눈물 또는 내부 vice를 커버하지 않습니다 . EV의 경우 battery/thermal (fire) 이벤트를 위한 커버 특정 정책 wording 및 위험 상품 선언 의무에 따라 달라집니다. EV를 결정하고 열 runaway/battery 화재가 덮여 나 제외되는지 여부를 작성하는 데 묻습니다. EV가 얼음 자동차와 똑같이 대우되지 않습니다.
## 지불을 청구하는 클레임
보험은 문서화 된 손실에 응답합니다.

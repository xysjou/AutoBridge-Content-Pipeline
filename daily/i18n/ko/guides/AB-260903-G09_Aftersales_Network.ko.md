...
## 이 정책은 기대 뒤에
China's four-ministry used-car export notice (수출 지원 체계 개선에 관한 항목, 수출) ** 가이드 수출, OEM 제품  and  해외 수입업자는 판매 후를 합동으로 배달합니다, 안전한 수리부품  and  기술 지원**. MOFCOM는 동일한 통지를 나릅니다. 이 수단에서 판매 후 선택적 광택이 없습니다: 그것은, 지속 가능한 수출 운영의 일부이며 심각한 구매자의 공급 업체의 더 많은 부분입니다.

...
- ** 지불 늦은 배달: ** a per-day liquidated-damages rate (often expressed in per-mille, ‰,  per day) with a **계약을 해제할 수 있는 최대 지체 기간**.

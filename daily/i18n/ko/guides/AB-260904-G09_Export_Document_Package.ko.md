...
- **메타 설명**: 현재 GB/T 21085-2020 공장 증명서의 주위에 수출 문서 세트를 건설하십시오, 20260041-Q-339 표준을 개발 중으로 구분하여  and  NEV /translation 항목에 대한 권장 사항.
- **H1**: 중국 차량 수출 문서 패키지 조립 - 현재는 무엇인가, 여전히 초안, 우리가 추천하는 것은
- **주요 키워드**: 차량 수출 문서 포장 공장 증명서 GB/T21085
- **보조 검색어**: 机动车出厂合格证의 GB/T21085-2020 현재, 20260041-Q-339 초안, 적합 수출의 증명서, NEV 수출 문서 UN38.3
- **추천 URL**: /guides/export-vehicle-document-package
- **검색 의도**: 중국 차량 수출 문서 패키지를 조립하는 이해 - 현재는, 여전히 초안, 우리가 무엇을 추천: 어떤 차량 / 부품 수출은 확인해야, 문서 및 주문에 커밋하기 전에 결정.
...
- **이미지 제안**: 문서 번들 레이아웃
- **ALT 텍스트**: 현재 GB / T21085-2020 인증서는 필수 20260041-Q-339 초안을 versus
...
국내로 새로운 차량을 배달하는 것은 일반적으로 다음과 같이 여행합니다: 가득 차있는 판매 송장, (수동) 공장 증명서, 필수 검사 장, ** 적합의 증명서 **, 보장 (three-guarantee) 바우처, 정비 설명서, 소유자 설명서 및 내장 명부. ** 신규 차량 수출 판매 **, 국내 등록 단계는 ** 제조 업체의 안전 기술 검사 인증서 (원래) ** 및 상업 중심 모터 차량 수출 면허의 ** 복사 ** (자동차 차량 등록 작업 규칙 당).
...
- ** 해외 **영어 또는 목적지 언어 버전**는 발급 당에 의해 각인된 모수 장의 증명서의 밑에; notarization/consular 법적인화가 목적지에 달려 있는지 여부.
...
3. Cross-check 대하여 인증서 VIN (VIN 가이드 참조).
4. NEVs의 경우, 책 캐리어 당 UN38.3/MSDS을 준비합니다 (등록).
5. 대상이 되는 범위에만 스탬프된 번역을 준비하십시오.

## 이 가이드의 경계
- 차량 발급 규칙은 **DRAFT_ONLY 및 차단** 현재 필요 단어에서.
- 미래 표준의 정확한 날짜는 게시 될 때까지 알려집니다.
- 대상이 중국 CoC를 등록하는 경우 국가 별이며 asserted.

## 자주 묻는 질문
**Which 공장 증명서 기준은 ** GB/T 21085-2020 (추천, 현재; 검토된 2026-01-27).
** 20260041-Q-339 ** 아니요 - 개발 중에도 여전히 필수 표준입니다. GB 21085 -XXXX는 원칙적으로 상담 초안입니다.
** UN38.3 및 번역된 CoC 문서 ** 그들은 권장 준비; 실제 필요는 캐리어 해상 권위 및 목적지에 따라 달라집니다.
** 수출 판매 등록은 어떤 ** 제조업체의 안전 기술 검사 인증서 (원래) 및 모터 차량 수출 면허의 사본.

...
## Powertrain, 배터리 및 전기 기능
- ** 치수 **: 4730 1890 1660 (部分配置 1680) mm (긴 구성 1680 mm 키 큰), 휠베이스 2795 mm (크로스 체크);화물 볼륨 638 L.
- ** 하이브리드 엔진 **: 72 (1.5L 混动专用发动机) kW 전용 하이브리드 엔진; 드라이브 모터 160 kW (크로스 체크); E-CVT (电混传动).
- ** 배터리 **: 磷酸铁锂, 약 约 18.4 kWh. 셀 공급자는 이차 소스에 두 계정 아래 나타나고 **확인 ** - 여기에 주장되지 않습니다.
- ** 전기 범위 **: 130 km CLTC (크로스 체크); 결합된 CLTC 1250 km.
...
## 결제 전 해외 구매자 검증
1. VIN에 의해 정확한 PHEV 윤곽과 건전지 수용량을 확인하십시오; ICE UNI-Z 구조에서 분리하십시오.
2. 대상 테스트 사이클에 대한 Reconcile CLTC 130 km.
3. DC 충전 커넥터 protocol 및 V2L 수출 대상 시장에 적합.
4. 중국 specs에서 inferring 보다는 오히려 목적지 PHEV 유형 문서를 얻으십시오.
5. 현재 수출 인용 (destination, 수량, 트림, LHD RHD, 포트, Incoterm) 요청 - 가격은 여기에 게시되지 않습니다.

## 의논하기
**이 UNI-Z는 같은 이름으로 해외로 판매? ** 이 소스의 OEM 문에 의해 설치되지; 이름 또는 spec equivalence를 가정하지 마십시오.
** 배터리를 공급합니까?** 두 개의 이차 계정 충돌, 그래서 공급자는 unconfirmed 남아 있습니다.
** 내 시장에서 V2L 일? ** 3.3 kW 숫자는 중국 시장 spec입니다; 연결관과 격자 겸용성을 국부적으로 확인합니다.

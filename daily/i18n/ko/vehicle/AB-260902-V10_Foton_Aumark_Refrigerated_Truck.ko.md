...
- **마타 기술 **: Foton Aumark (올린) 암초병: 150 PS Jieyun 포좌, 4.085 m 절연 몸, GVW 4.495 t, 열 임금/수동 단위 선택권, 그리고 수출을 위한 냉장한 트럭을 지정하는 방법.
- **Suggested URL**: /vehicles/foton-aumark- 냉장 트럭/
...
암초는 정말 ** 세 가지 제품 **: 도우미 섀시, 절연화물 상자 및 냉동 장치 - 종종 다른 제조업체에 의해 만들어졌습니다. Comparing "reefer truck prices" without naming all three is misleading. 참고 차량은 ** Aumark Jieyun (捷运) 150 PS 4 × 2, 전체 차량 발표 BJ5041XLC8JDA-AB1 (chassis BJ1041V9JDA-AB1) ** 4.085 m 암초체; Foton는 또한 Foton Cummins 힘을 가진 Suyun (速运)를 판매합니다. 상세한 Jieyun 인물은 단 하나 근원 (360che); Cummins Suyun 세부사항은 Foton 공식적인 물자로 교차 검사됩니다.

## 포좌와 몬탈

| 제품 정보 | Jieyun 150 참고 (360che 당) |
|---|---|
...
| 기어박스 | ZF 6-speed |
| 제한/등급 탑재량/GVW | 3.2 t / 1.1 t / **4.495 t** |
| 타이어/최고 속도 | 7.00R16LT 8PR ×6; 95 km/h |

대안 ** Suyun ** 힘 (공식/크로스 검사): 470 N·m에 163 PS 버전과 156 PS에 Foton Cummins 2.8 L. 긴 운반 신뢰성과 글로벌 커민스 서비스 문제 인수 비용보다 더 많은 경우, 마력 혼자 선택보다 Yunnei Jieyun에 대한 커민스 전원 Suyun을 비교합니다.
...
상자 성과는 절연제 간격에 달려 있습니다  and  패널 공정 (샌드위치 패널, 폼 유형  and  조밀도), 지면 짐 등급, 문 물개  and  육류 / 고기 후크 내부가 장착 된 여부 - CIMC 고기 후크 리프터 바디는 하나의 목록 옵션입니다. 수출을 위해, 지정하십시오: 요구된 내부 온도 고정점, 패널 물자/간격, 지면 유형 (알루미늄 보행 판 등), 측/후방 문 배열 및 고기 걸이 또는 선반 이음쇠. These change payload (the insulated body is heavy — note the reference payload is only ~1.1 t at 4.495 t GVW)  and  가격 실질적으로.

## 냉장 단위 선택권

The captured reference lists three fitment routes (single-source, builder로 확인되어야 합니다.

- **중독 독립형 유닛**: 열왕 T880 Pro 독립적 인 냉동 장치 - 독립적 인 단위는 자신의 엔진을 가지고 트럭 엔진이 꺼져있을 때 냉각을 유지하고, 긴 운반 / 약 / 드프 - 파 젠 작업을 선호합니다.
- **국내 단위 **: 산풍 (三丰) 590, 주위에 정격 ** - 18 °C ** 냉동 상품을 위해.
- ** 특수 바디 **: 차카 수송을위한 CIMC 고기 후크 리프터 박스.

단위를 결정하는 조달 질문: 필요한 고정 지점 및 풀다운 시간 (치드 ~ 0 + 5 °C 대 냉동 − 18 °C 대 초저), 독립형 (아래 엔진) 대 차량 구동 / 압축기, 서포 플러그 인 대역 전기 작동, 그리고 - 수입에 대 한 중요 한 - ** 지역 서비스 및 냉동 브랜드에 대 한 예비 부품**. 수입한 열 임금/탄약 단위는 많은 국가에서 서비스하기 쉽 그러나 더 많은 것을 요합니다; 국내 단위는 확인한 부속 노선을 필요로 합니다.

## AutoBridge가 포좌 따옴표를 넘어서는 것
Reefer는 종종 섀시를 가격을 인용하고 상자와 냉각 장치 vague를 남겨. 권장 방법은 ** chassis / 절연 상자 / 냉동 장치가 별도로 지정 된 세 개로 유지됩니다. 별도의 가격 라인**, ** 박스 재질/두께  and  K-value plus 단위의 온도 범위  and  대기 (전기) 옵션** 운영 기후에  and  **destination food/pharma cold-chain Certification**에 대한 전체 조합을 확인하십시오.
## 지불의 앞에 검증

- 섀시, 박스 및 냉동 장치용 **공장/코치빌더 사양을 모형 번호와 함께 획득하십시오. 360che개의 그림은 단일 소스입니다.
...
**전용/무거부 단위는 무엇을 의미합니까? ** 그것은 자체 엔진과 냉각 트럭 엔진의 독립적으로 - 긴 transit 및 주차 할 때 유용합니다; 차량 구동 장치는 더 저렴하지만 엔진과 냉각을 중지합니다.
**, Yunnei 또는 Cummins 힘은 낫습니까? ** 참고 Jieyun은 Yunnei 2.5 L 150 PS를 사용합니다; the Suyun offers a Foton Cummins 2.8 L (156/163 PS) with a global service footprint — choose by service network  and  ...
** 어떤 온도가 열 수 있습니까? ** 목록으로 만들어진 국내 Sanfeng 590 표적 − 18 °C 언 일; 성취할 수 있는 고정점은 선택된 단위 및 절연제에, 이렇게 그것을 지정합니다.
**가격이 부여되지 않습니까? ** Reefer 비용은 상자와 냉각 장치에 크게 달려 있습니다; 믿을 수 있는 2026-09-02 가격은 붙잡히고,  and  one will not be estimated.
...
|---|---|---|---|---|---|---|
| Aumark Jieyun 150 암초 모수 | 360che (卡车之家년) | 담당자: Mr. wang | HTTP: //제품.m. 360che.com/m441/110460_param.html | 2026-09-02 | CROSS_체크 | 발표, Yunnei 엔진, ZF6의 무게, 상자, 단위 선택권 | http://product.m.360che.com/m441/110460_param.html
...
- **마지막 검토**: 2026-09-05
- **참고 시장 **: 중국, 현재 판매 발표 구성
- ** 인증 방법**: 공식 Foton 재료 플러스 독립 상업 데이터베이스; 섀시 / 바디 / 유닛 분리 유지; 단일 소스 및 가격 차이 공개

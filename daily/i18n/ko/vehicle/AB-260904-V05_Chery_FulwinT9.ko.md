...
Fulwin T9은 Chery의 C-DM 중간 크기 플러그 인 하이브리드 SUV입니다.  5석과 7석 형태로 제공. 두 가지 순서 오류가이 모델을 지배: 스트레칭 T9L ** 표준 T9을 혼합하고 배터리를 남지 않고 전기 범위를 인용합니다. 이 문서는 ** 표준 Fulwin T9 (REFERENCE MARKET 만: 중국)**; T9L (거짓 4870 mm 2920 mm 휠베이스)는 다른 몸이며 심하게 제외됩니다. OEM 구성 페이지는 spec base를 강화하는 이 모형을 위해 붙잡았습니다.
...
- 범위 단계 및 좌석 레이아웃은 트림에 따라 다를 수 있습니다; the 120–220 km 구간은 한 대의 단일 수치가 아니다.

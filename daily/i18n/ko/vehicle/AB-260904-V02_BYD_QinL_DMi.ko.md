...
## SEO 메타데이터
- **SEO 제목**: BYD Qin L DM -i PHEV Specs & 수출 가이드 (5th-Gen DM, CLTC)
- **메타 설명**: 중국 시장 BYD Qin L DM -i 다섯 번째 세대 플러그 인 하이브리드 - 1.5L 전용 엔진,   LFP  Blade battery 10.08/15.87 kWh,  80/120 km  CLTC  electric range,  and  수출입 검사.
- **H1**: BYD Qin L DM -i (Fifth Generation DM): 중국 시장 PHEV Specs 및 수출 주
- **주요 키워드**: qin l dm-i specs 수출
- **보조 검색어**: Qin L DM -i 120km,  fifth generation  DM ,   BYD  Blade battery  PHEV , Qin L CLTC 범위, 秦 L DM년 -i 수출
- **추천 URL**: /vehicles/byd-qin-l-dm-i/
- **검색 의도**: BYD Qin L DM -i (Fifth-Generation DM): 중국 시장 PHEV 사양 및 수출 노트: 차량 / 부품 수출자가 확인해야하는지, 문서 및 주문에 투입하기 전에 결정하십시오.
...
- **이미지 제안**: 측 단면도 Qin L DM -i
- **ALT 텍스트**: BYD Qin L DM-i 다섯 번째 세대 PHEV 세단
...
A PHEV buyer needs four answers in order: **엔진, 구동 모터, 배터리, 모드**. 여기에 전용 1.5L 엔진은 주로 단일 속도 DHT를 통해 구동을 생성합니다. 변속기보다 전기 및 하이브리드 모드 사이의 드라이버 스위치. 모든 주문 라인에 전기 범위에 일치 배터리 버전.

## Range Claim - 제조업체 라벨을 부착 유지
- 80/120km의 수치는 ** CLTC** 전기 범위입니다.
...
## 자주 묻는 질문
**Qin L DM-i 80 및 120의 차이점은 ** 배터리 용량 (10.08 대 15.87 kWh) 및 CLTC 전기 범위 (80 대 120 km), 플러스 장비 단계 - 주문에 버전을 지정합니다.
** 2100 km 범위의 테스트 된 수치가 ** 아니; 그것은 제조 업체-판매 풀 탱크-플러스-충전-충전-충전-증수와 같은 라벨을해야합니다.
** 어떤 테스트 사이클이 ** 중국 그림은 CLTC입니다; WLTP 또는 NEDC로 그들을 제시하지 마십시오.
** 중국 충전 커넥터가 해외로 ** 자동으로 되지 — GB/T 하드웨어는 대상 커넥터에 대해 확인해야 합니다.
...
|---|---|---|---|---|---|---|
ホーム > 제품정보 > Qin Lq 담당자: Mr. 광 | https://m.dongchedi.com/auto/params-carIds-x-9796 | 2026-09-04 | CROSS_체크 | 차원, 축거, 배터리, DHT, 무게, 탱크 |
자동차용 부품 제조업체 담당자: Mr. wang | https://db.m.auto.sohu.com/model_7361/config?sliding=1&selectedTrimId=176155 | 2026-09-04 | CROSS_체크 |사이트 맵
| Qin L DM-i 2024 120km년 납땜 손질 | Sohu 자동차 데이터베이스 | 담당자: Mr. wang | https://db.m.auto.sohu.com/trim_173018 경우 | 2026-09-04 | CROSS_체크 | 120 km CLTC의 국내 가격 참고 |
 다섯  다섯  다섯  오토  오토  오토  오토 오 오 오 오 오 오 오 오 오 오 오 오 오 오 오 오 오 오 오 오 오 오 오 오 오 오  오토  오토  오토  다섯  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토  오토 담당자: Mr. 광 | https://chejiahao.m.autohome.com.cn/info/18596386? | 2026-09-04 | SINGLE_SOURCE(싱글) | 전용 엔진, 빠른 충전 시간, 청구 된 결합 된 범위 |

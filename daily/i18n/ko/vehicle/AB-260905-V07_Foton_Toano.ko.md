...
- ** 변환 참고 **: F2.8NS6B177L：2780mL/130kW，属冷藏改装上装 — 냉동 차체는 상부 장착물(upfit)이다, 기본 밴 사양이 아닙니다.
...
## 결제 전 해외 구매자 검증
1. 이름 축거 (3070/3510/3750), 배치 및 엔진 순서에.
2. GVW/kerb 질량을 얻고 Foton OEM/homologation에서 가득 차있는 엔진 모체를 얻으십시오.
3. 별도의 업핏 프로젝트로 변환을 치료합니다.
4. 디젤 및 (중소 아시아 도로 노선) TIR 적합을 별도로 확인합니다.

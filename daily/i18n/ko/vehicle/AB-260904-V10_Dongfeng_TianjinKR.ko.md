...
5. **HS 분류** — 암초는 특수 목적의 상품 차량입니다. HS 코드 가이드 당 87.04 대 87.05 경계를 두는 확인하고 수출 문서 검사당 전체 문서 패키지를 조립합니다.

## 현재 수출 견적 요청
수출 가격은 발행되지 않습니다. ** 파생 국가 · 수량 · 섀시 (KR KR Plus) · Reefer Unit & Temperature Requirement · LHD RHD · Destination Port · Incoterm**.

## 자주 묻는 질문
** Dongfeng 포좌의 냉각 장치 ** 아니 - 포좌는 Dongfeng입니다; 격리한 상자 및 화가 단위는 몸 건축업자 upfit이고 그들의 자신의 명세 장이 필요합니다.
**GVW와 박스 길이는 ** 18 t GVW는 문서화 된 KR의 5000 mm 휠베이스에 6.8 m 박스를 갖추고 있습니다.
** 어느 ** 180 kW (245 PS) 1000 N·m에 Dongfeng Cummins B6.2NS6B245, Dana 416 차축에 빠른 8-speed 기어 박스를 통해.
** KR Plus는 어떻게 KR Plus는 더 큽니다. 330 PS D7.0 엔진, 7.88 m 상자, 5800 mm 휠베이스 - 분리하십시오.

...
- ** 170 km 등급 20 kW ** - 최저 취득 참조 (대략 RMB 41,800국내, 시간 감지); 고정, 짧은 일일 루프에 적합 차량이 기지로 돌아와 느린 충전을 밤새 (캠퍼스, 게이트 커뮤니티, 리조트, 짧은 대여, 작은 반경으로 마지막 마일).
- ** 215 km 등급 ~ 13.4 kWh LFP** - 약 RMB 46,800국내 참조; 추가 용량은 의무 자전거 헤드 웨이를 구입하고, 어떤 DC 규정이 나타날 수 있다는 유일한 등급입니다 - 심지어는 ** 구성 의존하고 VIN** 당 확인해야합니다.
...
Micro-EV 라인 변경 조합 자주, 그래서 ** 특정 VIN 빌드 시트에 대한이 필드를 잠금 **, 브로셔 이름이 아닌:
...
4. ** 측면과 언어** — 중국 빌드에서 RHD 또는 로컬 언어 UI를 가정하지 않습니다.
...
## 자주 묻는 질문
** MINIEV Macaron은 ** 170 km 또는 215 km CLTC 등급에 따라; 이 중국 도시 자전거 숫자, 고속도로 범위는 없습니다.
** 빠른 충전 할 수 ** 선은 주로 AC 느린 충전입니다. 215 등급의 DC 규정은 구성 별이며 VIN에서 확인해야합니다.

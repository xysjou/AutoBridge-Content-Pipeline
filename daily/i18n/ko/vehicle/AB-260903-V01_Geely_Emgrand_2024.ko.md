...
ICE 자동차용 수출업체의 질문에 집중 **엔진 코드/튠, 기어 박스 선택, 연료 등급 및 배출 단계**. 5MT과 CVT는 프로 포마에 교환 할 수 없습니다: VIN에 대한 전송을 수정하고 목적지가 중국-6 배출 수준을 수락하거나 자체 인증을 필요로한다는 것을 확인합니다 (CoC / 유형 승인 도시어 가이드 참조).
...
2. **송금** (5MT 대 CVT) 및 ** 정확한 파워/토크 ** 그 트림에 대한.
...
## 자주 묻는 질문
** 2024은 가장 새로운 Emgrand와 동일하게 부여됩니까? ** 없음 - 4th-generation 2024 자동차  and  새로운 5th 세대 (중국,  Nov 2025) differ in size, 휠베이스  and  가격; VIN이 속한 세대를 확인합니다.
** Emgrand는 자동 변속기를 가지고 있습니까? ** 중국 라인은 5-speed 매뉴얼과 함께 CVT를 제공합니다. 주문에 대해 하나를 지정하십시오.
** 중국 - 6 자동차는 유로 인증을 자동적으로? ** No - 중국 배출 승인 및 목적지 유형 승인은 다른 프로세스입니다. 수입 시장의 필수 CoC / 승인 확인.
** 강력한 1.5L 엔진은? ** 93 kW (약 127 PS) 중국 참조 시트에 127 N·m; 정확한 트림을 확인합니다.

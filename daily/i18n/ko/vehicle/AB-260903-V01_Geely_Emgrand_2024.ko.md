...
Emgrand는 Geely의 고량 컴팩트한 술집과 가격 감지 된 엔트리카 시장을 위한 자연 후보입니다. importer의 함정은 세대입니다: 이 페이지는 ** 4th-generation 2024 중국 시장 자동차 (지역 시장: 중국)**,  while an **all-new 5세대가 해당 연도 11월 중국에 출시 2025** with a longer body, 더 긴 축축  and  낮은 시작 가격. 5th-gen 차원에 대한 2024 단위 할당 - 또는 부버 -이 명찰에 단일 가장 일반적인 순서 오류입니다. ** 중국 시장 참조 사양**로 각 숫자를 치료하십시오. 대상 시장 엔진 조정, 배출 단계 및 장비는이 시트에 의해하지 않는 지역 균질화에 의해 지배된다.

## 중국 시장 채식 및 Driveline (ICE 초점: 엔진, 기어 박스, 연료, 배출)
| 제품 정보 | 4th-gen Emgrand 2024 (China reference) |
|---|---|
| 바디 스타일 | 4-door, 5-seat 술집 |
| 의 특징 | 1.5L 자연 aspirated 인라인 4 휘발유 |
| 최대 힘 | 93 kW (≈127 PS) |
| 최대 토크 | 127 N·m (단일 자원; 정확한 손질 장에 확인하십시오) |
| 의논하기 | 5-speed 매뉴얼 ** 또는 ** CVT |
| 의 특징 | 앞 바퀴 드라이브 |
| 연료 주 | 휘발유; 연료 등급과 목적지 배출 단계 (중국 - 6 spec는 자체, 유로 인증)에 의해 아닙니다 |

ICE 자동차용 수출업체의 질문에 집중 **엔진 기어 박스 선택, 연료 등급 및 배출 단계**. 5MT과 CVT는 프로 포마에 교환 할 수 없습니다: VIN에 대한 전송을 수정하고 목적지가 중국-6 배출 수준을 수락하거나 자체 인증을 필요로한다는 것을 확인합니다 (CoC 유형 승인 도시어 가이드 참조).

## 차원과 오두막
- 길이 폭 높이: ** 4638 1820 1460 mm **
- 휠베이스: ** 2650 mm **
- 좌석: ** 5 **
이 4th-gen 자동차에 대한 중국 설정 치수입니다. 5th-generation 자동차는 더 크다 (수출 4815 1885 1480 mm, 2755 mm 휠베이스) - spec 라인 또는 마케팅 자료에서 두 가지를 혼합하지 마십시오.

## 모델 년 경계 (이 눈에 보이는 것을 따르십시오)
- **이 페이지:** 4th 세대, 모델 년 2024.
- **신: ** 5th 세대,  China launch November 2025 (TIME_SENSITIVE; 가용성 및 specs는 시장에 의하여 변화합니다).
- 추천된 연습: state generation**and** 모델 year**and** 생산 날짜에 PI. "Geely Emgrand" 라벨은 혼자 2024–2026.의 주위에 주변입니다.

## 지불의 앞에 Verify해야 하는 어떤 수입업자
1. ** PI에 작성된 Generation/year/trim** 및 VIN에 일치 — 5th-gen 주장을 가진 섞는 4th-gen 몸 없음.
2. **송금** (5MT 대 CVT) 및 ** 정확한 ** 그 트림에 대한.
3. **Emission/fuel** 호환성 및 대상 **type-approval/CoC** 노선; 중국 적합 증명서는 국내 문서, 해외 시장 접근이 아닙니다.
4. ** 측면, 클러스터 언어, 인포테인먼트 지역 ** 및 목적지의 보증.
5. **로드 플랜** - 4.64 m의 샐러드가 컨테이너 로드에서 효율적으로로드합니다. 부하 계획에서 실제 도난 수를 확인합니다 (컨테이너 로드 가이드 참조).

## 현재 수출 견적 요청
정적 수출 가격은 출판되지 않습니다. 대략 RMB 69의 900 중국 시작 그림은 **domestic의 시간 과민한 참고만 - FOB/CIF 인용 ** 아닙니다. ** 목적지 항구 · Incoterm**에 문의하십시오.

## 자주 묻는 질문
** 2024은 가장 새로운 Emgrand와 동일하게 ** 없음 - 4th-generation 2024 자동차  and  새로운 5th 세대 (중국,  Nov 2025) differ in size, 휠베이스  and  가격; VIN이 속한 세대를 확인합니다.
** Emgrand는 자동 변속기를 가지고 ** 중국 라인은 5-speed 매뉴얼과 함께 CVT를 제공합니다. 주문에 대해 하나를 지정하십시오.
** 중국 - 6 자동차는 유로 인증을 ** No - 중국 배출 승인 및 목적지 유형 승인은 다른 프로세스입니다. 수입 시장의 필수 CoC 승인 확인.
...
- **마지막 검토**: 2026-09-05
- **참고 시장 **: 중국, 4th-generation 2024 Emgrand (중국 시장 참고 명세; 세계적인 spec 아닙니다)
- **Verification 방법 **: 다중 데이터베이스 크로스 체크; 세대 경계 격리; 대상이 없음

...
For a tractor the buyer's decision runs across six dimensions,  and  각 모델명에서 가정하는 것보다는 쓰기에 고정되어야한다. (1) ** 엔진 ** 배출 단계 및 정확한 등급; (2) ** 기어 박스 ** (자동 대 수동) 및 속도의 수; (3) ** 드라이브 차축 ** 및 비율; (4) ** gross 조합 무게 (GCW) ** 구성은 당겨에 찬성됩니다; (5) ** cab ** (고투명 슬리퍼 명세) 및 (6) ** chassis ** 선택된 중국 6 빌드에 대한 공기 현탁액과 유압 지연제와 같은 옵션. 균질 인증서에서 GCW 및 차축 로드 등급을 획득하십시오. 그들은 엔진 힘에서 inferred.

...
## SEO 메타데이터
- **SEO 제목**: SAIC 맥시 V90 Diesel Van Specs & 수출 구성 가이드
- **메타 설명**: Chinese-market  SAIC  Maxus V90 wide-body diesel light van —  SAIC  π 2.0T diesel (110/130 kW), 6AT/ ZF 8AT, 선택 듀얼 후방 휠 RWD,  two wheelbases, 9–15석 균질화
- **H1**: SAIC Maxus Xintu V90 (중국 시장): Diesel Light Van 구성 및 수출 검사
- **주요 키워드**: saic maxus v90 디젤 밴 specs
- **보조 검색어**: Maxus V90 축거, V90 ZF 8AT의 Maxus 가벼운 버스 9-15 좌석, 디젤 넓은 몸 밴 수출, 이중 후방 바퀴 밴
- **추천 URL**: /vehicles/saic-maxus-v90-specs/
- **검색 의도**: SAIC Maxus Xintu V90 (중국 시장)를 견딜 수 있습니다. Diesel Light Van Configuration 및 Export Checks: 차량/부품 수출업체가 확인해야 하며, 주문에 따라 문서와 결정해야 합니다.
...
- **이미지 제안**: 긴 축 높은 회전 측면 프로파일
- **ALT 텍스트**: SAIC Maxus V90 긴 축축 높은 지붕 밴
...
| 의 | 앞 엔진, ** 레이 휠 드라이브 **; ** 듀얼 리어 휠 옵션 ** |
| 의 | Diesel - 연료 품질 공차 및 목적지 배출 단계 확인 |

...
"Jolion"은 ** 해외 시장 이름 ******** 하반 Chulian (哈弗初恋)**로 집에서 판매 된 중국 소형 SUV에 대한. alias는 봅시다. alias는 낭만적인 스타일의 MODEL_ALIAS_REQUIRES_OEM_PROOF에 따라 **베이스 모델 ID는 SAME_입니다. MODEL**. 중요한 제한: *name*의 OEM 확인은 **** 매 시장의 *powertrain 및 trim* 동일하게 만듭니다. 중국 1.5T, 호주 1.5T 및 해외 HEV는 ** 시장**에 따라 나열되며 "글로벌 사양"은 asserted입니다.
...
중국 차원, 의 특징  및 출력은 주로 하나의 구조화된 데이터베이스에 의존한다; 공장에 대한 시트를 재구성하는 참조 값으로 치료하십시오.
...
**중국판에 호주판 화물 부피를 적용해도 되는가?** No — 430/1130 L는 해외판 수치다; 중국 자동차를 별도로 확인합니다.

...
## SEO 메타데이터
- **SEO 제목**: JMC  Shunda Light Truck Specs & Export Guide ( GVW  4.27t, 중국- 6)
- **메타 설명**: 중국 시장 JMC Shunda 블루 플레이트 라이트 트럭 - JX493 디젤 90 kW, GVW 4.27 t, 3700 mm 드롭사이드 침대, 휠베이스 및 도는 원형, 플러스 페이로드 및 엔진 버전 검사 수출 필요.
- **H1**: JMC  Shunda: 중국 시장 빛 트럭 포좌, GVW 및 수출을 위한 화물 Specs
- **주요 키워드**: jmc shunda 빛 트럭 specs 수출
- **보조 검색어**: JMC  Shunda  JX493 , 顺达小卡, 중국 빛 트럭 GVW, JMC dropside 페이로드, 중국- 6 디젤 트럭 수출
- **추천 URL**: /vehicles/jmc-shunda/
- **검색 의도**: JMC의 이해 썬다: 중국 시장 빛 트럭 포좌, GVW 및 수출을 위한 화물 Specs: 어떤 차량/parts 수출자는 순서에 투입하기 전에, 문서 및 결정해야 합니다.
...
- **이미지 제안**: Shunda dropside 측
- **ALT 텍스트**: JMC Shunda 파란 판 빛 트럭 dropside
...
| 이용요금 | 약 1.93–2.0 t - MIIT 발표서류 당 최종값** 의논문
| 휠베이스 | **2800 mm** |
| 회전 원형 | **5.5 m** |
| 의정부 | 중국- 6 디젤 |

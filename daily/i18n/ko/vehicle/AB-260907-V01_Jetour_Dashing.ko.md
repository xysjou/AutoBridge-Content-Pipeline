...
앞바퀴 구동 모노코크 컴팩트 SUV로서 Dashing은 온로드 가족을 대상으로합니다.  and  urban-fleet use rather than four-wheel-drive off-road work. 더 높은 손질은 큰 중앙 스크린, 운전사 보조 특징 및 세그먼트의 전형적인 편익 장비를 나릅니다, 그러나 정확한 장비 세트는 손질과 년 별입니다. 실제 SKU의 구성 시트에 대한 주문; Top-trim 리뷰 단위에서 볼 수있는 기능을주의하지 마십시오. 인용 된 기본 자동차에 확장.
...
The 1.6T at 145 kW/290 N·m with a 7DCT is cross-checked by two independent sources; 다른 두 줄은 현재 단 하나 근원에 OEM 정확한 trim 확인을 보류합니다.

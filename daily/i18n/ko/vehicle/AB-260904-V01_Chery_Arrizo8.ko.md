...
| 방출 주 | 휘발유; 중국- 6 수준 - 목적지 연료 등급 및 배출 경로 확인 (중국- 6는 해외 유형 승인이 아닙니다) |
...
## 자주 묻는 질문
**Arrizo 8는 소형 또는 중간 크기의 ** 4780 mm의 긴 2790 mm 휠베이스는 컴팩트 한 필드의 상단 가장자리에 앉아있다, B-segment 치수 근처 - 측정 된 풋프린트에 의해 분류, 마케팅 라벨이 아닙니다.
** 1.6T은 ** 중국 1.6TGDI는 145 kW (약 197 PS) 및 290 N·m에 문서화되어 7-speed 젖은 DCT로 묶습니다.
** Arrizo 8 모델을 수출과 동일한 중국 ** 가정하지 않음 -이 시트는 중국 시장 참고입니다. 목적지 조정 및 장비는 로컬 OEM 사양이 필요합니다.
** 중국 - 6 배출은 자동차가 내 시장을 위해 인증을 ** 없음; 목적지 유형 승인은 분리되는 과정입니다.

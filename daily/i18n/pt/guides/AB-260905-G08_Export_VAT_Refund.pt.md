...
## A taxa de restituição é por código SH — e não é calculada
A taxa de restituição do IVA de exportação é fixada por ** código/produto SH** e alterações ao longo do tempo. Este guia declara deliberadamente ** nenhuma taxa numérica**: procure a taxa atual para o código exato do HS 10-digit no dia, porque citar uma taxa desatualizada distorce o modelo de custo-desempenho. Os prazos de depósito sensíveis também vêm do aviso STA atual.

## Por que as reivindicações de reembolso param: as armadilhas de consistência
...
5. Mantenha o rasto de cálculo para a inspecção fiscal.
...
- **Mercado de referência**: CN(中国税务侧)

...
- **MOFCOM General Office Notice on the 2026 automobile/motorcycle export-licence application (商办贸函〔2025〕408号, 28 Set 2025)** move aplicativos online (comp.licence.org.cn), com revisão preliminar do comércio local  and  Uma lista publicada de empresas qualificadas.
...
**What changed in China's export rules for 2026?** The 2026 application round runs under 商办贸函〔2025〕408号,  and  a partir de 1 Jan 2026 veículos de passageiros puros (HS 8703801090) exigem uma licença de exportação no âmbito do anúncio conjunto n.o. 54; Utilizar a lista de qualificações do ano em curso.

...
- ** 87.04 vs 87.05 ** — um veículo de mercadorias que * transporta carga* é 87.04; um veículo construído em torno de uma *função especial* (elevação, perfuração, máquinas montadas onde o transporte de carga é incidental) é de 87.05. Um camião de caixas refrigerados ainda transporta mercadorias e é tratado como um veículo de mercadorias; se uma superestrutura de refrigeração acrescentada altera a subposição de dez dígitos deve ser verificado linha a linha no 2026 tariff. Uma cabeça de trator (87.01) e seu semi-reboque (87.16) são sempre classificados separadamente, mesmo quando enviados como uma combinação.

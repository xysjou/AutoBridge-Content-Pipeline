...
| Rubrica | O que é que abrange (quadro da pauta aduaneira 2026) | Produto típico da AutoBridge |
|---|---|---|
| **87.01** | Tractores (excepto os tractores da posição 87.09), ** incluindo os semi-reboques * | Cabeça de tractor tipo Tianlong KL |
| **87.02** | Veículos a motor para ** 10+ pessoas** (autocarros/caixas), incluindo subposições eléctricas/híbridas | ônibus da cidade, ônibus |
| **87.03** | Veículos a motor **principalmente para pessoas, ≤ 9 lugares** — bares, SUVs, MPVs, veículos híbridos e eléctricos de passageiros | BYD/Chery/GWM automóveis de passageiros |
| **87.04** | ** Veículos de mercadorias** (incluindo veículos de carga eléctrica; carga de três rodas inferior a 8704.6000) | Shunda caminhão leve, van de carga |
...
- ** 87.03 vs 87.04 ** — decidido por * uso principal* (pessoas vs mercadorias), não forma corporal. Uma carrinha e uma carrinha fechadas precisam de uma decisão explícita sobre o uso principal.
- ** 87.04 vs 87.05 ** — um veículo de mercadorias que * transporta carga* é 87.04; um veículo construído em torno de uma *função especial* (elevação, perfuração, máquinas montadas onde o transporte de carga é incidental) é de 87.05. Um camião de caixas refrigerados ainda transporta mercadorias e é tratado como um veículo de mercadorias; whether an added refrigeration superstructure moves the ten-digit subheading must be checked line by line in the 2026 tariff. Uma cabeça de trator (87.01) e seu semi-reboque (87.16) são sempre classificados separadamente, mesmo quando enviados como uma combinação.
...
- **A subposição nacional exata de dez dígitos e a taxa provisória**: elas mudam com a tarifa anual — citam a edição ** 2026 e o número de anúncio GACC** de implementação em cada declaração, em vez de se basear em 2018/2020 quadros de referência mais antigos.
...
** Para onde vai uma cabeça de tractor semi-reboque?** Em 87.01 (que inclui expressamente tratores semi-reboques); o semi-reboque que puxa é 87.16, uma classificação separada.
** Um carro elétrico de passageiros ainda é 87.03 ?** Sim — automóveis eléctricos e híbridos de passageiros, para um máximo de nove pessoas, situados no espaço de 87.03; o comboio de potência muda a subposição, não a posição.
...
** Que edição tarifária devo citar agora?** O 2026 *Tarifário de Importação e Exportação* e o anúncio do GACC que implementa o programa 2026; não use 2018/2020 quadros como base atual.
...
- ** Método de verificação**: 2026 tarifa primária + implementação GACC ancorada; Q&A de fonte única sinalizada; HS-primeiro método aplicado

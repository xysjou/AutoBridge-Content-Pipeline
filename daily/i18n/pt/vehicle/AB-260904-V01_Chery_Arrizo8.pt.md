...
- ** Mercado de referência**: China, 2024/2025 Arrizo 8 1.6TGDI (especificação de referência do mercado chinês; não uma especificação global)
- ** Método de verificação**: Verificação cruzada de dois dados; itens de código único marcados; nenhuma extrapolação de destino

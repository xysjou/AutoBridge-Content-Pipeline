# GAC Trumpchi E8 (传祺E8): um PHEV MPV de sete lugares – Especificações da China e verificações de exportação

## Metadados SEO
- **Título SEO**: GAC Trumpchi E8 PHEV MPV Especificações e Guia de Exportação (7-Seat, China)
- **Meta descrição**: China-mercado Trumpchi E8 nova-energia PHEV MPV — 2.0ATK motor, 134 kW motor, 25.57 kWh bateria, 150 km CLTC, 2+2+3 assentos, e como difere da Glory HEV não-carregando.
- **H1**: GAC Trumpchi E8 PHEV: Seven-Seat de Mercado Chinês MPV Especificações e Notas de Exportação
- **Palavra-chave principal**: exportação de especificações de phev de gac Trumpchi e8
- **Termos de busca secundários**: Trumpchi E8 MPV, 传祺 E8 PHEV, E8 Glória HEV diferença, Trumpchi E8 7-seat, China PHEV MPV exportação
- **URL sugerida**: /vehicles/gac-trumpchi-e8/
- **Intenção de busca**: Compreenda GAC Trumpchi E8 PHEV: Chinês-Market Seven-Seat MPV Especificações e Notas de Exportação: o que um exportador de veículos/partes deve verificar, documentar e decidir antes de se comprometer com uma ordem.
- **Sugestões de links internos**: /guides/ev-shipping-un3556-imdg-compliance/ ; /guides/export-vehicle-document-package/ ; /vehicles/chery-fulwin-t9/
- **Sugestão de imagem**: Perfil lateral de E8 MPV
- **Texto ALT**: GAC Trumpchi E8 PHEV seven-seat MPV China spec
- **Escopo do schema**: Artigo + Veículo (sem produto/oferta/preço/revisão/rating)

## Contexto do comprador: uma compra do MPV é decidida por assento e pela divisão do PHEV/HEV
Para um exportador de MPV as perguntas são geometria de cabine e arquitetura de assentos primeiro, powertrain segundo. Na E8 há uma armadilha de nome: a ** E8 New Energy é um híbrido plug-in com uma porta de carregamento**, enquanto a ** E8 Glory (荣耀) é um HEV sem porta de carregamento**. São tipos de energia diferentes e devem ser citados em linhas separadas. Esta folha documenta o PHEV ** do mercado chinês (REFERÊNCIA MERCADO: CHINA)**; uma página de configuração OEM foi capturada.

## MPV Núcleo: Assentos, espaço e passageiros
...
| Peso do enrolamento | 2175 kg |
| Tanque de combustível | 50 L |

A distância entre eixos 2930 mm e 2+2+3 são a história comercial: Os lugares de capitão independentes da linha média e uma terceira fila utilizável. Confirme a configuração exata do assento no VIN, uma vez que o corte do MPV muda muitas vezes alterar a especificação de linha média.

## PHEV Powertrain (porta de carga E8)
| Item | Detalhe |
|---|---|
...
| Exportação de energia | 3.3 kW descarga externa (V2L) e 5.5 kW V2V (fonte única; confirmar por OEM) |
...
2. ** Layout de assento** — 2+2+3 especificações de sete lugares e linha média confirmadas por corte.
3. ** Conector de carga** vs padrão de destino; ternary-lithium battery shipping documents (UN38.3 summary) per the IMDG 42-24 guide.
4. ** V2L/V2V poder de exportação** reivindicações confirmadas na folha OEM (unica fonte aqui).
5. ** Classe de registro híbrido de destino e documentos** por meio da lista de verificação do pacote de documentos de exportação.

## Solicitar uma Cotação de Exportação Atual
Nenhum preço de exportação é publicado. Os preços de orientação chineses são ** referências nacionais, sensíveis ao tempo, não FOB/CIF**. Solicite um orçamento ao vivo com **Destino País · Quantidade · PHEV ou HEV Trim · LHD/RHD · Destino Porto · Incoterm**.

## Perguntas Mais Frequentes
** O Trumpchi E8 é um híbrido plug-in ou um híbrido auto-carregador?** A Nova Energia E8 é um PHEV com uma porta de carregamento; a Glory E8 é um HEV não carregado — especifique qual.
** Quantos lugares? Um 2+2+3 MPV de sete lugares numa distância de 2930 mm eixos.
** Qual é a faixa elétrica?** 150 km CLTC para o PHEV documentado.
** Os E8 podem alimentar dispositivos externos?** A cobertura chinesa lista 3.3 kW V2L e 5.5 kW V2V; confirme na folha de corte exato OEM.
...
|---|---|---|---|---|---|---|
| Trumpchi E8+ tabela de configuração oficial | GAC Trumpchi (OEM) | NC | https://www.gacmotor.com/configtable?id=811 | 2026-09-04 | VERIFICADO (EMO) | PHEV powertrain, bateria, dimensões, bancos |
| Lançamento, tamanho e electrificação do E8 (PHEV) | Diário de Metrópolis do Sul | NC | http://m.toutiao.com/group/7281953819724988991/ | 2026-09-04 | CROSS_CHECKED | Dimensões, motor, bateria |
| E8 showroom: tamanho/motor/bateria | VocêCheYiHou | NC | http://m.toutiao.com/group/7282038365669982759/ | 2026-09-04 | CROSS_CHECKED | Motor, peso, V2L/V2V |
| E8 arquitetura GPMA e aço de alta resistência | Yangcheng Notícias da noite PDF | NC | https://ep.ycwb.com/epaper/ycwb/resfile/2023-12-13/A11/ycwb20231213A11.pdf | 2026-09-04 | FONTE ÚNICA | Plataforma, ~ 75% HSS |
| Trumpchi E8 Nova configuração de linha completa de energia | Configuração do PCauto | NC | https://car.pcauto.com.cn/360/s47354/r1/config.html | 2026-09-04 | CROSS_CHECKED | Dimensões, 25.57 kWh, intervalo CLTC |
...
* Nota de confiança: página OEM capturado; relação de aço plataforma e V2L/V2V figuras são de fonte única. PHEV e Glory HEV deliberadamente separados; referência mercado chinês apenas. *

## Revisão Editorial
- **Autor**: AutoBridge Export Editorial Team · método para o nosso [Política editorial](/política editorial/)
- ** Última revisão**: 2026-09-05
- ** Mercado de referência**: China, E8 New Energy PHEV (referência do mercado chinês; CLTC indicado; Glory HEV separado; não uma especificação global)
- ** Método de verificação**: OEM config ancorado; energia-tipo split forçado; itens de fonte única sinalizados

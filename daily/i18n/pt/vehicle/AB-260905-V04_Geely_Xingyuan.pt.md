...
## Metadados SEO
- **Título SEO**: Geely Xingyuan (Galaxy Xingyuan)  BEV : Especificações e Exportação de Mercado Chinês Guia
- **Meta descrição**: Chinese-market Geely Xingyuan/Starwish small  EV : GEA arquitectura, RWD,  58/85 kW motors,  310/410 km  CLTC , Linha 40.16 kWh  and  Controlos de exportação de compradores.
- **H1**: Geely Xinguan / Galaxy Xinguuan (2025/2026) — Especificações do mercado chinês BEV e verificação da exportação
- **Palavra-chave principal**: Geely / 吉利 Xingyuan / 吉利星愿 (Galaxy 星愿) especificações de exportação
- **Termos de busca secundários**: Geely Xingyuan exportação; Galaxy Xingyuan especificações; Geely Starwish; chinês pequeno hatchback elétrico; CLTC cidade EV
- **URL sugerida**: /vehicles/geely-xingyuan/
- **Intenção de busca**: Compreenda Geely Xinguan / Galaxy Xinguuan (2025/2026) — Mercado chinês BEV Especificações e Verificação de Exportação: o que um exportador de veículos/partes deve verificar, documentar e decidir antes de se comprometer com uma ordem.
- **Sugestões de links internos**: /vehicles/geely-xingyuan/, /guides/ev-shipping-un3556-imdg-compliance-history/, /guides/export-compliance-sanctions-screening-end-user/
- **Sugestão de imagem**: Uma cena realista, documento/veículo focado ilustrando Geely Xinguan / Galaxy Xinguuan (2025/2026) — Chinese-Market BEV Especificações e Exportação Verific, nenhuma inspeção encenada ou as pessoas reivindicadas.
- **Texto ALT**: Fechar, visão natural dos materiais e do assunto relacionado a Geely Xinguan / Galaxy Xinguuan (2025/2026) — Chinese-Market BEV Especificações e Expo, fundo neutro, nenhuma pessoa ou ação de inspeção mostrado.
...
Cidade Os EVs são frequentemente mal citados usando um número de intervalo para duas linhas de motor/bateria. No Xinguuan, emparelhe o motor (58 ou 85 kW) com sua bateria correspondente e intervalo CLTC em cada ordem, e converter para o ciclo de teste de destino em vez de re-rotular CLTC. Como uma bateria de iões de lítio EV, o frete marítimo segue a atual classificação IMDG para veículos movidos a baterias (UN3556 para o veículo intacto) — consulte o guia de transporte. Fornecedor de bateria e pico de carga de energia não confirmada pendentes dados OEM.
...
4. Confirme a homologação EV, documentos de bateria e documentos de envio de UN38.3/IMDG com o encaminhador.

...
- ** Descrição do Meta**: Geely Xinguan/Starwish pequeno EV: GEA architecture, RWD, 58/85 kW motors, 310/410 km CLTC, 40.16 kWh line and export buyer checks.
- ** H1 **: Geely Xinguan / Galaxy Xinguan (2025/2026) — Especificações do BEV do mercado chinês e verificação da exportação
- **Chave Primária**: Geely / 吉利 Xingyuan / 吉利星愿（Galaxy 星愿） specs export
...
- ** Sugestões de ligação interna**: /veículos/geely-xinguan/, /guias/ev-shipping- un3556-imdg-compliance-history/, /guias/exportações-conformidade-sanções-sálvia-utilizador final/
- **Schema Scope**: Artigo + Veículo (sem Produto/Oferta/Revisão)

## Contexto do comprador e identidade do modelo
The **Geely Xingyuan (Galaxy Xingyuan, marketed in some export markets under a separate English name)** is an A0 five-door battery-electric hatchback on Geely's **GEA** EV architecture, with **rear-motor/rear-wheel drive**. Esta página é a referência ** do mercado chinês**; um nome de modelo no estrangeiro não é tratado como idêntico sem uma declaração do OEM.

## Linhas elétricas de potência e gama
- ** Corpo**: 4135 / 1805 / 1570（STAR限定版车长4155） mm (STAR edition 4155 mm long), wheelbase 2650 mm, 5门5座; 后置后驱.
- **Motores**: 58 / 85 kW options.
- **Bateria**: 磷酸铁锂; the captured capacity line is 40.16 kWh for the longer-range car. Um fornecedor específico de células aparece apenas em contas de enciclopédia/media e é **não confirmado pelo OEM**, por isso é retido.
- ** Intervalo**: 310 / 410 km CLTC (cross-checked) — a Chinese test cycle, not WLTP.
- **Carga**: 375（前备厢70，后排放倒1320） L; platform GEA 纯电架构.
...
|---|---|---|---|---|---|
| largura de comprimento altura | 4135 / 1805 / 1570（STAR限定版车长4155） | mm | CHINA | CROSS_CHECKED | 搜狐双页 |
...
| volume de carga | 375（前备厢70，后排放倒1320） | L | CHINA | FONTE ÚNICA | 搜狐车型库 |
| plataforma | GEA 纯电架构 | - Não, não, não. | CHINA | FONTE ÚNICA | 腾讯新闻 |

## Lógica de exportação Small-EV: linha de bateria, ciclo e transporte
Cidade Os EVs são frequentemente mal citados usando um número de intervalo para duas linhas de motor/bateria. On the Xingyuan, pair the motor (58 or 85 kW) with its matching battery and CLTC range on every order, and convert to the destination test cycle rather than re-labelling CLTC. Como uma bateria de iões de lítio EV, o frete marítimo segue a atual classificação IMDG para veículos movidos a bateria (UN3556 para o veículo intacto) — consulte o guia de transporte. Fornecedor de bateria e pico de carga de energia não confirmada pendentes dados OEM.

## Verificação do comprador no exterior antes do pagamento
1. Combine a opção do motor com a bateria e o intervalo CLTC; obtenha a linha de construção VIN.
2. Translate CLTC 310/410 km to the destination cycle.
3. Confirme o conector/protocolo de carga e a capacidade AC/DC (pico DC não capturado aqui).
4. Confirme a homologação EV, documentos de bateria e papelada de envio UN38.3/IMDG com o encaminhador.
5. Solicitar uma cotação de exportação atual; nenhum preço de exportação é publicado.

## Perguntas Frequentes
** É Xinguuan o mesmo que a exportação "Starwish"? ** Nomes em todos os mercados exigem uma declaração OEM; esta página mantém a identidade chinesa.
** Por que não há carga-power figura?** Não foi fonte confiável e é retido em vez de adivinhado.
** Quem faz as células?** Não confirmado pelo OEM; não declarado.
**Is 410 km WLTP?** No — CLTC.
** Como é que ele envia? Como uma bateria de iões de lítio intacta EV sob a classe IMDG atual (UN3556); confirme com o portador.


## Fontes e Verificação
| Origem | Organização | Mercado | Nível | Confiança | URL | Factos corroborados |
|---|---|---|---|---|---|---|
| 吉利星愿 车型参数 | 搜狐汽车 | NC | T2 | CROSS_CHECKED | http://db.auto.sohu.com/model_7477/a/1058252073_120590677 | 尺寸, 电机, 电池, 续航 |
| 吉利星愿 配置库 | 搜狐汽车车型库 | NC | T2 | CROSS_CHECKED | http://db.auto.sohu.com/model_7477/config | 尺寸, 轴距, 储物 |
| 星愿 上市报道 | 腾讯新闻 | NC | T3 | CROSS_CHECKED | http://news.qq.com/rain/a/20260329A04ZLQ00 | 续航版本, 架构 |
| Site oficial global Geely | Geely Auto Group 吉利 (OEM) | NC | T1 | VERIFICADO | https://global.geely.com/ | Identidade de marca/modelo-linha e autoridade OEM |
...
| Administração do Estado para o Regulamento do Mercado (SAMR) | SAMR 国家市场监督管理总局 | NC | T1 | VERIFICADO | https://www.samr.gov.cn/ | Normas nacionais, certificação e autoridade de regulação do mercado |
## Revisão Editorial
...
- ** MODEL_TOPIC_ MATCH**: exatamente Geely Xingyuan

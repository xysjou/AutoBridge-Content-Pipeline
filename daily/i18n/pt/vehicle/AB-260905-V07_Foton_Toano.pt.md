...
- ** H1 **: Foton Toano / Tuyano (2026) — Especificações e verificações de exportação de veículos de grande porte de mercado chinês (Light Bus)
- **Chave Primária**: Foton / 福田 Toano / 图雅诺 大VAN（轻客） specs export
...
The **Foton Toano (图雅诺, 2026)** is a Chinese-market diesel large van/light bus offered across many wheelbases and seat counts. Como a matriz variante é ampla, esta página é escrita em torno de **configurações identificadas apenas** ao invés de uma única especificação implícita de "Toano". O mercado de referência é **China**.

## Dimensões identificadas, grupo de potência e lugares sentados
- ** Corpo curto (X5)**: 4990×1980×1990, wheelbase 3070 mm.
- ** Longas distâncias entre eixos**: 3510（X5长轴）/3750（经典长轴，车长5990×2000） mm.
- ** 2.5T torque diesel**: 400 N·m; caixa de velocidades 6MT.
- **Seats**: 3/5/6/7/9/14/15/17（随版本）.
- ** Nota de conversão**: F2.8NS6B177L：2780mL/130kW，属冷藏改装上装 — a refrigerated body is an upfit, not a base-van specification.
...
| x5 distância curta entre eixos | 3070 | mm | CHINA | FONTE ÚNICA | 搜狐对比 |
| opções de longa distância entre eixos | 3510（X5长轴）/3750（经典长轴，车长5990×2000） | mm | CHINA | FONTE ÚNICA | 搜狐对比 |
| motor 2 5t torque | 400 | N.m. | CHINA | FONTE ÚNICA | 大众网 |
...
** Quantos lugares? Ele varia entre as versões (3–17); especifique a compilação exata.
** Por que não há lista completa de energia ISF2.8?** A matriz variante precisa de um bloqueio OEM; é retido.
...
|---|---|---|---|---|---|---|
| 图雅诺 词条（仅线索，T4不作关键事实唯一依据） | 抖音百科 | NC | T4 | CROSS_CHECKED | https://m.baike.com/wiki/%E5%9B%BE%E9%9B%85%E8%AF%BA/10989664 | 型号谱系线索 |
| 图雅诺 车型对比 | 搜狐汽车 | NC | T2 | CROSS_CHECKED | https://db.auto.sohu.com/compare-list?sliding=1&trimsid=156097,166576 | 短轴/长轴尺寸, 轴距 |
| 图雅诺 吉象流动服务车 | 大众网机械 | NC | T3 | CROSS_CHECKED | http://www.dzwww.com/jixie/f25184ea8b1340967.html | 2.5T动力, 扭矩, 座位 |
| 图雅诺 冷藏改装（上装） | 大众网机械 | NC | T3 | CROSS_CHECKED | http://www.dzwww.com/jixie/e79925a2501247453.html | F2.8NS6B177L改装上装，非原厂VAN参数 |
...
- ** MODEL_TOPIC_ MATCH**: furgão de Toano de Foton

...
| Element | Treatment |
| --- | --- |
| General ad-valorem duty | 6% of CIF (customs value) for non-preference origin |
| IVA (VAT) | 19% on CIF customs value + duty — charged even when duty is 0% under the FTA |
| FTA preference for qualifying Chinese origin | Ad-valorem duty 0%, conditional on a valid FTA certificate of origin and the product-specific rule |
| Port/logistics charges | Additional, forwarder/route-specific |
...
| Jinyu Autos — Chinese cars进口智利指南 | Jinyu Autos(industry site) | CL | https://jinyuautos.com/blog/import-chinese-cars-to-chile/ | 2026-09-02 | 中智 FTA 0% 关税通道 |
| huajiame — global vehicle import tariff guide | huajiame(industry site) | CL | https://www.huajiame.com/pl/knowledge/global-auto-import-tariff-guide | 2026-09-02 | 智利关税 6%(FTA 0%), VAT 19%, 奢侈品税 15%(>~$35k) |

...
- Meta Description: GWM Poer (China Pao / GWM Ute) explained for pickup buyers — petrol vs diesel, 8AT/9AT evolution, on-demand 4WD, standard vs long bed, payload verification and how to fix the exact export build.
...
The GWM Poer (China name Pao / Pao; some export markets GWM Ute) is Great Wall's core body-on-frame pickup platform, sold in the Middle East, ANZ, Latin America and selected RHD markets in both steering layouts and both fuels. The name covers passenger (passenger build), commercial (commercial build) and off-road (off-road build) builds whose chassis, bed, suspension and transmissions differ — so the version must be fixed before any comparison. This is an evergreen model page: the China 2024 passenger build is the named reference (Chinese-market reference), while current GWM-official data (which has evolved to 9AT and revised outputs) is shown separately rather than silently overwriting the 2024 figures.
## Drivetrain: Petrol vs Diesel — and a Model-Year Evolution to Respect
| Powertrain | China 2024 passenger reference (databases, corroborated) | Current GWM-official line |
| --- | --- | --- |
...
| --- | --- | --- |
| passenger build Passenger | Comfort double cab, automatic, on-demand 4WD | Trim, petrol/diesel, 4×2/4×4, transmission year |
| commercial build Commercial | Work-oriented, long bed (3470 mm WB), wider transmission choice | Payload/GVW, bed length, leaf-spring set-up, manual option |
| off-road build Off-road | Enhanced 4WD, locks, chassis/tyre upgrades | Low range, diff locks, tyres, ground clearance, angles |
...
| 2024 Pao config (China passenger reference) | PCauto | CN | https://price.pcauto.com.cn/m128673/config.html | 2026-09-02 | 2024 passenger 140 kW/360 petrol, 135 kW/480 diesel, ZF 8AT |

...
| Newer build | **≈51–51.4 kWh Xuanwu battery / 355–375 km** (TIME_SENSITIVE — confirm current model) |
...
- **Newer build:** ~51 kWh Xuanwu pack, ~355–375 km (time-sensitive; availability and exact figures change).
...
**How far does it go on a charge?** About 260 km (working condition) with the 35.2 kWh base pack; a newer ~51 kWh build is quoted at 355–375 km — confirm the build.

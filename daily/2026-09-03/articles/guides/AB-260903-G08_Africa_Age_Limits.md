...
- **Quality gates**: EDITORIAL_QA_PASS=PASS · FACT_SOURCE_PASS=PASS (Kenya/Nigeria primary; remaining rows explicitly non-primary and flagged, not asserted) · SEO_PASS=PASS · CODEX_REVIEW_PASS=PENDING (independent) · PUBLISH_APPROVED=FALSE
